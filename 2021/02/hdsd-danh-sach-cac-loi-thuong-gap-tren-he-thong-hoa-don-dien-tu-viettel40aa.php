...
<head>
  ...
  <link
    ...
    rel="canonical" />
  <link
    href="hdsd-danh-sach-cac-loi-thuong-gap-tren-he-thong-hoa-don-dien-tu-viettel40aa.php?m=1"
  ...
  <meta
    content="Tổng hợp các lỗi thường gặp nhất trên hệ thống hóa đơn điện tử S-invoice | Lỗi hệ thống | Lỗi người dùng | Lỗi cấu hình | Hóa đơn điện tử Viettel"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2021/02/hdsd-danh-sach-cac-loi-thuong-gap-tren-he-thong-hoa-don-dien-tu-viettel.php"
    property="og:url" />
  <meta
    content="Danh sách các lỗi thường gặp trên hệ thống Hóa đơn điện tử S-Invoice"
    property="og:title" />
  <meta
    content="Tổng hợp các lỗi thường gặp nhất trên hệ thống hóa đơn điện tử S-invoice | Lỗi hệ thống | Lỗi người dùng | Lỗi cấu hình | Hóa đơn điện tử Viettel"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="127588574643958352">
                ...
                <div class="entry-body">
                  <div class="divPostBody">
                    <h2 style="font-size: 1.3em">
                      <strong>1. &#8220;Không thể kết nối đến USB-TOKEN. Yêu cầu
                        cắm USB-TOKEN hoặc cài đặt phần mềm ký số của
                        Viettel&#8221;</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khi phát hành hóa đơn
                        (hoặc tải hóa đơn trắng), hệ thống báo lỗi:
                      ...
                      <li>
                        ...
                        <ul style="margin-left: 20px">
                          <li>
                            Máy tính của khách hàng chưa cấu hình đầy đủ các
                            yêu cầu để ký hóa đơn điện tử bằng USB token.
                          </li>
                          <li>
                            Hoặc máy tính khách hàng cài đặt phần mềm diệt
                            virus (Kaspersky, BKAV, Avast...), phần mềm diệt
                            virus chặn không cho chạy tool ký số dẫn đến lỗi.
                          </li>
                        </ul>
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong>Máy tính người dùng phải
                        đáp ứng đầy đủ các yêu cầu sau:
                        <ul style="margin-left: 20px">
                          <li>
                            Đã cài đặt driver của USB token và đã gắn token
                            khi phát hành hóa đơn
                          </li>
                          <li>
                            Đã cài đặt java 8 và đã chạy tool ký số
                            <a
                              class="color-warning"
                              href="https://drive.google.com/uc?id=1lSsYGOb0NwIBUS8Ee1W3MVTG0asey7YB&amp;export=download"
                              target="_blank"
                              title="Tool ký số">(vt-sign-tool)</a>
                          </li>
                          <li>Đã cấu hình trình duyệt để ký hóa đơn</li>
                          <li>
                            Đã thêm thành công chữ ký số trên hệ thống hóa đơn
                            điện tử S-Invoice
                          </li>
                          <li>
                            Khi phát hành hóa đơn, người dùng cần TẮT hết tất
                            cả các phần mềm diệt virus trên máy tính
                          </li>
                        </ul>
                        Khách hàng tham khảo bài viết chi tiết tại:
                        <a
                          class="color-warning"
                          href="../2020/11/cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb.php"
                          target="_blank"
                          title="Cấu hình ký hóa đơn điện tử Sinvoice bằng USB token Viettel">Cấu hình ký hóa đơn điện tử Sinvoice bằng USB token
                          Viettel</a>
                      </li>
                    </ul>

                    <h2 style="font-size: 1.3em">
                      <strong>2. Lỗi: "Bạn không thể phát hành hóa đơn do chứng thư
                        số của đơn vị đã hết hiệu lực"</strong>
                    </h2>

                    <p>
                      Nếu doanh nghiệp không thể phát hành hóa đơn điện tử, hệ
                      thống thông báo: "Bạn không thể phát hành hóa đơn do
                      chứng thư số của đơn vị đã hết hiệu lực!" thì có thể:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                      ...
                      <li>
                        <strong>Trường hợp 2:</strong> Chứng thư số của đơn vị
                        thuộc diện cấp bù nhưng chưa thay đổi thông tin chứng
                        thư số mới. Quý khách hàng cần làm theo hướng dẫn bên
                        dưới để gửi thông báo thay đổi đến Cơ quan Thuế phê
                        duyệt. Chi tiết xem tại bài viết:
                        <a
                          class="color-warning"
                          href="../2024/05/hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks.php"
                          target="_blank"
                          title="Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ quan Thuế">Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM
                          đến cơ quan Thuế</a>
                      </li>
                      <li>
                        <strong>Trường hợp 3:</strong> Chứng thư số của đơn vị
                        đã được gia hạn, tuy nhiên chưa được kích hoạt và gửi
                        lại thông báo phát hành thay đổi đến Cơ quan Thuế.
                        Khách hàng có thể liên hệ tổng đài CSKH 18008000 nhánh
                        1 để được hỗ trợ kích hoạt và gửi lại thông báo phát
                        hành hóa đơn.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>3. Không thêm được biểu mẫu Email</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi:</strong> Người dùng thêm mới biểu
                        mẫu email nhưng trong danh sách biểu mẫu không xuất
                        hiện biểu mẫu email vừa thêm.
                      </li>
                      <li>
                        <strong>Nguyên nhân:</strong> Người dùng có thể đã cấu
                        hình nhưng chưa click nút
                        <strong>Thêm mới</strong> nên thông tin không được cập
                        nhật trong danh sách biểu mẫu.
                      </li>
                      <li>
                        <strong>Cách xử lý:</strong> Người dùng thực hiện thêm
                        mới lại Biểu mẫu email và lưu ý:
                        <ul style="margin-left: 20px">
                          <li>
                            Phải soạn thảo đầy đủ tất cả 4 biểu mẫu email
                          </li>
                          <li>
                            Trạng thái phải chọn là <strong>Hoạt động</strong>
                          </li>
                          <li>
                            Phải click nút <strong>"Thêm mới"</strong> khi cấu
                            hình (tại màn hình Thêm mới Thông tin)
                          </li>
                        </ul>
                      </li>
                    </ul>
                    <p>
                      ***** Tham khảo:
                      <a
                        ...
                        href="../2020/11/hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice.php"
                        target="_blank"
                        title="Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice">Các bước cấu hình biểu mẫu Email trên hệ thống hóa
                        đơn điện tử S-Invoice</a>
                    </p>
                    <h2 style="font-size: 1.3em">
                      <strong>4. Không tìm thấy thông báo phát hành vừa mới cấu
                        hình</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi:</strong> Người dùng thêm mới thông
                        báo phát hành nhưng trong danh sách không tìm thấy
                        thông báo phát hành vừa thêm.
                      </li>
                      <li>
                        <strong>Nguyên nhân:</strong> Người dùng có thể đã cấu
                        hình nhưng chưa click nút <strong>Tạo mới</strong> nên
                        thông tin không được cập nhật trong danh sách thông
                        báo phát hành
                      </li>
                      <li>
                        <strong>Cách xử lý:</strong> Người dùng thực hiện thêm
                        mới thông báo phát hành theo từng bước sau:
                        <ul style="margin-left: 20px">
                          <li>
                            Phân hệ:
                            <strong><em>Quản lý phát hành/Lập thông báo phát hành</em></strong>
                          </li>
                          <li>Click vào nút <strong>Thêm mới</strong></li>
                          <li>
                            Nhập các thông tin của thông báo phát hành hóa
                            đơn, gồm: Tên đơn vị, mã số thuế, địa chỉ, tên cơ
                            quan Thuế...
                          </li>
                          <li>
                            Click và nút
                            <strong>Chọn loại hóa đơn phát hành</strong>
                          </li>
                          <li>
                            Nhập các thông tin của loại hóa đơn phát hành,
                            gồm: Tên mẫu hóa đơn, mẫu hóa đơn, ký hiệu, số
                            lượng, ngày bắt đầu sử dụng... hoàn thành việc
                            thêm loại hóa đơn bằng cách click
                            <strong>Thêm mới</strong>
                          </li>
                          <li>
                            Kết thúc bằng cách click vào nút
                      ...
                      <em
                        ...
                        <ul class="ulPostBody">
                          ...
                          <li>
                            <a
                              class="color-warning"
                              href="../2024/11/goi-300-hoa-don-dien-tu-dai-tra-viettel.php"
                              target="_blank"
                              title="Gói 300 hóa đơn điện tử đại trà"><strong>Gói 300 hóa đơn điện tử đại trà</strong></a>
                          </li>
                        </ul>
                      </em>
                    </div>
                    <h2 style="font-size: 1.3em">
                      <strong>5. Có lỗi xảy ra khi in hóa đơn trắng (Bước lập thông
                        báo phát hành)</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Ngay sau khi tạo mới thành
                        công thông báo phát hành, người dùng nhấn vào biểu
                        tượng tải về hóa đơn mẫu (Hóa đơn trắng) thì gặp thông
                        báo <strong><em>"Có lỗi xảy ra"</em></strong>.
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>Doanh nghiệp chưa cấu
                        hình chữ ký số HSM (hoặc chưa add chữ ký số USB token)
                        thành công.
                      </li>
                      <li>
                        <strong>Cách xử lý:</strong>Có hai trường hợp:
                        <ul style="margin-left: 20px">
                          <li>
                          ...
                          <li>
                            Nếu doanh nghiệp sử dụng chữ ký số USB token để ký
                            hóa đơn điện tử, vui lòng thực hiện thêm lại chữ
                            ký số (tham khảo bài viết:
                            <a
                              class="color-warning"
                              href="../2020/11/cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb.php"
                              target="_blank"
                              title="Cấu hình ký hóa đơn điện tử Sinvoice bằng USB token Viettel">Cấu hình ký hóa đơn điện tử Sinvoice bằng USB
                              token Viettel</a>
                          </li>
                        </ul>
                      </li>
                    ...
                    <h2 style="font-size: 1.3em">
                      <strong>6. Tài khoản hoặc mật khẩu không hợp lệ</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khách hàng đăng nhập vào
                        hệ thống hóa đơn điện tử S-Invoice xuất hiện lỗi
                        <em><strong>"Tài khoản hoặc mật khẩu không hợp lệ"</strong></em>
                        mặc dù đã đổi mật khẩu thành công, nhập đúng mật khẩu.
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>Khách hàng có thể dùng
                        sai tài khoản truy cập. Có hai loại tài khoản là: tài
                        khoản nghiệp vụ (tài khoản thường) và tài khoản
                        webservice. Cụ thể:
                        <ul style="margin-left: 20px">
                          <li>
                            Tài khoản webportal hay web nghiệp vụ dùng trên
                            link http://business-sinvoice.viettel.vn/
                          </li>
                          <li>
                            Tài khoản webservice (có dạng: "mst_ws", ví dụ:
                            0100109106_ws) dùng để tích hợp phần mềm bán hàng
                            vào phần mềm hóa đơn điện tử Viettel. Doanh nghiệp
                            <strong>không dùng</strong> tài khoản này để truy
                            cập trực tiếp vào link nghiệp vụ
                            http://business-sinvoice.viettel.vn/
                          </li>
                        </ul>
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong>Người dùng sử dụng đúng
                        tài khoản nghiệp vụ để đăng nhập vào link
                        http://business-sinvoice.viettel.vn/
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>7. Tài khoản của bạn chưa được kích hoạt</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khách hàng đăng nhập vào
                        hệ thống hóa đơn điện tử S-Invoice xuất hiện lỗi
                        <em><strong>"Tài khoản của bạn chưa được kích hoạt"</strong></em>
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>Tài khoản có thể bị khóa
                        do doanh nghiệp tự khóa hoặc bị khóa do vi phạm qui
                        định.
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong>Người dùng có thể liên hệ
                        tổng đài báo hỏng
                        <strong>1800 8000 nhánh 1</strong> để yêu cầu mở lại
                        tài khoản. Khách hàng vui lòng cung cấp lại GPKD của
                        doanh nghiệp.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>8. Lỗi không tìm thấy hóa đơn, không tra cứu được hóa
                        đơn</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khách hàng không tra cứu
                        được hóa đơn trên link nghiệp vụ
                        http://business-sinvoice.viettel.vn/ hoặc trên website
                        https://sinvoice.vn/
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>
                        <ul style="margin-left: 20px">
                          <li>
                            NN1: KH gõ sai mã bí mật, hoặc copy mã bí mật hoặc
                            các thông tin khác có kèm dấu cách.
                          </li>
                          <li>
                            NN2: Người dùng gõ thiếu số hóa đơn: số hóa đơn
                            phải bao gồm cả phần thông tin dải hóa đơn kèm số
                            hóa đơn , ví dụ: AC/21E0000006
                          </li>
                        </ul>
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong>Người dùng kiểm tra lại
                        các thông tin nhập vào, có thể copy sang notepad, xóa
                        các dấu cách sau đó paste vào mục tìm kiếm.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>9. Lỗi "Access denied"</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khi sử dụng các chức năng
                        của hệ thống hóa đơn điện tử xuât hiện thông báo lỗi
                        "Access denied"
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong> Người dùng sử dụng
                        nhiều tài khoản cùng lúc trên một máy tính. Cụ thể,
                        người dùng đang truy cập hệ thống bằng tài khoản cha
                        (tài khoản admin hoặc tài khoản được phân nhiều quyền)
                        nhưng sau đó, người dùng mở cửa sổ mởi (cùng máy, cùng
                        trình duyệt) và truy cập bằng tài khoản có quyền thấp
                        hơn (tài khoản con). Sau đó người dùng quay lại màn
                        hình tài khoản cha và click vào module khác. Lúc này,
                        tài khoản cha đã bị log out, tự động chuyển sang tài
                        khoản con. Khi click và module khác sẽ dẫn đến lỗi do
                        tài khoản con bị giới hạn truy cập module này.
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong>Người dùng làm mới lại
                        trình duyệt (nhấn F5) và đăng nhập lại.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>10. Lỗi không gửi được email hóa đơn cho người
                        mua</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Doanh nghiệp đã cấu hình
                        thành công cấu hình email, tuy nhiên khi gửi mail
                        người mua không nhận được.
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>
                        <ul style="margin-left: 20px">
                          <li>NN1: email người nhận sai.</li>
                          <li>
                            NN2: người dùng đã nhận email nhưng nằm trong thư
                            mục rác (spam inbox)
                          </li>
                          <li>NN3: sai email server hoặc sai port.</li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <ul style="margin-left: 20px">
                          <li>
                            Xử lý NN1: Người dùng kiểm tra lại email người
                            nhận đã đúng chưa.
                          </li>
                          <li>
                            Xử lý NN2: thông báo với người nhận rằng có thể
                            email nằm trong thư mục rác (spam) nhờ khách hàng
                            kiểm tra lại.
                          </li>
                          <li>
                            Xử lý NN3: Liên hệ tổng đài
                            <strong>18008000 nhánh 1</strong> và cung cấp đầy
                            đủ các thông tin về email server (IP, port...) để
                    ...
                    <h2 style="font-size: 1.3em">
                      <strong>11. Khách hàng quên mật khẩu (Lỗi 444)</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi:</strong> Người dùng quên mật khẩu
                        đăng nhập hệ thống hóa đơn điện tử S-Invoice
                      </li>
                      <li>
                        <strong>Nguyên nhân:</strong> Lỗi hành vi người dùng
                      </li>
                      <li>
                        <strong>Cách xử lý:</strong> Người dùng có thể sử dụng
                        chức năng <strong><em>"Quên mật khẩu"</em></strong> để
                        reset lại mật khẩu mới
                      </li>
                    </ul>
                    <p>
                      Chú ý: người dùng phải nhập đúng email admin đã đăng ký
                      mới có thể reset mật khẩu
                    </p>
                    <p>
                      ***** Tham khảo:
                      <a
                        ...
                        href="hdsd-cach-lay-lai-mat-khau-tai-khoan-hoa-don-dien-tu-viettel.php"
                        target="_blank"
                        title="Cách lấy lại mật khẩu tài khoản hóa đơn điện tử Viettel">Cách lấy lại mật khẩu tài khoản hóa đơn điện tử
                        Viettel</a>
                    </p>
                    <h2 style="font-size: 1.3em">
                      <strong>12. Lỗi khi tải hóa đơn trắng (hóa đơn mẫu)</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khách hàng sử dụng chữ ký
                        số server ký hóa đơn, nhưng khi tải hóa đơn trắng (hóa
                        đơn mẫu) thì hệ thống báo lỗi, không tải về được.
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong> Khách hàng sử dụng chữ
                        ký số server hsm để ký hóa đơn điện tử nhưng chưa được
                        kích hoạt.
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong> Người dùng kích hoạt lại
                        chứng thư số hsm theo các bước sau:
                        <ul style="margin-left: 20px">
                          <li>
                            Truy cập phân hệ
                            <strong><em>Quản lý phát hành/Khởi tạo thông tin doanh
                                nghiệp</em></strong>.
                          </li>
                          <li>
                            Chọn mục <strong>2. Tra cứu chứng thư số</strong>,
                            sau đó nhấn <strong>Tìm kiếm</strong>.
                          </li>
                          <li>
                            Kích hoạt chứng thư số HSM tương ứng bằng cách
                            click vào mũi tên xanh lá ở cột
                            <strong>Tác động</strong>.
                          </li>
                          <li>Tải lại hóa đơn trắng xem đã được chưa!</li>
                        </ul>
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>13. Lỗi không tìm thấy USB token.</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khách hàng chạy tool ký số
                        thì gặp lỗi "Không tìm thấy USB token".
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong> Máy tính khách hàng
                        chưa cài đặt driver cho USB token (Viettel token
                        manager)
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong> Cài đặt lại driver của
                        USB token và khởi chạy lại tool ký số.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>14. Lỗi nhảy số hóa đơn điện tử khi ký bằng USB
                        token.</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Số hóa đơn nhảy không đúng
                        theo thứ tự thời gian.
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong> Có thể trong quá trình
                        ký phát hành hóa đơn, người dùng rút USB ra dẫn đến
                        lỗi.
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong> Khách hàng vui lòng liên
                        hệ tổng đài chăm sóc khách hàng
                        <strong>1800 8000 nhánh 1</strong> để được hỗ trợ cập
                        nhật.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>15. Lỗi không lập được hóa đơn, không chọn được tên
                        mẫu hóa đơn.</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Khi lập hóa đơn, khách
                        hàng không thể chọn được tên mẫu hóa đơn => không lập
                        được hóa đơn
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong> Do khách hàng chưa tạo
                        thông báo phát hành trên hệ thống S-Invoice, hoặc đã
                        tạo rồi nhưng chưa được admin của Viettel phê duyệt.
                      </li>
                      <li>
                        <strong>Cách xử lý: </strong> Người dùng kiểm tra lại
                        thông báo phát hành đã lập bằng các bước sau:
                        <ul style="margin-left: 20px">
                          <li>
                            Truy cập phân hệ
                            <strong><em>Quản lý phát hành/Lập thông báo phát hành</em></strong>.
                          ...
                          <li>
                            Nhấn vào <strong>Tìm kiếm</strong> (Lưu ý: nhớ
                            chọn lại mục <strong>Từ ngày</strong> để việc tìm
                            kiếm chính xác hơn).
                          </li>
                          <li>Thông báo phát hành sẽ có trong danh sách</li>
                          <li>
                            Nếu trạng thái của TBPH là
                            <strong>Hoạt động</strong> tức là đã được Viettel
                            phê duyệt. Nếu trạng thái là
                            <strong>Dự thảo</strong> thì cần liên hệ với
                            Viettel để được hỗ trợ phê duyệt.
                          </li>
                        </ul>
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>16. Có lỗi xảy ra trong quá trình đăng nhập</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Mô tả lỗi: </strong>Người dùng đăng nhập vào
                        hệ thống thì xuất hiện lỗi
                        <strong><em>"Có lỗi xảy ra trong quá trình đăng nhập"</em></strong>
                      </li>
                      <li>
                        <strong>Nguyên nhân: </strong>Người dùng có thể đang
                        đăng nhập vào link demo của hệ thống hóa đơn điện tử
                        (https://demo-sinvoice.viettel.vn/dang-nhap.php)
                      </li>
                      <li>
                        <strong>Cách xử lý:</strong>
                        <ul style="margin-left: 20px">
                          <li>
                            Người dùng đăng nhập lại vào đường link chính thức
                            của hóa đơn điện tử Viettel tại:
                            https://business-sinvoice.viettel.vn/dang-nhap.php.
                          </li>
                          <li>
                            Nếu vẫn không đăng nhập được, doanh nghiệp vui
                            lòng liên hệ tổng đài báo hỏng
                            <strong>18008000 nhánh 1</strong> để được hỗ trợ
                            trực tiếp.
                          </li>
                        </ul>
                      </li>
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2021/02/hdsd-danh-sach-cac-loi-thuong-gap-tren-he-thong-hoa-don-dien-tu-viettel.php"
                  },
                  "headline": "Danh sách các lỗi thường gặp trên hệ thống Hóa đơn điện tử S-Invoice",
                  "description": "Tổng hợp các lỗi thường gặp nhất trên hệ thống hóa đơn điện tử S-invoice | Lỗi hệ thống | Lỗi người dùng | Lỗi cấu hình | Hóa đơn điện tử Viettel",
                  "image": {
                    "@type": "ImageObject",
                    "url": "",
                    "width": 720,
                  ...
                  "datePublished": "2021-02-26T22:14:00+07:00",
                  "dateModified": "2024-11-13T20:27:14+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "127588574643958352",
        pageId: "",
        pageName: "Danh sách các lỗi thường gặp trên hệ thống Hóa đơn điện tử S-Invoice",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2021/02/hdsd-danh-sach-cac-loi-thuong-gap-tren-he-thong-hoa-don-dien-tu-viettel.php",
