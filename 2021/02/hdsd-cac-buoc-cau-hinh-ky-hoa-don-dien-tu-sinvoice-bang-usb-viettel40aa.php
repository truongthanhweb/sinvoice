...
<head>
  ...
  <link
    ...
    rel="canonical" />
  <link
    href="hdsd-cac-buoc-cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb-viettel40aa.php?m=1"
  ...
  <meta
    content="Tóm tắt các bước chính giúp doanh nghiệp có thể tự cấu hình ký hóa đơn điện tử bằng usb token viettel | Hóa đơn điện tử Viettel giá rẻ | Mua thêm hóa "
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2021/02/hdsd-cac-buoc-cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb-viettel.php"
    property="og:url" />
  <meta
    content="Các bước cấu hình ký hóa đơn điện tử S-Invoice bằng USB token Viettel"
    property="og:title" />
  <meta
    content="Tóm tắt các bước chính giúp doanh nghiệp có thể tự cấu hình ký hóa đơn điện tử bằng usb token viettel | Hóa đơn điện tử Viettel giá rẻ | Mua thêm hóa "
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="4037834531788994869">
              ...
              <main class="article-body">
                <div class="entry-body">
                  <div class="divPostBody">
                    <p>
                      Để lập được hóa đơn điện tử, người dùng phải sử dụng chữ
                      ký số để ký lên hóa đơn. Trong bài hướng dẫn này,
                      S-Invocie sẽ hướng dẫn doanh nghiệp tự cấu hình ký hóa
                      đơn điện tử bằng USB token Viettel-CA. Người dùng thực
                      hiện cấu hình theo các bước sau:
                    </p>
                    ...
                    <p>
                      <strong>Trường hợp 1:</strong> Cấu hình Google
                      Chrome/Cốc cốc
                    </p>
                    <ul class="ulPostBody">
                      ...
                      <li>
                        ...
                        <strong><em>chrome://flags</em> </strong>sau đó nhấn
                        Enter.
                      </li>

                      <li>
                        Nhập từ khóa:<strong><em> #allow-insecure-localhost</em></strong>
                        vào ô tìm kiếm.
                      </li>
                      <li>
                        Đổi trạng thái từ
                        <strong><em>Disabled</em></strong> thành
                        <strong><em>Enabled</em></strong> trong kết quả tìm
                        kiếm (Nếu trạng thái đang là
                        <strong><em>Enabled</em></strong> thì không cần thực
                        hiện).
                      </li>

                      <li>Khởi động lại Google Chrome/Cốc Cốc.</li>
                    </ul>
                    <p><strong>Trường hợp 2: </strong>Cấu hình Firefox</p>
                    <ul class="ulPostBody">
                      <li>Mở trình duyệt Firefox.</li>
                      <li>
                        Vào menu <strong>Tools</strong> chọn
                      ...
                      <li>
                        Trong phần <strong>Certificates</strong> chọn
                      ...
                      <li>Nhấn vào <strong>Add Exeption.</strong></li>
                      <li>
                      ...
                      <li>Nhấn <strong>Get Certificate</strong>.</li>
                      <li>
                        Nhấn
                        <strong>Confirm Security Exeption</strong>
                      </li>
                      <li>Nhấn <strong>OK</strong> để xác nhận thay đổi.</li>
                      <li>Khởi động lại Firefox để hoàn thành cấu hình.</li>
                    </ul>
                    <h2 style="font-size: 1.1em">
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>Hoàn thành cài đặt <strong>Java 8</strong></li>
                    </ul>
                    <h2 style="font-size: 1.1em">
                      <strong>
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>
                        Giải nén file vừa tải về và chạy tool
                        <strong><em>vt-sign-tool.exe</em></strong> trong thư
                        mục "viettel-sinvoice-tool"
                      </li>
                      <li>
                    ...
                    <p>- Cách kết xuất file *.cer như sau:</p>
                    <ul class="ulPostBody">
                      <li>
                        Sau khi nhập mã PIN thành công, chúng ta sẽ thấy danh
                        sách chứng thư số có trong USB token. Người dùng kết
                        xuất file<strong> <i> .cer </i> </strong>bằng cách
                        nhấn phải vào chứng thư số cần kết xuất và chọn
                    ...
                    <p>
                      - Cách tải file *.cer lên hệ thống hóa đơn điện tử
                      S-Invoice:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Người dùng đăng nhập vào hệ thống hóa đơn điện tử
                        S-Invoice của Viettel tại đường dẫn:&nbsp;<a
                          href="https://vinvoice.viettel.vn/account/login"
                          rel="nofollow noopener"
                      ...
                      <li>
                        ...
                        <ul style="margin-left: 20px">
                          <li>
                            Loại chứng thư số: <strong>USB-TOKEN </strong>
                          </li>
                          <li>
                      ...
                      <li>
                        ...
                        người dùng nhấn chọn <strong>Thêm mới</strong> để hoàn
                        thành.
                      </li>
                    </ul>
                    <p>
                    ...
                    <p>
                      Lưu ý:
                      <strong>
                        <span class="color-primary">phải gắn USB token vào máy và chạy tool ký số trước
                    ...
                    <p>
                      ***** Bài viết chi tiết:
                      <strong><em><a
                            ...
                            target="_blank"
                            title="Hướng dẫn cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice">"Cấu hình ký hóa đơn điện tử Sinvoice bằng USB
                            token Viettel"</a></em></strong>
                    </p>
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2021/02/hdsd-cac-buoc-cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb-viettel.php"
                  },
                  "headline": "Các bước cấu hình ký hóa đơn điện tử S-Invoice bằng USB token Viettel",
                  "description": "Tóm tắt các bước chính giúp doanh nghiệp có thể tự cấu hình ký hóa đơn điện tử bằng usb token viettel | Hóa đơn điện tử Viettel giá rẻ | Mua thêm hóa ",
                  "image": {
                    "@type": "ImageObject",
                    "url": "",
                    "width": 720,
                  ...
                  "datePublished": "2021-02-18T19:36:00+07:00",
                  "dateModified": "2024-08-21T21:15:48+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "4037834531788994869",
        pageId: "",
        pageName: "Các bước cấu hình ký hóa đơn điện tử S-Invoice bằng USB token Viettel",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2021/02/hdsd-cac-buoc-cau-hinh-ky-hoa-don-dien-tu-sinvoice-bang-usb-viettel.php",
