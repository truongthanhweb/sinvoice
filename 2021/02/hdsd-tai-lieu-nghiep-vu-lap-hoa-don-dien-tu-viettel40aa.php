...
<head>
  ...
  <link
    ...
    rel="canonical" />
  <link
    href="hdsd-tai-lieu-nghiep-vu-lap-hoa-don-dien-tu-viettel40aa.php?m=1"
  ...
  <link
    ...
    media="handheld"
    rel="alternate" />
  <title>Tài liệu nghiệp vụ &amp;quot;Lập hóa đơn điện tử&amp;quot;</title>
  <meta
    content="Tùy từng trường hợp phát sinh trong quá trình lập hóa đơn điện tử mà người dùng có thể thực hiện theo các bước hướng dẫn | Mua hóa đơn điện tử Viettel"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2021/02/hdsd-tai-lieu-nghiep-vu-lap-hoa-don-dien-tu-viettel.php"
    property="og:url" />
  <meta
    content="Tài liệu nghiệp vụ &amp;quot;Lập hóa đơn điện tử&amp;quot;"
    property="og:title" />
  <meta
    content="Tùy từng trường hợp phát sinh trong quá trình lập hóa đơn điện tử mà người dùng có thể thực hiện theo các bước hướng dẫn | Mua hóa đơn điện tử Viettel"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="6809207668904931292">
              ...
              <main class="article-body">
                <div class="entry-body">
                  <div class="divPostBody">
                    ...
                    <p>
                      Tài liệu nhằm mô tả nghiệp vụ lập hóa đơn điện tử của
                      người sử dụng tuân theo các quy định của Bộ tài chính.
                      Bao gồm:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Xử lý khi phát hiện hóa đơn sai<br />
                        <ul style="margin-left: 20px">
                          <li>
                            Trường hợp hóa đơn đã lập và gửi cho người mua,
                            người mua chưa kê khai thuế
                          </li>
                          <li>
                            Trường hợp hóa đơn đã lập và gửi cho người mua,
                      ...
                      <li>
                        Khách hàng trả lại hàng<br />
                        <ul style="margin-left: 20px">
                          <li>Người mua có hóa đơn</li>
                          <li>Người mua không có hóa đơn</li>
                        </ul>
                      </li>
                    </ul>
                    <p></p>
                    ...
                    <p>
                      Tùy từng trường hợp phát sinh trong quá trình lập hóa
                      đơn điện tử, các bên thực hiện theo hướng dẫn sau:
                    </p>
                    <h3 style="font-size: 1.1em">
                      <strong>1. Hóa đơn viết sai</strong>
                    </h3>
                    <p>Theo (Điều 11 Thông tư 32/2011/TT-BTC)</p>
                    <p>
                      <em><strong>1.1. Trường hợp hóa đơn đã lập và gửi cho người
                          mua, người mua chưa kê khai thuế:</strong></em>
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Lập biên bản thu hồi hóa đơn có cả xác nhận của cả
                        người mua và người bán
                      </li>
                      <li>Lập hóa đơn điện tử mới</li>
                    </ul>
                    <p>
                      <strong><em>1.2. Trường hợp hóa đơn đã lập và gửi cho người
                          mua, người mua đã kê khai thuế:</em></strong>
                    </p>
                    <p>
                      + Hóa đơn sai thông tin tên, địa chỉ khách hàng nhưng
                      vẫn đúng mã số thuế:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Lập biên bản điều chỉnh hóa đơn có cả xác nhận của cả
                        người mua và người bán
                      </li>
                    </ul>
                    <p>
                      + Hóa đơn sai các thông tin khác (số lượng, tiền, mã số
                      thuế&#8230;):
                    </p>
                    <ul class="ulPostBody">
                      <li>
                      ...
                      <li>
                        Lập hóa đơn điều chỉnh (Lưu ý hóa đơn điện tử không
                        được ghi số âm)
                      </li>
                    </ul>
                    <p>
                      ***** Xem thêm:
                      <strong><em><a
                            class="color-warning"
                            href="../2020/11/hdsd-cach-lap-bien-ban-dieu-chinh-hoa-don-dien-tu-sinvoice.php"
                            target="_blank">Cách lập biên bản điều chỉnh hóa đơn điện tử
                            S-Invoice</a></em></strong>
                    </p>
                    <h3 style="font-size: 1.1em">
                      <strong>2. Khách hàng trả lại hàng</strong>
                    </h3>
                    <p>
                      <strong><em>2.1. Người mua có hóa đơn</em></strong>
                    </p>
                    <p>
                      Người mua sẽ xuất lại hóa đơn cho người bán, có thể xuất
                      toàn bộ hàng hoặc một phần hàng tùy từng trường hợp.
                    </p>
                    <p>
                      <strong><em>2.2. Người mua không có hóa đơn</em></strong>
                    </p>
                    <ol type="a" style="font-size: 1.1em">
                      <li>
                        Hóa đơn chưa kê khai thuế<br />
                        <ul style="margin-left: 20px">
                          <li>
                            Người mua trả lại một phần hàng<br />
                            - Người bán và người mua lập biên bản thỏa
                            thuận<br />
                            - Người bán thu hồi hóa đơn và xuất hóa đơn thay
                            thế<br />
                          </li>
                          <li>
                            Người mua trả lại toàn bộ hàng<br />
                            - Người bán và người mua lập biên bản thỏa
                            thuận<br />
                            - Người bán thu hồi hóa đơn<br />
                          </li>
                        </ul>
                      </li>
                      <li>
                        Hóa đơn đã kê khai thuế<br />
                        - Người bán và người mua lập biên bản thỏa thuận<br />
                        - Người bán xuất hóa đơn điều chỉnh.<br />
                      </li>
                    </ol>
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2021/02/hdsd-tai-lieu-nghiep-vu-lap-hoa-don-dien-tu-viettel.php"
                  },
                  "headline": "Tài liệu nghiệp vụ &quot;Lập hóa đơn điện tử&quot;",
                  "description": "Tùy từng trường hợp phát sinh trong quá trình lập hóa đơn điện tử mà người dùng có thể thực hiện theo các bước hướng dẫn | Mua hóa đơn điện tử Viettel",
                  "image": {
                    "@type": "ImageObject",
                    "url": "",
                    "width": 720,
                  ...
                  "datePublished": "2021-02-23T20:01:00+07:00",
                  "dateModified": "2021-05-13T14:39:09+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "6809207668904931292",
        pageId: "",
        pageName: "Tài liệu nghiệp vụ &quot;Lập hóa đơn điện tử&quot;",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2021/02/hdsd-tai-lieu-nghiep-vu-lap-hoa-don-dien-tu-viettel.php",
