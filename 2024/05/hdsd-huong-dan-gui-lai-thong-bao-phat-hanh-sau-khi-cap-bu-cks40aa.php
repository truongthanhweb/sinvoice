...
<head>
  ...
  <link
    href="hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks.php"
    rel="canonical" />
  <link
    href="hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks40aa.php?m=1"
  ...
  <link
    ...
    rel="alternate" />
  <title>
    Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ quan Thuế
  </title>
  <meta
    content="Hướng dẫn khách hàng xử lý lỗi: Bạn không thể phát hành hóa đơn do chứng thư số của đơn vị đã hết hiệu lực. Chữ ký số có thể đã hết hạn dùng."
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgHLpHoHttZDfe0tb-7RvOgQcg6wH2pYvTr9cng6c8W6JVzkpA7vF6L-zlmfIc9qz19DZxRyLmYdsAV2HGCCAY5M1ThiPkHqaBRmQkvmUHGJUurLCzCdAuOIr3u0yLTrPdajMsQ0d1j7uaAL3K218ij-6kj3BiuLAPcZGgLDEurOYBiZznyPysyvCtjUert/w1200-h630-p-k-no-nu/huong-dan-xu-ly-loi-chung-thu-so-het-hieu-luc.webp"
    property="og:image" />
  <meta content="1200" property="og:image:width" />
  <meta content="630" property="og:image:height" />
  <meta
    content="https://www.sinvoice.vn/2024/05/hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks.php"
    property="og:url" />
  <meta
    content="Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ quan Thuế"
    property="og:title" />
  <meta
    content="Hướng dẫn khách hàng xử lý lỗi: Bạn không thể phát hành hóa đơn do chứng thư số của đơn vị đã hết hiệu lực. Chữ ký số có thể đã hết hạn dùng."
      ...
      <div class="sidebar col-md-3 col-xs-12 section" id="sidebar-2">
        ...
        <div class="list-group widget" id="list-group">
          <ul id="myUL" type="none">
            ...
            <li>
              <a
                href="../01/hdsd-lap-va-tra-cuu-hoa-don-dien-tu.php"
            ...
            <li>
              <a
                href="../01/hdsd-huong-dan-giai-trinh-hoac-xoa-bo-hoa-don-sinvoice.php"
            ...
            <li>
              <a
                href="../01/hdsd-gui-hoa-don-tu-may-tinh-tien-len-co-quan-thue.php"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="656480364078011343">
              <header class="article-header">
                <h1 class="entry-title">
                  Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ
                  quan Thuế
                </h1>
              </header>
                ...
                <div class="entry-body">
                  <div class="divPostBody">
                    <p>
                      ...
                      Chứng thư số Viettel-CA được Bộ TT&amp;TT cấp phép năm
                      2019, có thời hạn đến ngày 13/5/2024, do đó các chứng
                      thư số của khách hàng có thời hạn lớn nhất chỉ đến đúng
                      ngày 13/05/2024 dẫn đến việc Viettel cấp thiếu thời gian
                      của một lượng lớn khách hàng theo hợp đồng sử dụng dịch
                      vụ. Từ ngày 01/04/2024, Viettel đã chủ động cấp bù thời
                      hạn cho các
                      <strong><em>khách hàng sử dụng chữ ký số server HSM</em></strong>
                      trên hệ thống hóa đơn điện tử S-Invoice.
                      <span class="color-primary">Tuy nhiên, khách hàng cần gửi lại thông báo phát hành
                        thay đổi chữ ký số (đã được Viettel cấp bù) đến Cơ
                        quan Thuế để có thể phát hành hóa đơn</span>. Trong hướng dẫn này,
                      <a
                        href="../index.php"
                        target="_blank"
                        title="Hóa đơn điện tử S-Invoice">S-invoice</a>
                      xin hướng dẫn quý khách hàng cách gửi lại thông báo thay
                      đổi chữ ký số lên Cơ quan Thuế để cập nhật thông tin
                      chứng thư số mới.
                    </p>
                    <table
                      align="center"
                      ...
                      <tbody>
                        <tr>
                          <td style="text-align: center">
                            <a
                              href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgHLpHoHttZDfe0tb-7RvOgQcg6wH2pYvTr9cng6c8W6JVzkpA7vF6L-zlmfIc9qz19DZxRyLmYdsAV2HGCCAY5M1ThiPkHqaBRmQkvmUHGJUurLCzCdAuOIr3u0yLTrPdajMsQ0d1j7uaAL3K218ij-6kj3BiuLAPcZGgLDEurOYBiZznyPysyvCtjUert/s16000/huong-dan-xu-ly-loi-chung-thu-so-het-hieu-luc.webp"
                              style="margin-left: auto; margin-right: auto"><img
                                alt="Hướng dẫn xử lý lỗi chứng thư số hết hiệu lực 13/5/2024"
                                border="0"
                        ...
                        <tr>
                          <td class="tr-caption" style="text-align: center">
                            Hướng dẫn xử lý lỗi chứng thư số hết hiệu lực
                            13/5/2024
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <h2 class="entry-subtitle">
                      <strong>1. Khi phát hành hóa đơn, hệ thống báo lỗi: "Bạn
                        không thể phát hành hóa đơn do chứng thư số của đơn vị
                        đã hết hiệu lực!"</strong>
                    </h2>
                    <p>
                      Nếu doanh nghiệp không thể phát hành hóa đơn điện tử, hệ
                      thống thông báo:
                      <strong><em>"Bạn không thể phát hành hóa đơn do chứng thư số
                          của đơn vị đã hết hiệu lực!"</em></strong>
                      thì có thể:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                    ...
                    <p>
                      Để biết được đơn vị mình đang thuộc trường hợp nào, Quý
                      khách hàng thực hiện theo các bước sau:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Bước 1:</strong> Đăng nhập vào hệ thống hóa
                        ...
                        <a
                          ...
                          rel="nofollow"
                          target="_blank"
                          title="Hóa đơn điện tử S-invoice">Tại đây</a>.
                      </li>
                      <li>
                        <strong>Bước 2:</strong> Tại màn hình chính, người
                        dùng chọn menu: <strong>Quản lý phát hành</strong> =>
                        <strong>Khởi tạo thông tin doanh nghiệp</strong> =>
                        Click chọn mục
                        <strong>2. Tra cứu chứng thư số</strong>.
                      </li>
                      <li>
                        <strong>Bước 3:</strong> Chứng thư số có trạng thái là
                        <strong><em>Hoạt động</em></strong> là chứng thư số
                        đang được dùng để phát hành hóa đơn điện tử.
                      </li>
                      <ul style="padding-left: 20px">
                        <li>
                          Nếu ngày hết hiệu lực của
                          <strong><em>chứng thư số Hoạt động</em></strong> nhỏ
                          hơn ngày hiện tại thì chứng thư số đã hết hạn. Quý
                          khách hàng thuộc trường hợp 1 nêu trên.
                        </li>
                        <li>
                          Nếu xuất hiện dòng chứng thư số có ngày hết hiệu lực
                          lớn hơn ngày hiện tại (còn hạn), và đang ở trạng
                          thái
                          <strong><em>Đã cấp chứng thư số</em></strong> thì
                          doanh nghiệp thuộc trường hợp 2 nêu trên. Đơn vị vui
                          lòng thực hiện theo hướng dẫn bên dưới đây để cập
                          nhật thông tin chứng thư số mới với Cơ quan Thuế.
                        </li>
                      </ul>
                    </ul>
                    <table
                      ...
                      <tbody>
                        <tr>
                          <td style="text-align: center">
                            <a
                              ...
                              style="margin-left: auto; margin-right: auto"><img
                                alt="Chứng thư số đã được Viettel cấp bù tự động, cần gửi lại thông báo phát hành"
                                border="0"
                                data-original-height="605"
                                data-original-width="900"
                                src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhzGvBXFpVt1rdyOe7oWXK6sKKENhGDykdOb5xP3HCHRfh2zT3_Zl7U_ToegaIQcE3UmoLdV8Up1qyZu3w52JAhVk_1IwC1cxgiCMy75MZ2cnpG2vITk5sMK8UABhEr0c-Eb9KddpbQXGJQx1uDTOfhSzILSrZXe0O6Wm5aVPg5_iaf-9WLWd7pGvkD9PdI/s16000/don-vi-da-duoc-cap-bu-chung-thu-so-moi.webp" /></a>
                        ...
                        <tr>
                          <td class="tr-caption" style="text-align: center">
                            Chứng thư số đã được Viettel cấp bù tự động, cần
                            gửi lại thông báo phát hành
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <h2 class="entry-subtitle">
                      <strong>2. Hướng dẫn nộp thông báo thay đổi chứng thư số lên
                        Cơ quan Thuế.</strong>
                    </h2>
                    <h3 class="entry-subtitle">
                      <strong>Bước 1: Kích hoạt chứng thư số đã được cấp
                        bù.</strong>
                    </h3>
                    <p>
                      Khi xác định được chứng thư số của doanh nghiệp thuộc
                      trường hợp 2:
                      <strong><em>Đã được Viettel cấp bù thời hạn, nhưng chưa gửi
                          thông báo thay đổi</em></strong>, quý khách hàng cần kích hoạt chứng thư số mới trước
                      khi gửi thông báo thay đổi đến Cơ quan Thuế. Trình tự
                      thực hiện như sau:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        <strong>Bước 1.1:</strong> Tại màn hình
                        <strong>2. Tra cứu chứng thư số</strong>, người dùng
                        tìm chứng thư số đã được cấp bù (là chứng thư số có
                        trạng thái
                        <strong><em>Đã cấp chứng thư số</em></strong> và chưa
                        hết hạn). Người dùng click chọn vào biểu tượng
                        <strong>"Kích hoạt"</strong> ở cột Hành động.
                      </li>
                      <li>
                        <strong>Bước 1.2:</strong> Tại cửa sổ
                        <strong>Kích hoạt chứng thư số</strong>, người dùng
                        click chọn <strong>Kích hoạt</strong>. Sau đó nhấn
                        <strong>Đồng ý</strong> để xác nhận kích hoạt chứng
                        thư số đã được cấp bù.
                      </li>
                      <li>
                        <strong>Bước 1.3:</strong> Người dùng nhấn tiếp
                        <strong>Đồng ý</strong> để xác nhận ngừng hoạt động
                        đối với chứng thư số cũ (hết hạn), và kích hoạt đối
                        với chứng thư số mới (còn hạn).
                      </li>
                    </ul>
                    <p>
                      Hệ thống thông báo kích hoạt chứng thư số thành công ở
                      góc trên bên phải.
                    </p>
                    <h3 class="entry-subtitle">
                    ...
                    <ul class="ulPostBody">
                      <li>
                        <strong>Bước 2.1:</strong> Người dùng chọn menu
                        <strong>Quản lý phát hành</strong> =>
                        <strong>Lập thông báo phát hành</strong> => Click vào
                        nút <strong>Lập thông báo phát hành</strong> => chọn
                        <strong>Đăng ký theo Nghị định 123(TT78)</strong>
                      </li>
                      <li>
                        <strong>Bước 2.2:</strong> Tại cửa sổ
                        <strong>Thêm mới thông báo phát hành</strong>, người
                        dùng nhập các thông tin theo hướng dẫn sau:
                      </li>
                      <ul style="padding-left: 20px">
                        <li>
                          <strong>Tên đơn vị khởi tạo hoá đơn điện tử:</strong>
                          Chọn tên doanh nghiệp/tổ chức/hộ kinh doanh tương
                          ứng;
                        </li>
                        <li>
                          <strong>Mã số thuế, Số điện thoại, Địa chỉ, Dấu phân cách
                            sử dụng:</strong>
                          hệ thống đã tự động điền sẵn, người dùng không cần
                          thay đổi;
                        </li>
                        <li>
                          <strong>Tên cơ quan thuế:</strong> người dùng nhập
                          đúng tên cơ quan thuế quản lý của doanh nghiệp. Nếu
                          nhập sai thì cơ quan thuế sẽ từ chối duyệt thông báo
                          thay đổi;
                        </li>
                        <li>
                          <strong>Hình thức đăng ký:</strong> chọn
                          <strong>Thay đổi</strong>;
                        </li>
                        <li>
                          <strong>Hình thức uỷ nhiệm:</strong> chọn
                          <strong>Không ủy nhiệm</strong>;
                        </li>
                        <li>
                          <strong>Hình thức hóa đơn:</strong> người dùng chọn
                          hình thức hóa đơn đang áp dụng. Thông thường thì
                          doanh nghiệp sử dụng hóa đơn có mã của cơ quan thuế;
                        </li>
                        <li>
                          <strong>Hình thức gửi hóa đơn điện tử:</strong>
                          Không chọn;
                        </li>
                        <li>
                          <strong>Phương thức chuyển dữ liệu hóa đơn điện
                            tử:</strong>
                          chọn
                          <strong>Chuyển đầy đủ nội dung từng hóa đơn</strong>;
                        </li>
                        <li>
                          <strong>Loại hóa đơn sử dụng:</strong> Người dùng
                          tích chọn loại hóa đơn mà doanh nghiệp đang phát
                          hành;
                        </li>
                        <li>
                          <strong>Danh sách chứng thư số sử dụng:</strong> Nếu
                          bước kích hoạt chứng thư số thành công, thì chứng
                          thư số đã được cấp bù sẽ ở trạng thái
                          <strong><em>Thêm mới</em></strong>. Người dùng có thể xóa bỏ các chứng thư số hết
                          hạn, các chứng thư số còn hạn thì đổi trạng thái là
                          <strong><em>Thêm mới</em></strong>;
                        </li>
                        <li>
                          <strong>Danh sách mẫu số, ký hiệu hóa đơn sử
                            dụng:</strong>
                          Người dùng nhấn
                          <strong>Chọn mẫu số, ký hiệu hóa đơn sử dụng</strong>
                          để thêm danh sách hóa đơn. Tại cửa sổ
                          <strong>Chọn loại hóa đơn phát hành</strong>, người
                          dụng chọn mẫu số hóa đơn và ký hiệu sau đó nhấn
                          <strong>Ghi lại</strong>. Thực hiện lại thao tác
                          trên cho đến khi thêm đủ số mẫu và ký hiệu hóa đơn;
                        </li>
                      </ul>
                      <li>
                        <strong>Bước 2.3:</strong> Sau khi điền đầy đủ thông
                        tin trên thông báo phát hành, người dùng nhấn
                        <strong>Ghi lại</strong> để lưu nháp thông báo phát
                        hành. Hệ thống thông báo
                        <strong>Thêm mới thông báo phát hành thành công</strong>
                        ở góc trên bên phải;
                      </li>
                      <li>
                        <strong>Bước 2.4:</strong> Nếu xác nhận các thông tin
                        trong thông báo phát hành là đúng, người dùng nhấn
                        chọn nút <strong>Gửi cơ quan Thuế</strong> ở cột hành
                        động để gửi thông báo phát hành vừa tạo đến cơ quan
                        thuế.
                      </li>
                    </ul>
                    <p>
                      Lưu ý: Người dùng có thể xem lại thông báo phát hành cũ
                      đã được cơ quan Thuế phê duyệt để nhập đúng các thông
                      tin. Để xem lại thông báo phát hành cũ trước đó, người
                      dùng thực hiện theo các bước:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Bước 1: Tại cửa sổ lập thông báo phát hành, người dùng
                        chọn khoảng thời gian Từ ngày: 01/01/2020, sau đó nhấn
                        <strong>Tìm kiếm</strong>
                      </li>
                      <li>
                        Bước 2: Trong danh sách lập thông báo phát hành, người
                        dùng tìm đến thông báo mới nhất (xem cột ngày lập) và
                        ở trạng thái <strong><em>Hoạt động</em></strong>.
                      </li>
                      <li>
                        Bước 3: Nhấn vào biểu tượng chữ
                        <strong><em>"i nhỏ"</em></strong> ở cột hành động để
                        xem thông tin thông báo phát hành mới nhất.
                      </li>
                    </ul>
                    <h2 class="entry-subtitle">
                    ...
                    <ul class="ulPostBody">
                      <li>
                        Sau khi gửi thông báo thay đổi đến cơ quan Thuế thành
                        công, quý khách hàng cần chờ Cơ quan Thuế phê duyệt
                        thông báo. Thời gian phê duyệt là 24h làm việc (không
                        tính thứ 7, chủ nhật và ngày lễ).
                        <span class="color-primary">TRONG THỜI GIAN CHỜ, QUÝ KHÁCH HÀNG SẼ KHÔNG PHÁT
                          HÀNH ĐƯỢC HÓA ĐƠN ĐIỆN TỬ.</span>
                      </li>
                      <li>
                        Nếu cơ quan Thuế kiểm tra thông báo thay đổi có sai
                        sót sẽ từ chối phê duyệt. Quý khách hàng cần khắc phục
                        sai sót và gửi lại thông báo phát hành thay đổi.
                      </li>
                      <li>
                        Để kiểm tra thông báo phát hành đã được duyệt hay
                        chưa, người dùng thực hiện theo các bước:
                        <ul style="padding-left: 20px">
                          <li>
                            <strong>Bước 1:</strong> Đăng nhập vào tài khoản
                            Hóa đơn điện tử S-Invoice
                          </li>
                          <li>
                            <strong>Bước 2:</strong> Người dùng chọn menu
                            <strong>Quản lý phát hành</strong> =>
                            <strong>Lập thông báo phát hành</strong>. Nếu
                            trạng thái của thông báo phát hành là
                            <strong><em>Hoạt động</em></strong> thì Cơ quan
                            Thuế đã phê duyệt. Ngược lại, trạng thái của thông
                            báo là
                            <strong><em>"Từ chối phê duyệt"</em></strong> thì
                            người dùng cần khắc phục sai sót và gửi lại thông
                            báo phát hành khác. Nếu trạng thái là
                            <strong><em>Chờ phê duyệt</em></strong> thì cơ
                            quan Thuế chưa phê duyệt thông báo, đơn vị cần chờ
                            thêm.
                          </li>
                        </ul>
                      </li>
                    ...
                    <p>
                      <strong>Cảm ơn Quý khách hàng đã sử dụng dịch vụ của Viettel.
                        Trân trọng!</strong>
                    </p>
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>
                        <a
                          href="../04/goi-300-hoa-don-dien-tu-cho-ho-kinh-doanh.php"
                          target="_blank"
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2024/05/hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks.php"
                  },
                  "headline": "Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ quan Thuế",
                  "description": "Hướng dẫn khách hàng xử lý lỗi: Bạn không thể phát hành hóa đơn do chứng thư số của đơn vị đã hết hiệu lực. Chữ ký số có thể đã hết hạn dùng.",
                  "image": {
                    "@type": "ImageObject",
                    "url": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgHLpHoHttZDfe0tb-7RvOgQcg6wH2pYvTr9cng6c8W6JVzkpA7vF6L-zlmfIc9qz19DZxRyLmYdsAV2HGCCAY5M1ThiPkHqaBRmQkvmUHGJUurLCzCdAuOIr3u0yLTrPdajMsQ0d1j7uaAL3K218ij-6kj3BiuLAPcZGgLDEurOYBiZznyPysyvCtjUert/w720-h480-p-k-no-nu/huong-dan-xu-ly-loi-chung-thu-so-het-hieu-luc.webp",
                    "width": 720,
                    "height": 480
                  },
                  "datePublished": "2024-05-12T14:37:00+07:00",
                  "dateModified": "2024-05-12T19:04:43+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "656480364078011343",
        pageId: "",
        pageName: "Hướng dẫn gửi lại thông báo thay đổi chữ ký số HSM đến cơ quan Thuế",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2024/05/hdsd-huong-dan-gui-lai-thong-bao-phat-hanh-sau-khi-cap-bu-cks.php",
