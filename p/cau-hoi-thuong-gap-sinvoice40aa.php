...
<head>
  ...
  <link href="cau-hoi-thuong-gap-sinvoice.php" rel="canonical" />
  <link
    href="cau-hoi-thuong-gap-sinvoice40aa.php?m=1"
  ...
  <link
    ...
    media="handheld"
    rel="alternate" />
  <title>Câu hỏi thường gặp Sinvoice</title>
  <meta
    content="FAQs - Những câu hỏi thường gặp khi sử dụng dịch vụ Hóa đơn điện tử S-Invoice | Mua hóa đơn điện tử Viettel ở đâu? | Tìm mẫu hóa đơn điện tử ở đâu?"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/p/cau-hoi-thuong-gap-sinvoice.php"
    property="og:url" />
  <meta content="Câu hỏi thường gặp Sinvoice" property="og:title" />
  <meta
    content="FAQs - Những câu hỏi thường gặp khi sử dụng dịch vụ Hóa đơn điện tử S-Invoice | Mua hóa đơn điện tử Viettel ở đâu? | Tìm mẫu hóa đơn điện tử ở đâu?"
          ...
          <div class="collapse navbar-collapse" id="nav_main2">
            <ul
              ...
              <li class="col-md-3 col-xs-12 col-sm-3">
                <a
                  href="thu-tuc-dang-ky-sinvoice.php"
                  title="Thủ tục đăng ký">Thủ tục đăng ký</a>
              </li>
              <li class="col-md-3 col-xs-12 col-sm-3">
                <a
                  href="van-ban-phap-ly-sinvoice.php"
              ...
              <li class="col-md-3 col-xs-12 col-sm-3 active">
                <a
                  href="cau-hoi-thuong-gap-sinvoice.php"
    ...
    <div class="container">
      <div class="row">
        <div
          ...
          <div class="accordion-group accordion-faq" id="accordion-faq-0">
            <h1 class="entry-title">PHẦN A- HỎI VÀ TRẢ LỜI VỀ HÓA ĐƠN</h1>
            <div
              class="accordion-item panel"
              itemprop="mainEntity"
              itemscope=""
              itemtype="https://schema.org/Question">
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  class="clearfix collapsed"
                  data-parent="#accordion-faq-0"
                  data-toggle="collapse"
                  href="#001">
                  <span class="panel-title clearfix col-xs-11">Câu 1: Hóa đơn là gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              </h2>
              <div
                ...
                style="height: 0px; margin-left: 6px">
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn là chứng từ kế toán do
                    tổ chức, cá nhân bán hàng hóa, cung cấp dịch vụ lập, ghi
                    nhận thông tin bán hàng hóa, cung cấp dịch vụ. Hóa đơn
                    được thể hiện theo hình thức hóa đơn điện tử hoặc hóa đơn
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#002">
                  <span class="panel-title clearfix col-xs-11">Câu 2: Ai phải lập hóa đơn và lập hóa đơn khi nào?
                  </span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Khi bán hàng hóa, cung cấp dịch
                    vụ, người bán phải lập hóa đơn để giao cho người mua (bao
                    gồm cả các trường hợp hàng hóa, dịch vụ dùng để khuyến
                    mại, quảng cáo, hàng mẫu; hàng hóa, dịch vụ dùng để cho,
                    biếu, tặng, trao đổi, trả thay lương cho người lao động và
                    tiêu dùng nội bộ (trừ hàng hóa luân chuyển nội bộ để tiếp
                    tục quá trình sản xuất); xuất hàng hóa dưới các hình thức
                    cho vay, cho mượn hoặc hoàn trả hàng hóa) và phải ghi đầy
                    đủ nội dung theo quy định tại Điều 10 Nghị định số
                    123/2020/NĐ-CP, trường hợp sử dụng hóa đơn điện tử thì
                    phải theo định dạng chuẩn dữ liệu của cơ quan thuế theo
                    quy định tại Điều 12 Nghị định số 123/2020/NĐ-CP.
                  </p>
                  <p>
                    Thời điểm lập hóa đơn đối với bán hàng hóa (bao gồm cả bán
                    tài sản nhà nước, tài sản tịch thu, sung quỹ nhà nước và
                    bán hàng dự trữ quốc gia) là thời điểm chuyển giao quyền
                    sở hữu hoặc quyền sử dụng hàng hóa cho người mua, không
                    phân biệt đã thu được tiền hay chưa thu được tiền.
                  </p>
                  <p>
                    Thời điểm lập hóa đơn đối với cung cấp dịch vụ là thời
                    điểm hoàn thành việc cung cấp dịch vụ không phân biệt đã
                    thu được tiền hay chưa thu được tiền. Trường hợp người
                    cung cấp dịch vụ có thu tiền trước hoặc trong khi cung cấp
                    dịch vụ thì thời điểm lập hóa đơn là thời điểm thu tiền
                    (không bao gồm trường hợp thu tiền đặt cọc hoặc tạm ứng để
                    đảm bảo thực hiện hợp đồng cung cấp các dịch vụ: kế toán,
                    kiểm toán, tư vấn tài chính, thuế; thẩm định giá; khảo
                    sát, thiết kế kỹ thuật; tư vấn giám sát; lập dự án đầu tư
                    xây dựng).
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#003">
                  <span class="panel-title clearfix col-xs-11">Câu 3: Có mấy hình thức hóa đơn?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Có hai hình thức hóa đơn là hóa
                    đơn điện tử và hóa đơn giấy do cơ quan thuế đặt in.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#004">
                  <span class="panel-title clearfix col-xs-11">Câu 4: Hóa đơn điện tử là gì và có bao nhiêu hình thức
                    đơn điện tử?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn điện tử là hóa đơn có mã
                    hoặc không có mã của cơ quan thuế được thể hiện ở dạng dữ
                    liệu điện tử do tổ chức, cá nhân bán hàng hóa, cung cấp
                    dịch vụ lập bằng phương tiện điện tử để ghi nhận thông tin
                    bán hàng hóa, cung cấp dịch vụ theo quy định của pháp luật
                    về kế toán, pháp luật về thuế, bao gồm cả trường hợp hóa
                    đơn được khởi tạo từ máy tính tiền có kết nối chuyển dữ
                    liệu điện tử với cơ quan thuế.
                  </p>
                  <p>
                    Có 3 hình thức hóa đơn điện tử: Hóa đơn điện tử có mã của
                    cơ quan thuế, Hóa đơn điện tử không có mã của cơ quan
                    thuế, Hóa đơn được khởi tạo từ máy tính tiền có kết nối
                    chuyển dữ liệu với cơ quan thuế.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#005">
                  <span class="panel-title clearfix col-xs-11">Câu 5: Thế nào là hóa đơn điện tử có mã của cơ quan thuế?
                    Mã cơ quan thuế trên hóa đơn?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn điện tử có mã của cơ
                    quan thuế là hóa đơn điện tử được cơ quan thuế cấp mã
                    trước khi tổ chức, cá nhân bán hàng hóa, cung cấp dịch vụ
                    gửi cho người mua. Mã của cơ quan thuế trên hóa đơn điện
                    tử bao gồm số giao dịch là một dãy số duy nhất do hệ thống
                    của cơ quan thuế tạo ra và một chuỗi ký tự được cơ quan
                    thuế mã hóa dựa trên thông tin của người bán lập trên hóa
                    đơn.
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#006">
                  <span class="panel-title clearfix col-xs-11">Câu 6: Thế nào là hóa đơn điện tử không có mã của cơ quan
                    thuế?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn điện tử không có mã của
                    cơ quan thuế là hóa đơn điện tử do tổ chức bán hàng hóa,
                    cung cấp dịch vụ gửi cho người mua không có mã của cơ quan
                    thuế.
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#007">
                  <span class="panel-title clearfix col-xs-11">Câu 7: Hóa đơn điện tử được khởi tạo từ máy tính tiền có
                    kết nối chuyển dữ liệu với cơ quan thuế phải đảm bảo
                    nguyên tắc gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn được khởi tạo từ máy
                    tính tiền kết nối chuyển dữ liệu điện tử với cơ quan thuế
                    là hóa đơn điện tử có mã hoặc không có mã.
                  </p>
                  <p>
                  ...
                  <ul class="ulPostBody">
                    <li>
                      Nhận biết được hóa đơn in từ máy tính tiền kết nối
                      chuyển dữ liệu điện tử với cơ quan thuế;
                    </li>
                    <li>Không bắt buộc có chữ ký số;</li>
                    <li>
                      Khoản chi mua hàng hóa, dịch vụ sử dụng hóa đơn (hoặc
                      sao chụp hóa đơn hoặc tra thông tin từ Cổng thông tin
                      điện tử của Tổng cục Thuế về hóa đơn) được khởi tạo từ
                      máy tính tiền được xác định là khoản chi có đủ hóa đơn,
                      chứng từ hợp pháp khi xác định nghĩa vụ thuế.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#008">
                  <span class="panel-title clearfix col-xs-11">Câu 8: Thế nào là hóa đơn giấy do cơ quan thuế đặt in?
                    Đối tượng được mua hóa đơn giấy?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn do cơ quan thuế đặt in
                    là hóa đơn được thể hiện dưới dạng giấy do cơ quan thuế
                    đặt in để bán cho tổ chức, cá nhân thuộc đối tượng và
                    trường hợp được mua hóa đơn của cơ quan thuế theo quy định
                    tại Điều 23 Nghị định số 123/2020/NĐ-CP để sử dụng khi bán
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#009">
                  <span class="panel-title clearfix col-xs-11">Câu 9: Đối tượng áp dụng hóa đơn điện tử có mã của cơ
                    quan thuế</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Các tổ chức, cá nhân sau là đối
                    tượng áp dụng hóa đơn điện tử có mã của cơ quan thuế:
                  </p>
                  <ol>
                    <li>
                      Doanh nghiệp, tổ chức kinh tế sử dụng hóa đơn điện tử có
                      mã của cơ quan thuế khi bán hàng hóa, cung cấp dịch vụ
                      không phân biệt giá trị từng lần bán hàng hóa, cung cấp
                      dịch vụ.
                    </li>
                    <li>
                      Doanh nghiệp thuộc đối tượng nêu tại Khoản 2 Điều 91
                      Luật Quản lý thuế đang sử dụng hoá đơn điện tử không mã
                      có nhu cầu chuyển đổi sử dụng hoá đơn điện tử có mã của
                      cơ quan thuế.
                    </li>
                    <li>
                      Doanh nghiệp rủi ro cao về thuế: Người nộp thuế thuộc
                      đối tượng sử dụng hóa đơn điện tử không có mã theo quy
                      định tại khoản 2 Điều 91 Luật Quản lý thuế số
                      38/2019/QH14 nếu thuộc trường hợp được xác định rủi ro
                      cao về thuế theo quy định tại Thông tư số 31/2021/TT-BTC
                      ngày 17/5/2021 của Bộ Tài chính quy định về áp dụng rủi
                      ro trong quản lý thuế và được cơ quan thuế thông báo
                      (Mẫu số 01/TB-KTT Phụ lục IB ban hành kèm theo Nghị định
                      số 123/2020/NĐ-CP) về việc chuyển đổi áp dụng hóa đơn
                      điện tử có mã của cơ quan thuế thì phải chuyển đổi sang
                      áp dụng hóa đơn điện tử có mã của cơ quan thuế. Trong
                      thời gian mười (10) ngày làm việc kể từ ngày cơ quan
                      thuế phát hành thông báo, người nộp thuế phải thay đổi
                      thông tin sử dụng hóa đơn điện tử (chuyển từ sử dụng hóa
                      đơn điện tử không có mã sang hóa đơn điện tử có mã của
                      cơ quan thuế) theo quy định tại Điều 15 Nghị định số
                      123/2020/NĐ-CP và thực hiện theo thông báo của cơ quan
                      thuế.
                    </li>
                    <li>
                      Hộ kinh doanh, cá nhân kinh doanh sử dụng hóa đơn điện
                      tử bao gồm:
                      <ul clas="ulPostBody">
                        <li>
                          Hộ kinh doanh, cá nhân kinh doanh nộp thuế theo
                          phương pháp kê khai phải sử dụng hóa đơn điện tử;
                        </li>
                        <li>
                          Hộ kinh doanh, cá nhân kinh doanh nộp thuế theo
                          phương pháp khoán nếu có yêu cầu sử dụng hóa đơn thì
                          cơ quan thuế cấp lẻ hóa đơn điện tử theo từng lần
                          phát sinh;
                        </li>
                        <li>
                          Hộ kinh doanh, cá nhân kinh doanh khai thuế theo
                          từng lần phát sinh nếu có yêu cầu sử dụng hóa đơn
                          thì cơ quan thuế cấp lẻ hóa đơn điện tử theo từng
                          lần phát sinh.
                        </li>
                      </ul>
                    </li>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#010">
                  <span class="panel-title clearfix col-xs-11">Câu 10: Đối tượng áp dụng hóa đơn điện tử không có mã của
                    cơ quan thuế?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <ul class="ulPostBody">
                    <li>
                      Doanh nghiệp kinh doanh ở lĩnh vực điện lực, xăng dầu,
                      bưu chính viễn thông, nước sạch, tài chính tín dụng, bảo
                      hiểm, y tế, kinh doanh thương mại điện tử, kinh doanh
                      siêu thị, thương mại, vận tải hàng không, đường bộ,
                      đường sắt, đường biển, đường thủy và doanh nghiệp, tổ
                      chức kinh tế đã hoặc sẽ thực hiện giao dịch với cơ quan
                      thuế bằng phương tiện điện tử, xây dựng hạ tầng công
                      nghệ thông tin, có hệ thống phần mềm kế toán, phần mềm
                      lập hóa đơn điện tử đáp ứng lập, tra cứu hóa đơn điện
                      tử, lưu trữ dữ liệu hóa đơn điện tử theo quy định và bảo
                      đảm việc truyền dữ liệu hóa đơn điện tử đến người mua và
                      đến cơ quan thuế thì được sử dụng hóa đơn điện tử không
                      có mã của cơ quan thuế khi bán hàng hóa, cung cấp dịch
                      vụ, không phân biệt giá trị từng lần bán hàng hóa, cung
                      cấp dịch vụ, trừ trường hợp rủi ro về thuế cao theo quy
                      định của Bộ trưởng Bộ Tài chính và trường hợp đăng ký sử
                      dụng hóa đơn điện tử có mã của cơ quan thuế.
                    </li>
                    <li>
                      Doanh nghiệp thuộc trường hợp rủi ro cao về thuế chuyển
                      sang sử dụng hóa đơn điện tử có mã của cơ quan thuế
                      nhưng sau 12 tháng kể từ thời điểm chuyển sang sử dụng
                      hóa đơn điện tử có mã của cơ quan thuế, nếu người nộp
                      thuế có nhu cầu sử dụng hóa đơn điện tử không có mã thì
                      người nộp thuế thay đổi thông tin sử dụng hóa đơn điện
                      tử theo quy định tại Điều 15 Nghị định số
                      123/2020/NĐ-CP, cơ quan thuế căn cứ quy định tại khoản 2
                      Điều 91 Luật Quản lý thuế số 38/2019/QH14 và quy định
                      tại Thông tư số 31/2021/TT-BTC để xem xét, quyết định.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#011">
                  <span class="panel-title clearfix col-xs-11">Câu 11: Đối tượng áp dụng hóa đơn được khởi tạo từ máy
                    tính tiền kết nối chuyển dữ liệu điện tử với cơ quan thuế?
                    Lộ trình áp dụng?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Doanh nghiệp, hộ, cá nhân kinh
                    doanh nộp thuế theo phương pháp kê khai có hoạt động cung
                    cấp hàng hoá, dịch vụ trực tiếp đến người tiêu dùng theo
                    mô hình kinh doanh (trung tâm thương mại; siêu thị; bán lẻ
                    hàng tiêu dùng; ăn uống; nhà hàng; khách sạn; bán lẻ thuốc
                    tân dược; dịch vụ vui chơi, giải trí và các dịch vụ khác)
                    được lựa chọn sử dụng hoá đơn điện tử được khởi tạo từ máy
                    tính tiền có kết nối chuyển dữ liệu điện tử với cơ quan
                    thuế hoặc hóa đơn điện tử có mã, hóa đơn điện tử không có
                    mã.
                  </p>
                  <p>
                    Việc sử dụng hoá đơn điện tử được khởi tạo từ máy tính
                    tiền có kết nối chuyển dữ liệu điện tử với cơ quan thuế sẽ
                    theo lộ trình của cơ quan thuế.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#012">
                  <span class="panel-title clearfix col-xs-11">Câu 12: Thế nào là hóa đơn hợp pháp? Hóa đơn giả?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong> Hóa đơn, chứng từ hợp pháp là
                    hóa đơn, chứng từ đảm bảo đúng, đầy đủ về hình thức và nội
                    dung theo quy định.
                  </p>
                  <p>
                    Hóa đơn, chứng từ giả là hóa đơn, chứng từ được in hoặc
                    khởi tạo theo mẫu hóa đơn, chứng từ đã được thông báo phát
                    hành của tổ chức, cá nhân khác hoặc in, khởi tạo trùng số
                    của cùng một ký hiệu hóa đơn, chứng từ hoặc làm giả hóa
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#013">
                  <span class="panel-title clearfix col-xs-11">Câu 13: Thế nào là hành vi sử dụng hóa đơn bất hợp pháp?
                    Sử dụng bất hợp pháp hóa đơn?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                style="height: 0px; margin-left: 6px">
                <div class="panel-body" itemprop="text">
                  <p><strong>Sử dụng hóa đơn không hợp pháp là:</strong></p>
                  <ul class="ulPostBody">
                    <li>Việc sử dụng hóa đơn giả;</li>
                    <li>
                      Sử dụng hóa đơn chưa có giá trị sử dụng, hết giá trị sử
                      dụng;
                    </li>
                    <li>
                      Sử dụng hóa đơn bị ngừng sử dụng trong thời gian bị
                      cưỡng chế bằng biện pháp ngừng sử dụng hóa đơn, trừ
                      trường hợp được phép sử dụng theo thông báo của cơ quan
                      thuế;
                    </li>
                    <li>
                      Sử dụng hóa đơn điện tử không đăng ký sử dụng với cơ
                      quan thuế;
                    </li>
                    <li>
                      Sử dụng hóa đơn điện tử chưa có mã của cơ quan thuế đối
                      với trường hợp sử dụng hóa đơn điện tử có mã của cơ quan
                      thuế;
                    </li>
                    <li>
                      Sử dụng hóa đơn mua hàng hóa, dịch vụ có ngày lập trên
                      hóa đơn từ ngày cơ quan thuế xác định bên bán không hoạt
                      động tại địa chỉ kinh doanh đã đăng ký với cơ quan nhà
                      nước có thẩm quyền;
                    </li>
                    <li>
                      Sử dụng hóa đơn mua hàng hóa, dịch vụ có ngày lập trên
                      hóa đơn, chứng từ trước ngày xác định bên lập hóa đơn,
                      chứng từ không hoạt động tại địa chỉ kinh doanh đã đăng
                      ký với cơ quan nhà nước có thẩm quyền hoặc chưa có thông
                      báo của cơ quan thuế về việc bên lập hóa đơn không hoạt
                      động tại địa chỉ kinh doanh đã đăng ký với cơ quan có
                      thẩm quyền nhưng cơ quan thuế hoặc cơ quan công an hoặc
                      các cơ quan chức năng khác đã có kết luận đó là hóa đơn
                      không hợp pháp.
                    </li>
                  </ul>
                  <p>
                    <strong>Sử dụng không hợp pháp hóa đơn là việc sử dụng:</strong>
                  </p>
                  <ul class="ulPostBody">
                    <li>
                      Hóa đơn không ghi đầy đủ các nội dung bắt buộc theo quy
                      định;
                    </li>
                    <li>Hóa đơn tẩy xóa, sửa chữa không đúng quy định;</li>
                    <li>
                      Sử dụng hóa đơn khống (hóa đơn đã ghi các chỉ tiêu, nội
                      dung nghiệp vụ kinh tế nhưng việc mua bán hàng hóa, dịch
                      vụ không có thật một phần hoặc toàn bộ);
                    </li>
                    <li>
                      Sử dụng hóa đơn phản ánh không đúng giá trị thực tế phát
                      sinh hoặc lập hóa đơn khống, lập hóa đơn giả;
                    </li>
                    <li>
                      Sử dụng hóa đơn có sự chênh lệch về giá trị hàng hóa,
                      dịch vụ hoặc sai lệch các tiêu thức bắt buộc giữa các
                      liên của hóa đơn;
                    </li>
                    <li>
                      Sử dụng hóa đơn để quay vòng khi vận chuyển hàng hóa
                      trong khâu lưu thông hoặc dùng hóa đơn của hàng hóa,
                      dịch vụ này để chứng minh cho hàng hóa, dịch vụ khác;
                    </li>
                    <li>
                      Sử dụng hóa đơn của tổ chức, cá nhân khác (trừ hóa đơn
                      của cơ quan thuế và trường hợp được ủy nhiệm lập hóa
                      đơn) để hợp thức hóa hàng hóa, dịch vụ mua vào hoặc hàng
                      hóa, dịch vụ bán ra;
                    </li>
                    <li>
                      Sử dụng hóa đơn mà cơ quan thuế hoặc cơ quan công an
                      hoặc các cơ quan chức năng khác đã kết luận là sử dụng
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#014">
                  <span class="panel-title clearfix col-xs-11">Câu 14: Các hành vi bị cấm trong lĩnh vực hóa đơn?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p><strong>Trả lời:</strong></p>
                  <p>Đối với công chức thuế, hành vi bị cấm bao gồm:</p>
                  <ul class="ulPostBody">
                    <li>
                      Gây phiền hà, khó khăn cho tổ chức, cá nhân đến mua hóa
                      đơn;
                    </li>
                    <li>
                      Có hành vi bao che, thông đồng cho tổ chức, cá nhân để
                      sử dụng hóa đơn không hợp pháp;
                    </li>
                    <li>Nhận hối lộ khi thanh tra, kiểm tra về hóa đơn.</li>
                  </ul>
                  <p>
                    Đối với tổ chức, cá nhân bán, cung cấp hàng hóa, dịch vụ,
                    tổ chức, cá nhân có quyền và nghĩa vụ liên quan, hành vi
                    bị cấm bao gồm:
                  </p>
                  <ul class="ulPostBody">
                    <li>
                      Thực hiện hành vi gian dối như sử dụng hóa đơn không hợp
                      pháp, sử dụng không hợp pháp hóa đơn;
                    </li>
                    <li>
                      Cản trở công chức thuế thi hành công vụ, cụ thể các hành
                      vi cản trở gây tổn hại sức khỏe, nhân phẩm của công chức
                      thuế khi đang thanh tra, kiểm tra về hóa đơn;
                    </li>
                    <li>
                      Truy cập trái phép, làm sai lệch, phá hủy hệ thống thông
                      tin về hóa đơn;
                    </li>
                    <li>
                      Đưa hối lộ hoặc thực hiện các hành vi khác liên quan hóa
                      đơn nhằm mưu lợi bất chính.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#015">
                  <span class="panel-title clearfix col-xs-11">Câu 15: Thế nào là tiêu hủy hóa đơn? Tiêu hủy hóa đơn do
                    cơ quan thuế đặt in?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p><strong>Trả lời:</strong></p>
                  <p>
                    Tiêu hủy hóa đơn là biện pháp làm cho hóa đơn điện tử
                    không còn tồn tại trên hệ thống thông tin, không thể truy
                    cập và tham chiếu đến thông tin chứa trong hóa đơn điện
                    tử.
                  </p>
                  <p>
                    Tiêu hủy hóa đơn do cơ quan thuế đặt in là việc sử dụng
                    biện pháp đốt cháy, cắt, xé nhỏ hoặc hình thức tiêu hủy
                    khác, đảm bảo hóa đơn, chứng từ đã tiêu hủy sẽ không thể
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#016">
                  <span class="panel-title clearfix col-xs-11">Câu 16: Khi bán hàng hóa, cung cấp dịch vụ, người bán
                    phải lập hóa đơn đảm bảo yêu cầu như thế nào?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    ...
                    đơn để giao cho người mua (bao gồm cả các trường hợp hàng
                    hóa, dịch vụ dùng để khuyến mại, quảng cáo, hàng mẫu; hàng
                    hóa, dịch vụ dùng để cho, biếu, tặng, trao đổi, trả thay
                    lương cho người lao động và tiêu dùng nội bộ (trừ hàng hóa
                    luân chuyển nội bộ để tiếp tục quá trình sản xuất); xuất
                    hàng hóa dưới các hình thức cho vay, cho mượn hoặc hoàn
                    trả hàng hóa) và phải ghi đầy đủ nội dung theo quy định
                    tại Điều 10 Nghị định này, trường hợp sử dụng hóa đơn điện
                    tử thì phải theo định dạng chuẩn dữ liệu của cơ quan thuế
                    theo quy định tại Điều 12 Nghị định số 123/2020/NĐ-CP.
                  </p>
                  <p>
                    Khi bán hàng hóa, cung cấp dịch vụ, người bán phải lập hóa
                    đơn điện tử để giao cho người mua theo định dạng chuẩn dữ
                    liệu và phải ghi đầy đủ nội dung theo quy định của pháp
                    luật về thuế, pháp luật về kế toán, không phân biệt giá
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#017">
                  <span class="panel-title clearfix col-xs-11">Câu 17: Thủ tục Đăng ký sử dụng/Thông báo phát hành với
                    cơ quan thuế như thế nào?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Trước khi sử dụng hóa đơn, biên lai doanh nghiệp, tổ chức
                    kinh tế, tổ chức khác, hộ, cá nhân kinh doanh, tổ chức thu
                    thuế, phí, lệ phí phải thực hiện đăng ký sử dụng với cơ
                    quan thuế hoặc thực hiện thông báo phát hành theo quy định
                    tại Điều 15, Điều 34 và khoản 1 Điều 36 Nghị định số
                    123/2020/NĐ-CP. Đối với hóa đơn, biên lai do cơ quan thuế
                    đặt in, cơ quan thuế thực hiện thông báo phát hành theo
                    khoản 3 Điều 24 và khoản 2 Điều 36 Nghị định số
                    123/2020/NĐ-CP.
                  </p>
                  <p>
                    Trường hợp người bán có sử dụng máy tính tiền thì người
                    bán đăng ký sử dụng hóa đơn điện tử được khởi tạo từ máy
                    tính tiền có kết nối chuyển dữ liệu điện tử với cơ quan
                    thuế.
                  </p>
                </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#018">
                  <span class="panel-title clearfix col-xs-11">Câu 18: Phương thức bảo quản, lưu trữ hóa đơn điện tử như
                    thế nào ? Đối với hóa đơn do cơ quan thuế đặt in đảm bảo
                    yêu cầu gì ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Hóa đơn điện tử được bảo quản, lưu trữ bằng phương tiện
                    điện tử. Cơ quan, tổ chức, cá nhân được quyền lựa chọn và
                    áp dụng hình thức bảo quản, lưu trữ hóa đơn điện tử phù
                    hợp với đặc thù hoạt động và khả năng ứng dụng công nghệ.
                    Hóa đơn điện tử phải sẵn sàng in được ra giấy hoặc tra cứu
                    được khi có yêu cầu.
                  </p>
                  <p>
                    Hóa đơn do cơ quan thuế đặt in phải bảo quản, lưu trữ đúng
                    với yêu cầu sau:
                  </p>
                  <ul class="ulPostBody">
                    <li>
                      Hóa đơn chưa lập được lưu trữ, bảo quản trong kho theo
                      chế độ lưu trữ bảo quản chứng từ có giá.
                    </li>
                    <li>
                      Hóa đơn đã lập trong các đơn vị kế toán được lưu trữ
                      theo quy định lưu trữ, bảo quản chứng từ kế toán.
                    </li>
                    <li>
                      Hóa đơn đã lập trong các tổ chức, hộ, cá nhân không phải
                      là đơn vị kế toán được lưu trữ và bảo quản như tài sản
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#019">
                  <span class="panel-title clearfix col-xs-11">Câu 19: Khi nào cần chuyển đổi hóa đơn điện tử thành hóa
                    đơn giấy và việc chuyển đổi đảm bảo theo nguyên tắc
                    gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Hóa đơn điện tử hợp pháp được chuyển đổi thành hóa đơn
                    giấy khi có yêu cầu nghiệp vụ kinh tế, tài chính phát sinh
                    hoặc theo yêu cầu của cơ quan quản lý thuế, cơ quan kiểm
                    toán, thanh tra, kiểm tra, điều tra và theo quy định của
                    pháp luật về thanh tra, kiểm tra và điều tra.
                  </p>
                  <p>
                    Việc chuyển đổi hóa đơn điện tử thành hóa đơn giấy phải
                    bảo đảm sự khớp đúng giữa nội dung của hóa đơn điện tử,
                    chứng từ điện tử và hóa đơn, chứng từ giấy sau khi chuyển
                    đổi.
                  </p>
                  <p>
                    Hóa đơn điện tử được chuyển đổi thành hóa đơn giấy thì hóa
                    đơn giấy chỉ có giá trị lưu giữ để ghi sổ, theo dõi theo
                    quy định của pháp luật về kế toán, pháp luật về giao dịch
                    điện tử, không có hiệu lực để giao dịch, thanh toán, trừ
                    trường hợp hóa đơn được khởi tạo từ máy tính tiền có kết
                    nối chuyển dữ liệu điện tử với cơ quan thuế theo quy định
                    tại Nghị định này.
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#020">
                  <span class="panel-title clearfix col-xs-11">Câu 20: Đối tượng áp dụng hóa đơn GTGT? Hóa đơn bán hàng
                    ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <ol type="1">
                    <li>
                      <p>
                        Hóa đơn giá trị gia tăng là hóa đơn dành cho các tổ
                        chức khai thuế giá trị gia tăng theo phương pháp khấu
                        trừ sử dụng cho các hoạt động:
                      </p>
                      <ol type="a">
                        <li>Bán hàng hóa, cung cấp dịch vụ trong nội địa;</li>
                        <li>Hoạt động vận tải quốc tế;</li>
                        <li>
                    ...
                    <li>
                      <p>
                        Hóa đơn bán hàng là hóa đơn dành cho các tổ chức, cá
                        nhân như sau:
                      </p>
                      <ol type="a">
                        <li>
                          Tổ chức, cá nhân khai, tính thuế giá trị gia tăng
                          theo phương pháp trực tiếp sử dụng cho các hoạt
                          động:
                        </li>
                        <ul class="ulPostBody">
                          <li>
                          ...
                          <li>
                            Xuất khẩu hàng hóa, cung cấp dịch vụ ra nước
                            ngoài.
                          </li>
                        </ul>
                        <li>
                          Tổ chức, cá nhân trong khu phi thuế quan khi bán
                          hàng hóa, cung cấp dịch vụ vào nội địa và khi bán
                          hàng hóa, cung ứng dịch vụ giữa các tổ chức, cá nhân
                          trong khu phi thuế quan với nhau, xuất khẩu hàng
                          hóa, cung cấp dịch vụ ra nước ngoài, trên hóa đơn
                          ghi rõ &#8220;Dành cho tổ chức, cá nhân trong khu
                          phi thuế quan&#8221;.
                        </li>
                      </ol>
                    </li>
            ...
            <h2 style="font-size: 1.5em; font-weight: 700">
              PHẦN B - ĐẶT VÀ TRẢ LỜI CÂU HỎI VỀ CHỨNG TỪ
            </h2>
            <div
              class="accordion-item panel"
              itemprop="mainEntity"
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#021">
                  <span class="panel-title clearfix col-xs-11">Câu 21: Chứng từ là gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời: </strong>Chứng từ là tài liệu dùng để ghi
                    nhận thông tin về các khoản thuế khấu trừ, các khoản thu
                    thuế, phí và lệ phí thuộc ngân sách nhà nước theo quy định
                    của pháp luật quản lý thuế. Chứng từ theo quy định bao gồm
                    chứng từ khấu trừ thuế thu nhập cá nhân, biên lai thuế,
                    phí, lệ phí được thể hiện theo hình thức điện tử hoặc đặt
                    in, tự in.
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#022">
                  <span class="panel-title clearfix col-xs-11">Câu 22: Có bao nhiêu hình thức chứng từ? Thế nào là chứng
                    từ điện tử ? Chứng từ in, tự in?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong>Có 2 hình thức chứng từ là chứng
                    từ điện tử và chứng từ in, tự in
                  </p>
                  <ol>
                    <li>
                      Chứng từ điện tử <br />
                      <p>
                        ...
                        được thể hiện ở dạng dữ liệu điện tử do cơ quan quản
                        lý thuế hoặc tổ chức có trách nhiệm khấu trừ thuế cấp
                        cho người nộp thuế bằng phương tiện điện tử khi thực
                        hiện các thủ tục về thuế hoặc các khoản thu khác thuộc
                        ngân sách nhà nước và các loại chứng từ, biên lai điện
                        tử khác.)
                      </p>
                      <p>
                        Chứng từ điện tử bao gồm các loại chứng từ, biên lai
                        (chứng từ khấu trừ thuế thu nhập cá nhân, biên lai
                        thuế, phí, lệ phí) được thể hiện ở dạng dữ liệu điện
                        tử do tổ chức, cá nhân có trách nhiệm khấu trừ thuế
                        cấp cho người nộp thuế hoặc do tổ chức thu thuế, phí,
                        lệ phí cấp cho người nộp bằng phương tiện điện tử theo
                        quy định của pháp luật phí, lệ phí, pháp luật thuế khi
                        thực hiện các thủ tục về thuế hoặc các khoản thu khác
                        thuộc ngân sách nhà nước và các loại chứng từ, biên
                        lai điện tử khác.
                      </p>
                    </li>
                    <li>
                      Chứng từ đặt in, tự in<br />
                      <p>
                        Chứng từ đặt in, tự in bao gồm các loại chứng từ, biên
                        lai (chứng từ khấu trừ thuế thu nhập cá nhân, biên lai
                        thuế, phí, lệ phí) được thể hiện ở dạng giấy do cơ
                        quan thuế, tổ chức thu thuế, phí, lệ phí đặt in theo
                        mẫu để sử dụng hoặc tự in trên các thiết bị tin học,
                        máy tính tiền hoặc các thiết bị khác khi khấu trừ
                        thuế, khi thu thuế, phí, lệ phí theo quy định của pháp
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#023">
                  <span class="panel-title clearfix col-xs-11">Câu 23: Đối với trường hợp giao hàng nhiều lần hoặc bàn
                    giao từng hạng mục, công đoạn dịch vụ thì thời điểm lập
                    hóa đơn được quy định như thế nào?Thế nào là Chứng từ hợp
                    pháp ? Chứng từ giả ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Chứng từ hợp pháp là chứng từ đảm bảo đúng, đầy đủ về hình
                    thức và nội dung theo quy định tại Nghị định số
                    123/2020/NĐ-CP. Chứng từ giả là chứng từ được in hoặc khởi
                    tạo theo mẫu hóa đơn, chứng từ đã được thông báo phát hành
                    của tổ chức, cá nhân khác hoặc in, khởi tạo trùng số của
                    cùng một ký hiệu hóa đơn, chứng từ hoặc làm giả hóa đơn
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#024">
                  <span class="panel-title clearfix col-xs-11">Câu 24: Thế nào là hành vi sử dụng chứng từ bất hợp pháp?
                    Sử dụng bất hợp pháp chứng từ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p><strong>Sử dụng chứng từ không hợp pháp là: </strong></p>
                  <ul class="ulPostBody">
                    <li>Việc sử dụng chứng từ giả;</li>
                    <li>
                      Sử dụng chứng từ chưa có giá trị sử dụng, hết giá trị sử
                      dụng;
                    </li>
                    <li>
                      Sử dụng chứng từ mua hàng hóa, dịch vụ có ngày lập trên
                      , chứng từ trước ngày xác định bên lập chứng từ không
                      hoạt động tại địa chỉ kinh doanh đã đăng ký với cơ quan
                      nhà nước có thẩm quyền hoặc chưa có thông báo của cơ
                      quan thuế về việc bên lập hóa đơn, chứng từ không hoạt
                      động tại địa chỉ kinh doanh đã đăng ký với cơ quan có
                      thẩm quyền nhưng cơ quan thuế hoặc cơ quan công an hoặc
                      các cơ quan chức năng khác đã có kết luận đó là chứng từ
                      không hợp pháp.
                    </li>
                  </ul>
                  <p>Sử dụng không hợp pháp chứng từ là việc sử dụng:</p>
                  <ul>
                    <li>
                      Chứng từ không ghi đầy đủ các nội dung bắt buộc theo quy
                      định;
                    </li>
                    <li>
                      Sử dụng chứng từ khống (chứng từ đã ghi các chỉ tiêu,
                      nội dung nghiệp vụ kinh tế nhưng việc mua bán hàng hóa,
                      dịch vụ không có thật một phần hoặc toàn bộ);
                    </li>
                    <li>
                      Sử dụng chứng từ của tổ chức, cá nhân khác để hợp thức
                      hóa hàng hóa, dịch vụ mua vào hoặc hàng hóa, dịch vụ bán
                      ra;
                    </li>
                    <li>
                      Sử dụng chứng từ mà cơ quan thuế hoặc cơ quan công an
                      hoặc các cơ quan chức năng khác đã kết luận là sử dụng
                      không hợp pháp hóa đơn.
                    </li>
                  </ul>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#025">
                  <span class="panel-title clearfix col-xs-11">Câu 25: Thế nào là hủy chứng từ ? Tiêu hủy chứng từ điện
                    tử ? Tiêu hủy chứng từ giấy ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Hủy chứng từ là làm cho hóa đơn, chứng từ đó không có giá
                    trị sử dụng.
                  </p>
                  <p>
                    Tiêu hủy chứng từ điện tử là biện pháp làm cho chứng từ
                    điện tử không còn tồn tại trên hệ thống thông tin, không
                    thể truy cập và tham chiếu đến thông tin chứa trong, chứng
                    từ điện tử.
                  </p>
                  <p>
                    Tiêu hủy chứng từ đặt in, tự in là việc sử dụng biện pháp
                    đốt cháy, cắt, xé nhỏ hoặc hình thức tiêu hủy khác, đảm
                    bảo hóa đơn, chứng từ đã tiêu hủy sẽ không thể sử dụng lại
                    các thông tin, số liệu trên.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#026">
                  <span class="panel-title clearfix col-xs-11">Câu 26: Khi lập chứng từ khi khấu trừ thuế, khi thu phí,
                    lệ phí đảm bảo nguyên tắc gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Khi khấu trừ thuế thu nhập cá nhân, khi thu thuế, phí, lệ
                    phí, tổ chức khấu trừ thuế, tổ chức thu phí, lệ phí, tổ
                    chức thu thuế phải lập chứng từ khấu trừ thuế, biên lai
                    thu thuế, phí, lệ phí giao cho người có thu nhập bị khấu
                    trừ thuế, người nộp thuế, nộp phí, lệ phí và phải ghi đầy
                    đủ các nội dung theo quy định tại Điều 32 Nghị định này.
                    Trường hợp sử dụng biên lai điện tử thì phải theo định
                    dạng chuẩn dữ liệu của cơ quan thuế. Trường hợp cá nhân ủy
                    quyền quyết toán thuế thì không cấp chứng từ khấu trừ thuế
                    thu nhập cá nhân.
                  </p>
                  <p>
                    Đối với cá nhân không ký hợp đồng lao động hoặc ký hợp
                    đồng lao động dưới 03 tháng thì tổ chức, cá nhân trả thu
                    nhập được lựa chọn cấp chứng từ khấu trừ thuế cho mỗi lần
                    khấu trừ thuế hoặc cấp một chứng từ khấu trừ cho nhiều lần
                    khấu trừ thuế trong một kỳ tính thuế. Đối với cá nhân ký
                    hợp đồng lao động từ 03 tháng trở lên, tổ chức, cá nhân
                    trả thu nhập chỉ cấp cho cá nhân một chứng từ khấu trừ
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#027">
                  <span class="panel-title clearfix col-xs-11">Câu 27: Các hành vi bị cấm trong lĩnh vực chứng từ?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <ol>
                    <li>
                      <strong>Đối với công chức thuế</strong>
                      <ul>
                        <li>
                          Gây phiền hà, khó khăn cho tổ chức, cá nhân đến mua
                          hóa đơn, chứng từ;
                        </li>
                        <li>
                          Có hành vi bao che, thông đồng cho tổ chức, cá nhân
                          để sử dụng hóa đơn, chứng từ không hợp pháp;
                        </li>
                        <li>
                    ...
                    <li>
                      <strong>Đối với tổ chức, cá nhân bán, cung cấp hàng hóa, dịch
                        vụ, tổ chức, cá nhân có quyền và nghĩa vụ liên
                        quan</strong>
                      <ul>
                        <li>
                          Thực hiện hành vi gian dối như sử dụng hóa đơn không
                          hợp pháp, sử dụng không hợp pháp hóa đơn;
                        </li>
                        <li>
                          Cản trở công chức thuế thi hành công vụ, cụ thể các
                          hành vi cản trở gây tổn hại sức khỏe, nhân phẩm của
                          công chức thuế khi đang thanh tra, kiểm tra về hóa
                          đơn, chứng từ;
                        </li>
                        <li>
                          Cản trở công chức thuế thi hành công vụ, cụ thể các
                        ...
                        <li>
                          Đưa hối lộ hoặc thực hiện các hành vi khác liên quan
                          hóa đơn, chứng từ nhằm mưu lợi bất chính.
                        </li>
                      </ul>
                    </li>
                    <li></li>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#028">
                  <span class="panel-title clearfix col-xs-11">Câu 28: Yêu cầu đối với chứng từ được bảo quản, lưu trữ
                    phải được đảm bảo như thế nào?
                  </span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong>Chứng từ được bảo quản, lưu trữ
                    đảm bảo:
                  </p>
                  <ul class="ulPostBody">
                    <li>
                      Tính an toàn, bảo mật, toàn vẹn, đầy đủ, không bị thay
                      đổi, sai lệch trong suốt thời gian lưu trữ;
                    </li>
                    <li>
                      Lưu trữ đúng và đủ thời hạn theo quy định của pháp luật
                      kế toán.
                    </li>
                  </ul>
                </div>
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#029">
                  <span class="panel-title clearfix col-xs-11">Câu 29: Trình bày phương thức bảo quản, lưu trữ hóa đơn
                    điện tử, chứng từ điện tử?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
                </a>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Hóa đơn điện tử, chứng từ điện tử được bảo quản, lưu trữ
                    bằng phương tiện điện tử. Cơ quan, tổ chức, cá nhân được
                    quyền lựa chọn và áp dụng hình thức bảo quản, lưu trữ hóa
                    đơn điện tử, chứng từ điện tử phù hợp với đặc thù hoạt
                    động và khả năng ứng dụng công nghệ. Hóa đơn điện tử,
                    chứng từ điện tử phải sẵn sàng in được ra giấy hoặc tra
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#030">
                  <span class="panel-title clearfix col-xs-11">Câu 30: Các Yêu cầu cần thiết đối với chứng từ đặt in, tự
                    in khi bảo quản, lưu trữ?
                  </span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong>Chứng từ đặt in, tự in phải bảo
                    quản, lưu trữ đúng với yêu cầu sau:
                  </p>
                  <ul class="ulPostBody">
                    <li>
                      Chứng từ chưa lập được lưu trữ, bảo quản trong kho theo
                      chế độ lưu trữ bảo quản chứng từ có giá.
                    </li>
                    <li>
                      Chứng từ đã lập trong các đơn vị kế toán được lưu trữ
                      theo quy định lưu trữ, bảo quản chứng từ kế toán.
                    </li>
                    <li>
                      Chứng từ đã lập trong các tổ chức, hộ, cá nhân không
                      phải là đơn vị kế toán được lưu trữ và bảo quản như tài
            ...
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#031">
                  <span class="panel-title clearfix col-xs-11">Câu 31: Trường hợp nào được áp dụng chuyển đổi chứng từ
                    điện tử thành chứng từ giấy và phải đáp ứng yêu cầu
                    gì?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Hóa đơn điện tử, chứng từ điện tử hợp pháp được chuyển đổi
                    thành hóa đơn, chứng từ giấy khi có yêu cầu nghiệp vụ kinh
                    tế, tài chính phát sinh hoặc theo yêu cầu của cơ quan quản
                    lý thuế, cơ quan kiểm toán, thanh tra, kiểm tra, điều tra
                    và theo quy định của pháp luật về thanh tra, kiểm tra và
                    điều tra.
                  </p>
                  <p>
                    Việc chuyển đổi hóa đơn điện tử, chứng từ điện tử thành
                    hóa đơn, chứng từ giấy phải bảo đảm sự khớp đúng giữa nội
                    dung của hóa đơn điện tử, chứng từ điện tử và hóa đơn,
                    chứng từ giấy sau khi chuyển đổi.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#032">
                  <span class="panel-title clearfix col-xs-11">Câu 32: Chứng từ điện tử được chuyển đổi thành Chứng từ
                    giấy thì chứng từ giấy có hiệu lực khi giao dịch, thanh
                    toán không?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  ...
                  <p>
                    Chứng từ điện tử được chuyển đổi thành chứng từ giấy thì
                    chứng từ giấy chỉ có giá trị lưu giữ để ghi sổ, theo dõi
                    theo quy định của pháp luật về kế toán, pháp luật về giao
                    dịch điện tử, không có hiệu lực để giao dịch, thanh toán.
                  </p>
                </div>
              </div>
            </div>
            <div
              ...
              <h2 class="entry-subtitle" itemprop="name">
                <a
                  ...
                  data-toggle="collapse"
                  href="#033">
                  <span class="panel-title clearfix col-xs-11">Câu 33: Biên lai điện tử cần tuân thủ định dạng như thế
                    nào?</span>
                  <span class="panel-instruction">
                    <i aria-hidden="true" class="fa_click fa fa-plus"></i>
                  </span>
              ...
              <div
                ...
                <div class="panel-body" itemprop="text">
                  <p>
                    <strong>Trả lời:</strong>Các loại biên lai quy định tại
                    điểm b khoản 1 Điều 30 Nghị định số 123/2020/NĐ-CP phải
                    thực hiện theo định dạng sau:
                  </p>
                  <ol type="a">
                    <li>
                      Định dạng biên lai điện tử sử dụng ngôn ngữ định dạng
                      văn bản XML (XML là chữ viết tắt của cụm từ tiếng Anh
                      "eXtensible Markup Language" được tạo ra với mục đích
                      chia sẻ dữ liệu điện tử giữa các hệ thống công nghệ
                      thông tin);
                    </li>
                    <li>
                      Định dạng biên lai điện tử gồm hai thành phần: thành
                      phần chứa dữ liệu nghiệp vụ biên lai điện tử và thành
                      phần chứa dữ liệu chữ ký số;
                    </li>
                    <li>
                      Tổng cục Thuế xây dựng và công bố thành phần chứa dữ
                      liệu nghiệp vụ biên lai điện tử, thành phần chứa dữ liệu
                      chữ ký số và cung cấp công cụ hiển thị các nội dung của
                      biên lai điện tử theo quy định tại Nghị định số
                      123/2020/NĐ-CP.
                    </li>
                  </ol>
                </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "2595224797553661360",
        pageName: "Câu hỏi thường gặp Sinvoice",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/cau-hoi-thuong-gap-sinvoice.php",
