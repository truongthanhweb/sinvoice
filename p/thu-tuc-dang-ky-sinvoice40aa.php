...
<head>
  ...
  <link href="thu-tuc-dang-ky-sinvoice.php" rel="canonical" />
  <link
    href="thu-tuc-dang-ky-sinvoice40aa.php?m=1"
  ...
  <link
    ...
    media="handheld"
    rel="alternate" />
  <title>Thủ tục đăng ký Sinvoice</title>
  <meta
    content="Thủ tục đăng ký dịch vụ Hóa đơn điện tử S-Invoice tại website sinvoice.vn | Hồ sơ đăng ký dịch vụ | Mẫu hóa đơn | Hình thức thanh toán "
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/p/thu-tuc-dang-ky-sinvoice.php"
    property="og:url" />
  <meta content="Thủ tục đăng ký Sinvoice" property="og:title" />
  <meta
    content="Thủ tục đăng ký dịch vụ Hóa đơn điện tử S-Invoice tại website sinvoice.vn | Hồ sơ đăng ký dịch vụ | Mẫu hóa đơn | Hình thức thanh toán "
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-xs-12 content_support">
          <div id="content" itemscope="" itemtype="https://schema.org/HowTo">
            <h1 class="entry-title" itemprop="name">
              <strong>Thủ tục đăng ký dịch vụ Hóa đơn điện tử S-Invoice</strong>
            </h1>
            <div itemprop="description">
              <p>
                Chúng tôi cam kết đấu nối và bàn giao dịch vụ chỉ trong
                <span content="P2H" itemprop="totalTime">2h làm việc</span>.
                Hồ sơ và các bước đăng ký dịch vụ hóa đơn điện tử S-Invoice
                như sau:
              </p>
            </div>
            <h2 class="entry-subtitle">
              <strong>Hồ sơ của doanh nghiệp bao gồm:</strong>
            </h2>
            <ul class="ulPostBody">
              <li
                itemprop="supply"
                ...
                <span itemprop="name">
                  Bản sao có công chứng giấy phép đăng ký kinh doanh hoặc bản
                  sao có công chứng giấy phép hoạt động (chấp nhận bản photo
                  đóng dấu của tổ chức/doanh nghiệp đó nếu có bản gốc để đối
                  chiếu);</span>
              </li>
              <li
                itemprop="supply"
                itemscope=""
                itemtype="http://schema.org/HowToSupply">
                <span itemprop="name">Bản sao có công chứng chứng minh thư nhân dân của người đại
                  diện pháp lý (hoặc hộ chiếu) (chấp nhận bản photo đóng dấu
                  của tổ chức/doanh nghiệp đó nếu có bản gốc để đối
                  chiếu);</span>
              </li>
            </ul>
            <h2 class="entry-subtitle">
              <strong>Hồ sơ của tổ chức/đơn vị hành chính sự nghiệp/cơ quan nhà
                nước:</strong>
            </h2>
            <ul class="ulPostBody">
              <li
                ...
                itemscope=""
                itemtype="http://schema.org/HowToSupply">
                <span itemprop="name">Bản sao giấy chứng nhận mã số thuế/ thông báo mã số thuế,
                  quyết định bổ nhiệm cán bộ (chấp nhận bản photo đóng dấu của
                  tổ chức/doanh nghiệp đó nếu có bản gốc để đối chiếu);</span>
              </li>
              <li
                itemprop="supply"
                itemscope=""
                itemtype="http://schema.org/HowToSupply">
                <span itemprop="name">Bản sao chứng minh thư hoặc hộ chiếu của người đại diện
                  pháp lý/cán bộ được bổ nhiệm (chấp nhận bản photo đóng dấu
                  của tổ chức/doanh nghiệp đó nếu có bản gốc để đối
                  chiếu);</span>
              </li>
            </ul>
            <div
              itemprop="tool"
              itemscope=""
              itemtype="http://schema.org/HowToTool">
              <p>
                Bên cạnh hồ sơ trên, Quý khách hàng cần chọn mẫu hóa đơn điện
                tử phù hợp với mô hình/tổ chức của doanh nghiệp. Quý khách
                hàng vui lòng tham khảo các mẫu hóa đơn điện tử đẹp tại menu
                <span itemprop="name"><strong><em><a
                        alt="Mẫu hóa đơn"
                        href="mau-hoa-don-gtgt.php"
                        target="_blank">Mẫu hóa đơn</a></em></strong></span>
              </p>
            </div>
            <div
              id="step1"
              ...
              <link
                href="thu-tuc-dang-ky-sinvoice.php#step1"
                itemprop="url" />
              <link
                href="../1.bp.blogspot.com/-hkdRys-GVJ4/YLIaVcRTKrI/AAAAAAAAAeQ/n-sDwXssjN4-OXKXyVvlfJ16cldm8UBEwCLcBGAsYHQ/s16000/thu-tuc-dang-ky-hoa-don-dien-tu.jpg"
                itemprop="image" />
              <h2 class="entry-subtitle" itemprop="name">
                <strong>Bước 1: Gửi hồ sơ đăng ký dịch vụ</strong>
              </h2>
              <div
                ...
                <ul class="ulPostBody" itemprop="text">
                  <li>
                    Quý khách hàng vui lòng gửi hồ sơ trên về email:
                    <strong><img
                        alt="QR-Zalo Sinvoice"
                  ...
                  <li>
                    Mẫu hóa đơn điện tử đã được Viettel thiết kế sẵn ở menu
                    <em><strong><a
                          alt="Mẫu hóa đơn"
                          href="mau-hoa-don-gtgt.php"
                          target="_blank">Mẫu hóa đơn</a></strong></em>, quý khách hàng vui lòng gửi kèm tên mẫu hóa đơn để được
                    hỗ trợ nhanh chóng.
                  </li>
                </ul>
              </div>
            ...
            <div
              ...
              itemtype="https://schema.org/HowToStep">
              <link
                href="thu-tuc-dang-ky-sinvoice.php#step2"
                itemprop="url" />
              <link
                href="../1.bp.blogspot.com/-hkdRys-GVJ4/YLIaVcRTKrI/AAAAAAAAAeQ/n-sDwXssjN4-OXKXyVvlfJ16cldm8UBEwCLcBGAsYHQ/s16000/thu-tuc-dang-ky-hoa-don-dien-tu.jpg"
                itemprop="image" />
              <h2 class="entry-subtitle" itemprop="name">
                <strong>Bước 2: Bàn giao tài khoản HDDT và hướng dẫn sử
                  dụng</strong>
              </h2>
              <div
                itemprop="itemListElement"
                ...
                <ul class="ulPostBody" itemprop="text">
                  <li>
                    Dựa vào mẫu hóa đơn đã chọn, nhân viên Viettel sẽ thiết kế
                    và đấu nối gói hóa đơn tương ứng với hợp đồng đã ký.
                  </li>
                  <li>
                    Thời gian đấu nối tối đa là
                    <span content="P2H" itemprop="totalTime">2h làm việc</span>
                    kẻ từ khi nhận đầy đủ hồ sơ. Ngay sau đó, khách hàng sẽ có
                    thể sử dụng dịch vụ.
                  </li>
                </ul>
              </div>
            ...
            <div
              ...
              itemtype="https://schema.org/HowToStep">
              <link
                href="thu-tuc-dang-ky-sinvoice.php#step3"
                itemprop="url" />
              <link
                href="../1.bp.blogspot.com/-hkdRys-GVJ4/YLIaVcRTKrI/AAAAAAAAAeQ/n-sDwXssjN4-OXKXyVvlfJ16cldm8UBEwCLcBGAsYHQ/s16000/thu-tuc-dang-ky-hoa-don-dien-tu.jpg"
                itemprop="image" />
              <h2 class="entry-subtitle" itemprop="name">
                <strong>Bước 3: Lập thông báo phát hành hóa đơn điện tử</strong>
              </h2>
              <div
                itemprop="itemListElement"
                itemscope=""
                ...
                <ul class="ulPostBody" itemprop="text">
                  <li>
                    Nhân viên Viettel sẽ hỗ trợ khách hàng lập thông báo phát
                    hành qua mạng.
                  </li>
                  <li>
                    Sau khi chi cục Thuế duyệt thông báo phát hành hóa đơn
                    (sau 2 ngày làm việc), khách hàng có thể phát hành hóa đơn
            ...
            <div
              ...
              itemtype="https://schema.org/HowToStep">
              <link
                href="thu-tuc-dang-ky-sinvoice.php#step4"
                itemprop="url" />
              <link
                href="../1.bp.blogspot.com/-hkdRys-GVJ4/YLIaVcRTKrI/AAAAAAAAAeQ/n-sDwXssjN4-OXKXyVvlfJ16cldm8UBEwCLcBGAsYHQ/s16000/thu-tuc-dang-ky-hoa-don-dien-tu.jpg"
                itemprop="image" />
              <h2 class="entry-subtitle" itemprop="name">
                <strong>Bước 4: Thanh toán</strong>
              </h2>
              <div
                itemprop="itemListElement"
                itemscope=""
                ...
                <div itemprop="text">
                  ...
                  <ul class="ulPostBody">
                    ...
                    <li>
                      Địa chỉ:
                      <strong>Số 1, Trần Hữu Dực, Phường Mỹ Đình 2, Q.Nam Từ Liêm,
                        TP.Hà Nội</strong>
                    </li>
                    <li>
                      Nội dung ví dụ:
                      <strong>Cong ty TNHH ABC thanh toan dich vu HDDT Viettel theo
                        hoa don so: 123456.</strong>
                    </li>
                  </ul>
                </div>
              </div>
              <p>
                <strong>Trân trọng cảm ơn Quý khách hàng đã quan tâm đến dịch vụ
                  của Chúng tôi!</strong>
              </p>
            </div>
          </div>
        </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "6850333798842206741",
        pageName: "Thủ tục đăng ký Sinvoice",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/thu-tuc-dang-ky-sinvoice.php",
