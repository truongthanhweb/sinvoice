...
<head>
  ...
  <link href="bang-gia-viettel-ca.php" rel="canonical" />
  <link
    href="bang-gia-viettel-ca40aa.php?m=1"
  ...
  <link
    ...
    media="handheld"
    rel="alternate" />
  <title>Bảng giá Viettel-CA</title>
  <meta
  ...
  <meta
    content="https://www.sinvoice.vn/p/bang-gia-viettel-ca.php"
    property="og:url" />
  <meta content="Bảng giá Viettel-CA" property="og:title" />
  <meta
    content="Hóa đơn điện tử S-Invoice | Hỗ trợ 100% thủ tục thông báo phát hành hóa đơn | Lưu trữ miễn phí trong 10 năm"
  ...
  <div class="header-image section" id="header-image-2">
    <div>
      <img
        ...
        height="302"
        loading="lazy"
        src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgHYkiSbH_dNX5J1st8Eho2wdiN5JUHUQWAhgpTwbxHlB8UW-Il94nrGhk6z7BZccbEnfUQZVFPrD9_PD4b-lP51tXzrzZLp2q3--m0LhtvbZC5LfgbClS_nxF6DpRFn1F6GWhxMSE-BsINhPmqErTt3npqaFmq6eLPmaETgloBp47JxT1MV_3vZf12Cw/s16000/banner-sinvoice-tra-cuu_NEW.webp"
        width="1600" />
    </div>
  </div>
      ...
      <div class="col-md-8 section" id="main-1">
        <div class="widget Blog" data-version="2" id="Blog1">
          <div class="main_top" style="margin-top: 20px">
            <script type="application/ld+json">
              {
                ...
                "itemListElement": {
                  "@type": "ListItem",
                  "position": "1",
                  "name": "Bảng giá dịch vụ Chữ ký số Viettel-CA",
                  "item": "https://www.sinvoice.vn/p/bang-gia-viettel-ca.php"
                }
              }
            </script>
            <script type="application/ld+json">
              {
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.sinvoice.vn/p/bang-gia-viettel-ca.php"
                },
                "headline": "Bảng giá dịch vụ Chữ ký số Viettel-CA",
            ...
            <h1 class="entry-title">Bảng giá dịch vụ Chữ ký số Viettel-CA</h1>
            <div class="divPostBody">
              <p>
                ...
                giá dịch vụ &#8220;Chữ ký số Viettel-CA&#8221; như sau:
              </p>
              <h2 class="entry-subtitle">
                <strong>1. Giá chữ ký số dành cho doanh nghịêp/tổ chức:</strong>
              </h2>
              <p class="textRight">
                <strong>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="text-align: left">Giá thiết bị USB:</td>
                    ...
                    <tr>
                      <td class="text-center noiDungHoTro" colspan="5">
                        <p class="level hidden">Đăng ký USB token</p>
                        <a
                          class="btn"
                          data-target="#form-order"
                          data-toggle="modal"
              ...
              <ul class="ulPostBody">
                ...
                <li>
                  Chữ ký số USB token Viettel-CA có thể dùng để ký cùng lúc:
                  hóa đơn điện tử, thuế điện tử, hải quan điện tử, BHXH điện
                  tử...
                </li>
                <li>
              ...
              <h2 class="entry-subtitle">
                <strong>2. Giá chữ ký số HSM chỉ ký hóa đơn điện tử
                  S-Invoice:</strong>
              </h2>
              <p class="textRight">
                <strong>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="text-align: left">Giá chứng thư:</td>
                      <td style="vertical-align: middle">880.000</td>
                      <td style="vertical-align: middle">1.650.000</td>
                      <td style="vertical-align: middle">2.310.000</td>
                    </tr>
                    <tr>
                      <td style="vertical-align: middle; text-align: left">
                        <strong>Tổng giá bán:</strong>
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: middle">
                        Tặng thêm 12 tháng, tổng 24 tháng.
                      </td>
                      <td style="vertical-align: middle">
                        Tặng thêm 12 tháng, tổng 36 tháng.
                      </td>
                      <td style="vertical-align: middle">
                        Tặng thêm 12 tháng, tổng 48 tháng.
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="text-center noiDungHoTro" colspan="5">
                        <p class="level hidden">Đăng ký HSM</p>
                        <a
                          class="btn"
                          data-target="#form-order"
                          data-toggle="modal"
              ...
              <ul class="ulPostBody">
                <li>Giá bán trên đã bao gồm <strong>VAT 10%</strong>;</li>
                <li>
                  Chữ ký số HSM: là chữ ký số tích hợp sẵn trên hệ thống hóa
                  đơn điện tử, chỉ dùng để ký hóa đơn điện tử Viettel, không
                  dùng ký các giao dịch điện tử khác;
                  <a
                    class="color-warning"
                    href="../2020/11/giai-phap-ky-hoa-don-dien-tu-sinvoice-bang-chu-ky-so-hsm.php"
                    target="_blank"
                    title="Giải pháp ký hóa đơn điện tử S-Invoice bằng chữ ký số server HSM tích hợp"><strong>Tìm hiểu thêm</strong></a>
                </li>
                <li>
                  Chi tiết vui lòng liên hệ hotline bán hàng
                  <span class="color-primary">0586899444</span> để được tư
              ...
              <h2 class="entry-subtitle">
                <strong>2. Giá chữ ký số dành cho cá nhân:</strong>
              </h2>
              <ul class="ulPostBody">
                <li>
                  Là chứng thư số thể hiện đại diện là cá nhân như : Giám đốc,
                  thủ quỹ, kế toán, hoặc nhân sự liên quan đến việc ký xác
                  nhận các văn bản điện tử thông qua các phần mềm của tổ chức
                  hoặc doanh nghiệp
                </li>
                <li>
                  Một số phần mềm áp dụng:<strong>
                    Cổng Thông tin điện tử (TTĐT) Kho Bạc Nhà Nước VN
                    (KBNN)</strong>, Cổng TTĐT Chính phủ, Văn phòng điện tử Viettel (vOffice),
                  Văn phòng điện tử Khối Ngân Hàng (ACB, VCB, Agribank..)...
                </li>
                <li>
                  Để đáp ứng như cầu của khách hàng, Viettel có 2 hình thức
                  cung cấp CTS Cá nhân như sau:
                </li>
              </ul>
              <p class="textRight">
                <strong>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-center noiDungHoTro" colspan="5">
                        <p class="level hidden">Đăng ký CKS cá nhân</p>
                        <a
                          class="btn"
                          data-target="#form-order"
                          data-toggle="modal"
              ...
              <h2 class="entry-subtitle">
                <strong>4. Thủ tục đăng ký Dịch vụ chữ ký số Viettel</strong>
              </h2>
              <p>
                - Để đăng ký dịch vụ Chữ ký số Viettel một cách nhanh chóng.
              </p>
              <p>
              ...
              <ol>
                <li>
                  Bản sao hợp lệ chứng minh thư của người trực tiếp đăng ký
                  hoặc bản sao hộ chiếu.
                </li>
                <li>
                  Phiếu yêu cầu (PYC) cung cấp dịch vụ Viettel-CA: Mẫu PYC
                  cung cấp dịch vụ Viettel-CA nhân viên Viettel gửi cho khách
                  hàng
                </li>
              </ol>
              <p>
              ...
              <ol>
                ...
                <li>
                  Phiếu yêu cầu (PYC) cung cấp dịch vụ<strong> </strong>Viettel-CA: Mẫu PYC cung cấp dịch vụ Viettel-CA
                  nhân viên Viettel gửi cho khách hàng
                </li>
                <li>
              ...
              <p>
                ...
                <span class="color-primary"><strong>0586 899 444</strong></span>
            ...
            <div class="quotComments">
              <em
                ...
                <p>
                  <strong>Mọi thông tin chi tiết vui lòng liên hệ hotline bán hàng
                    0586899444. Trân trọng!</strong>
                </p>
              </em>
            </div>
          </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "8081349182642481340",
        pageName: "Bảng giá Viettel-CA",
        searchqueryescaped: "",
