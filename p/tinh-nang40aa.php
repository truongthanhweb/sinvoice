...
<head>
  ...
  <link href="tinh-nang.php" rel="canonical" />
  <link
    href="tinh-nang40aa.php?m=1"
    media="only screen and (max-width: 640px)"
    rel="alternate" />
  <link href="tinh-nang40aa.php?m=1" media="handheld" rel="alternate" />
  ...
  <meta
    content="https://www.sinvoice.vn/p/tinh-nang.php"
    property="og:url" />
  <meta content="Tính năng" property="og:title" />
  <meta
    content="Hóa đơn điện tử S-Invoice | Hỗ trợ 100% thủ tục thông báo phát hành hóa đơn | Lưu trữ miễn phí trong 10 năm"
          ...
          <div class="main_top" style="margin-top: 20px">
            <script type="application/ld+json">
              {
                ...
                "itemListElement": {
                  "@type": "ListItem",
                  "position": "1",
                  "name": "S-Invoice đáp ứng đầy đủ tính năng, quản lý linh hoạt",
                  "item": "https://www.sinvoice.vn/p/tinh-nang.php"
                }
              }
            </script>
            <script type="application/ld+json">
              {
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.sinvoice.vn/p/tinh-nang.php"
                },
                "headline": "S-Invoice đáp ứng đầy đủ tính năng, quản lý linh hoạt",
                "description": "Hóa đơn điện tử S-Invoice | Hỗ trợ 100% thủ tục thông báo phát hành hóa đơn | Lưu trữ miễn phí trong 10 năm",
                "image": {
                  "@type": "ImageObject",
                  "url": "https://1.bp.blogspot.com/-1h3iF7jEkKc/X6Phwv8McEI/AAAAAAAAAJg/GMmb0j1n2hokoNAbBkNQlP8buYh1fJFngCLcBGAsYHQ/s16000/sinvoice_tinh_nang_01.png",
                  "width": 720,
                  "height": 480
                },
                "datePublished": "",
            ...
            <div class="row">
              <h1 class="entry-title">
                <strong>S-Invoice đáp ứng đầy đủ tính năng, quản lý linh
                  hoạt</strong>
              </h1>
              <img
                alt="Sinvoice đầy đủ tính năng, quản lý linh hoạt"
                class="img-responsive"
                src="../1.bp.blogspot.com/-1h3iF7jEkKc/X6Phwv8McEI/AAAAAAAAAJg/GMmb0j1n2hokoNAbBkNQlP8buYh1fJFngCLcBGAsYHQ/s16000/sinvoice_tinh_nang_01.png" />
              <h2 class="entry-subtitle">
                <strong>Quản lý mô hình Tổng Công ty &#8211; Chi nhánh thành
                  viên</strong>
              </h2>
              <ul class="ulPostBody">
                <li>
                  Hệ thống đáp ứng mô hình Tổng Công ty quản lý nhiều chi
                  nhánh
                </li>
                <li>
                  Đơn vị quản lý có thể quản lý tâp trung hoạt động động sử
                  dụng hóa đơn của tất cả các chi nhánh
                </li>
              </ul>
              <img
                alt="Quản lý mô hình Tổng Công ty – chi nhánh thành viên"
                class="img-responsive"
                src="../1.bp.blogspot.com/-87K5KUBLyJI/X6PhwQXteUI/AAAAAAAAAJY/j8nkxxe-CFsIej01IrtjMc9Tx8re6UlSQCLcBGAsYHQ/s16000/sinvoice_tinh_nang_02.png" />
              <h2 class="entry-subtitle">
                <strong>Tích hợp sẵn tính năng gửi SMS cho khách hàng của doanh
                  nghiệp</strong>
              </h2>
              <p>
                Ngoài tính năng gửi email cho khách hàng, hệ thống tích hợp
                sẵn module nhắn tin qua hệ thống tin nhắn thương hiệu do
                Viettel cung cấp, Khách hàng chỉ cần đăng ký sử dụng dịch vụ,
                dịch vụ ngay lập tức được khởi tạo
              </p>
              <img
                alt="Tích hợp sẵn tính năng gửi SMS cho khách hàng của doanh nghiệp"
                class="img-responsive"
                src="../1.bp.blogspot.com/-OEcYqTTxQyE/X6PhwVZQ-AI/AAAAAAAAAJc/RLjvAoyNWioivkFivEHcp3cOTa-vJ9EmwCLcBGAsYHQ/s16000/sinvoice_tinh_nang_03.png" />
              <h2 class="entry-subtitle">
                <strong>Đáp ứng số lượng người dùng lớn</strong>
              </h2>
              <ul class="ulPostBody">
                <li>
                  Thiết kế hệ thống với khả năng mở rộng cao, khả năng đáp ứng
                  không giới hạn số lượng doanh nghiệp dùng dịch vụ
                </li>
                <li>
                  Đáp ứng đồng thời số lượng lớn giao dịch lập, phát hành hóa
                  đơn
                </li>
              </ul>
              <h2 class="entry-subtitle">
                <strong>Khả năng tùy chọn mẫu hóa đơn linh hoạt</strong>
              </h2>
              <ul class="ulPostBody">
                <li>
                  Hệ thống có nhiều mẫu hóa đơn để doanh nghiệp lựa chọn, có
                  chức năng thay đổi, quản lý mẫu hóa đơn
                </li>
                <li>
                  Cho khả năng tùy chỉnh mẫu hóa đơn, thay đổi logo, hình nền
                  mẫu hóa đơn theo nhu cầu
                </li>
              </ul>
            </div>
          </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "4268185375395697650",
        pageName: "Tính năng",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/tinh-nang.php",
