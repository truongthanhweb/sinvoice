...
<head>
  ...
  <link href="tra-cuu-hoa-don.php" rel="canonical" />
  <link
    href="tra-cuu-hoa-don40aa.php?m=1"
  ...
  <meta
    content="https://www.sinvoice.vn/p/tra-cuu-hoa-don.php"
    property="og:url" />
  <meta content="Tra cứu hóa đơn" property="og:title" />
  <meta
    content="Hóa đơn điện tử S-Invoice | Hỗ trợ 100% thủ tục thông báo phát hành hóa đơn | Lưu trữ miễn phí trong 10 năm"
...
<body>
  ...
  <div class="header-image section" id="header-image-2">
    <div>
      <img
        ...
        height="302"
        loading="lazy"
        src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1FBspCvTgqT18tJQgZq5AalEc6z9o0Jj0I0byafAXER6PFcfeXj5zWX5FqHLaLbpNVEy71HlV6hF-lxiJjlTLRYpAYI9Sq-sGcWaxqLTSJZzRohramQ-9A9OKy5l1wP0OZiPavhbEOPWF6knLXsQetK69YGD7IJCcVI2Y625YemFcnMzylz8ksljqrQ/s16000/banner-sinvoice-tem-ve-the.webp"
        width="1600" />
    </div>
  </div>
  ...
  <div class="content-register section" id="content-register">
    <div class="container">
      <script type="application/ld+json">
        {
          ...
          "itemListElement": {
            "@type": "ListItem",
            "position": "1",
            "name": "Tra cứu hóa đơn điện tử Viettel",
            "item": "https://www.sinvoice.vn/p/tra-cuu-hoa-don.php"
          }
        }
      </script>
      <script type="application/ld+json">
        {
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://www.sinvoice.vn/p/tra-cuu-hoa-don.php"
          },
          "headline": "Tra cứu hóa đơn điện tử Viettel",
      ...
      <div class="row">
        <div
          class="col-md-12 col-xs-12 content_support"
          style="width: 100%; height: 100%; overflow: hidden">
          <h1 class="entry-title">Tra cứu hóa đơn điện tử Viettel</h1>
          <div class="quotComments">
            <em
              style="
                  ...
                  padding: 0px;
                  vertical-align: baseline;
                ">Hóa đơn điện tử S-Invoice của Viettel đã nâng cấp và hỗ trợ kết
              nối với hầu hết các loại phần mềm máy tính tiền, phần mềm bán
              hàng, máy POS như: Kiot Việt, POS365, POSAPP, SAPO....Hệ thống
          ...
          <div class="noiDungHoTro text-center">
            ...
            <a
              ...
              data-target="#form-order"
              data-toggle="modal"
              href="#">Liên hệ hỗ trợ</a>
          </div>
          <iframe
            class="full-screen-me"
            frameborder="0"
            src="https://vinvoice.viettel.vn/utilities/invoice-search"
            style="overflow: hidden"
            title="Tra cứu hóa đơn điện tử Viettel"
            width="100%"
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "8589991829506763525",
        pageName: "Tra cứu hóa đơn",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/tra-cuu-hoa-don.php",
