...
<head>
  ...
  <link href="tai-ve.php" rel="canonical" />
  <link
    href="tai-ve40aa.php?m=1"
    media="only screen and (max-width: 640px)"
    rel="alternate" />
  <link href="tai-ve40aa.php?m=1" media="handheld" rel="alternate" />
  <title>Tải về</title>
  <meta
    content="Tổng hợp tải về các mẫu hóa đơn chuẩn, hướng dẫn sử dụng và công cụ trên hệ thống hóa đơn điện tử S-Invoice | Mẫu hóa đơn điện tử Viettel đẹp"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta content="https://www.sinvoice.vn/p/tai-ve.php" property="og:url" />
  <meta content="Tải về" property="og:title" />
  <meta
    content="Tổng hợp tải về các mẫu hóa đơn chuẩn, hướng dẫn sử dụng và công cụ trên hệ thống hóa đơn điện tử S-Invoice | Mẫu hóa đơn điện tử Viettel đẹp"
        ...
        <div class="widget Blog" data-version="2" id="Blog1">
          <div class="main_top" style="margin-top: 20px">
            <script type="application/ld+json">
              {
                ...
                "itemListElement": {
                  "@type": "ListItem",
                  "position": "1",
                  "name": "Tải về tool, hướng dẫn, công cụ... trên hệ thống hóa đơn điện tử S-Invoice",
                  "item": "https://www.sinvoice.vn/p/tai-ve.php"
                }
              }
            </script>
            <script type="application/ld+json">
              {
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.sinvoice.vn/p/tai-ve.php"
                },
                "headline": "Tải về tool, hướng dẫn, công cụ... trên hệ thống hóa đơn điện tử S-Invoice",
                "description": "Tổng hợp tải về các mẫu hóa đơn chuẩn, hướng dẫn sử dụng và công cụ trên hệ thống hóa đơn điện tử S-Invoice | Mẫu hóa đơn điện tử Viettel đẹp",
                "image": {
                  "@type": "ImageObject",
                  "url": "https://1.bp.blogspot.com/-0l-K8tEqwBM/X5loAsLysBI/AAAAAAAAAEk/KMvYCmlH-kEvcMzjL4lYdv6z7tfaU0a_wCLcBGAsYHQ/s16000/banner-sinvoice-headerv3.png",
                  "width": 720,
                  "height": 480
                },
                "datePublished": "",
            ...
            <h1 class="entry-title">
              <strong>Tải về tool, hướng dẫn, công cụ... trên hệ thống hóa đơn điện
                tử S-Invoice</strong>
            </h1>
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Mẫu hóa đơn chuẩn</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                    <img
                      alt="ảnh"
                      class="img-responsive"
                      src="../1.bp.blogspot.com/-9GSQYSe6P3s/X6Pve5AeKqI/AAAAAAAAAJ0/-TfFZdwDZ6sBpWwScGvXcnbfxH_Rp5R7QCLcBGAsYHQ/s0/icon_soft.png" />
                  </div>
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1YYAf_3XB42lKXBznUzNQAQ3qEk-uHkA_/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu hóa đơn bán hàng và biên lai</a>
                    </div>
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1-ZAjsGo9nqkbXcxmUtL6XGUZAZGmQBSA/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu hóa đơn giá trị gia tăng điện và nước</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1zVilhPnoTbymCXH0tIGVD-0I5kgIg3V6/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu hóa đơn giá trị gia tăng thuế dòng</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/11OxP80X-uvGEHARrNYQ79q9GHziJoE4S/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu hóa đơn giá trị gia tăng thuế tổng có chiết
                        khấu</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1TrUFwD4UF91Kq26jO0SlPqSmRdmvwelb/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu hóa đơn giá trị gia tăng thuế tổng khác</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/11hHiHrmvJRw43BYIaVLMNGvEzE_wu2mx/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Danh sách mẫu hóa đơn trên hệ thống thật và hệ thống
                        demo</a>
                    </div>
                    <div class="text_bottom">
                      Danh sách mẫu hóa đơn trên hệ thống thật và hệ thống
                      demo
                    </div>
                  </div>
                  <div class="col-md-2 pull-right">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Tài liệu hướng dẫn tích hợp hệ thống Hóa đơn điện
                  tử</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                    <img
                      alt="ảnh"
                      class="img-responsive"
                      src="../1.bp.blogspot.com/-D_7RnnDx50A/X6PvelSZhUI/AAAAAAAAAJw/74JtBkIQQF45HzdyudKz9Mu4KQh5rc_KgCLcBGAsYHQ/s0/icon_doc.png" />
                  </div>
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1r6z7flmHTLcTqkVcFtSGS4MJV796tSZD/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Hướng dẫn cấu hình user WEBSERVICE</a>
                    </div>
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/uc?id=1oWX0IFz-OwR8_nh7JZyrUOsRUI5iQa-3&amp;export=download"
                        rel="nofollow noopener"
                        target="_blank">Tài liệu mô tả Webservice Hóa đơn điện tử v2.35</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/uc?id=1hjtKQtEHD-QETDPyNMMcL6myJzG8GQwx&amp;export=download"
                        rel="nofollow noopener"
                        target="_blank">Danh sách lỗi thường gặp khi tích hợp</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://sinvoice.viettel.vn/download/soft/example_create_invoice.rar"
                        rel="nofollow noopener"
                        target="_blank">Example_API_C#</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://sinvoice.viettel.vn/download/soft/src_java.rar"
                        rel="nofollow noopener"
                        target="_blank">Example_API_JAVA</a>
                    </div>
                    <div class="text_bottom">Source code mẫu Java</div>
                  </div>
                  <div class="col-md-2 pull-right">
                    <div class="button_text">
                      <a
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/uc?id=1XnbwYltMYnI3nv1bJKLfW6Pq2-BI48wi&amp;export=download"
                        rel="nofollow noopener"
                        target="_blank">Tài liệu mô tả Webservice Hóa đơn điện tử Tiếng
                        Anh</a>
                    </div>
                    <div class="text_bottom">
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://sinvoice.viettel.vn/download/soft/signhash.rar"
                        rel="nofollow noopener"
                        target="_blank">Example USB-TOKEN</a>
                    </div>
                    <div class="text_bottom">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Công văn đặc thù</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1fW7iPyi2HXKrI2bRq4GVbLn415TDWTBz/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Công văn đặc thù</a>
                    </div>
                    <div class="text_bottom">Công văn đặc thù</div>
                  </div>
                  <div class="col-md-2 pull-right">
                    <div class="button_text">
                      <a
                ...
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                    <img
                      alt="ảnh"
                      class="img-responsive"
                      src="../1.bp.blogspot.com/-OMrxlDcqwro/X6Pvek3rhMI/AAAAAAAAAJs/P2iJYUEWkj4a23arGchFCEESKVHDVGrywCLcBGAsYHQ/s0/icon_pdf.png" />
                  </div>
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/14tjTTokS1T-qC_09FlrsjnkE0Teu1wW1/view?usp=sharing"
                        rel="nofollow noopener"
                        target="blank">Hướng dẫn cấp CTS server cho KH dùng HDDT</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        ...
                        rel="nofollow noopener"
                        target="blank">Điều khoản sử dụng dịch vụ Hóa đơn điện tử</a>
                    </div>
                    <div class="text_bottom">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Hướng dẫn sử dụng hệ thống quản lý HDDT</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1lcHBLE9woLXSi4vWYf3WxsYR3OTYeltl/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Hướng dẫn sử dụng hóa đơn điện tử</a>
                    </div>
                    <div class="text_bottom">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Mẫu Quyết định và Thông báo phát hành HDDT</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1dE_agO3flzRGecuzyOFATcZgh5WNOM4c/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Mẫu Quyết định và Thông báo phát hành HDDT</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Tool ký số và xem hóa đơn</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/uc?id=1f4RiWfCILojCU5pQEI9_-cw3n4B9QkFj&amp;export=download"
                        rel="nofollow noopener"
                        target="_blank">Tool ký số 32 bit</a>
                    </div>
                    <div class="text_bottom">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        ...
                        rel="nofollow noopener"
                        target="_blank">Tool ký số 64 bit</a>
                    </div>
                    <div class="text_bottom">
                      Lưu ý: Chạy tool ký số trước khi ký
                    </div>
                ...
                <div class="row list_one">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/uc?id=1xHd6TIeVaw6FBJA3f2rJGCT23Gps8Q9x&amp;export=download"
                        rel="nofollow noopener"
                        target="_blank">Tool ký số hóa đơn điện tử (hiệu lực từ
                        26/03/2025)</a>
                    </div>
                    <div class="text_bottom">
                      Lưu ý: Chạy tool ký số trước khi phát hành hóa đơn
                    </div>
                  </div>
                  <div class="col-md-2 pull-right">
                    <div class="button_text">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        ...
                        rel="nofollow noopener"
                        target="blank">Link download Java 8</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Tài liệu hướng dẫn thiết kế mẫu hóa đơn</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/18iNBZWnsotLm4_H-bB6OLHWzhotBFkfM/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Hướng dẫn chi tiết</a>
                    </div>
                    <div class="text_bottom">
            ...
            <div class="list_text">
              <h2 class="entry-subtitle">
                <strong>Tài liệu thông tư 68</strong>
              </h2>
              <div class="list_text_content">
                <div class="row list_one">
                  <div class="col-md-1 col-xs-2">
                  ...
                  <div class="col-md-9 col-xs-10">
                    <div class="text_top">
                      <a
                        class="text_top"
                        href="https://drive.google.com/file/d/1wwChcL2dgt4wMBynDERzuf5GXoOWUU2y/view?usp=sharing"
                        rel="nofollow noopener"
                        target="_blank">Tài liệu thông tư 68T</a>
                    </div>
                    <div class="text_bottom"></div>
                  </div>
                  <div class="col-md-2 pull-right">
                ...
                <ul class="ulPostBody">
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      title="Khuyến mãi: Tặng 20% số lượng khi MUA THÊM hóa đơn điện tử"><strong>Khuyến mãi: Tặng 20% số lượng khi MUA THÊM hóa đơn
                        điện tử</strong></a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      title="Từ ngày 15/6/2024 cửa hàng kinh doanh vàng không có hóa đơn điện tử sẽ rút giấy phép kinh doanh?"><strong>Từ ngày 15/6/2024 cửa hàng kinh doanh vàng không có
                        hóa đơn điện tử sẽ rút giấy phép kinh doanh?</strong></a>
                  </li>
                </ul>
              </em>
            </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "3540711053045617027",
        pageName: "Tải về",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/tai-ve.php",
