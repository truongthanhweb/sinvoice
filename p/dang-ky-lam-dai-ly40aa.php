...
<head>
  ...
  <link href="dang-ky-lam-dai-ly.php" rel="canonical" />
  <link
    href="dang-ky-lam-dai-ly40aa.php?m=1"
  ...
  <meta
    content="https://www.sinvoice.vn/p/dang-ky-lam-dai-ly.php"
    property="og:url" />
  <meta content="Đăng ký làm đại lý" property="og:title" />
  <meta
    content="Hóa đơn điện tử S-Invoice | Hỗ trợ 100% thủ tục thông báo phát hành hóa đơn | Lưu trữ miễn phí trong 10 năm"
  ...
  <div class="header-image section" id="header-image-2">
    <div>
      <img
        ...
        height="302"
        loading="lazy"
        src="https://blogger.googleusercontent.com/img/a/AVvXsEiHiT-Hd9PZeusv9NnNuoSIcWsep-BvnWHhR3Dhed3-6RedHlWlkvhRGQwlUvHoMAbNHtaoEfA0NrnA-RakJWTAeBjKkiQmn-5OwNSq6aVvVgsGHHxK6H0kH2vHdEYsJPobdTAMT_EP_1C1sLOeygqevoOeCezWA9fXxgfR4bLHrlyh8dbiReye14fYBQ=s16000"
        width="1600" />
    </div>
  </div>
          ...
          <div class="main_top" style="margin-top: 20px">
            <div id="content">
              <script type="application/ld+json">
                {
                  ...
                  "description": "Viettel kính gửi đến Quý doanh nghiệp lời mới hợp tác cùng phân phối các dịch vụ hóa đơn điện tử, chữ ký số, phần mềm kế toán,.. với mức chiết khấu cao và cam kết hỗ trợ trọn đời.",
                  "sku": "146036HDDT007",
                  "mpn": "HDDT007",
                  "brand": {
                    "@type": "Brand",
              ...
              <h1 class="entry-title">
                <strong>Tuyển đại lý hợp tác bán hàng dịch vụ
                  <a
                    href="../index.php"
                    target="_blank"
                    title="Hóa đơn điện tử S-Invoice">Hóa đơn điện tử S-Invoice</a></strong>
              </h1>
              <div class="divPostBody">
                <p>
                  ...
                  <strong>Tập đoàn Công nghiệp - Viễn thông Quân đội
                    (VIETTEL)</strong>
                  xin gửi tới Quý khách hàng, Quý đối tác lời chúc sức khỏe và
                  lời chào trân trọng nhất!
                </p>
                <p>
                  Viettel là một trong những đơn vị đi đầu trong lĩnh vực viễn
                  thông và công nghệ thông tin. Viettel cũng là đơn vị chuyên
                  cung cấp các giải pháp số, cùng với các doanh nghiệp, tổ
                  chức, chính phủ thực hiện sứ mệnh xây dựng một xã hội 4.0
                  hiện đại. Với hơn 15 năm kinh nghiệm cung cấp giải pháp công
                  nghệ và hơn 07 năm triển khai hóa đơn hóa đơn điện, chúng
                  tôi đã cung cấp cho hơn 300.000 doanh nghiệp lớn nhỏ trên
                  khắp cả nước. Với mong muốn mở rộng thị trường và nâng cao
                  hiệu quả phân phối các sản phẩm đến các khách hàng, Viettel
                  kính gửi đến Quý doanh nghiệp lời mới hợp tác cùng phân phối
                  dịch vụ hóa đơn điện tử S-Invoice và chữ ký số Viettel-CA
                  với mức chiết khấu cao và cam kết hỗ trợ trọn đời.
                </p>
                <h2 class="entry-subtitle">
                  <strong>1. Đối tượng áp dụng:</strong>
                </h2>
                <p>
                  Tất cả các doanh nghiệp có nhu cầu trở thành đại lý hợp tác
                  cung cấp sản phẩm hóa đơn điện tử, chữ ký số, phần mềm kế
                  toán... với Viettel.
                </p>
                <h2 class="entry-subtitle">
                  <strong>2. Chính sách chiết khấu:</strong>
                </h2>
                <p>
                  Với quan điểm
                  <strong><em>&#8220;Hợp tác lâu dài, tin cậy&#8221;</em></strong>, Viettel cam kết sẽ hợp tác lâu dài, cùng phát triển và hỗ
                  trợ các đối tác với các chính sách ưu đãi dành cho các đại
                  lý như sau:
                </p>
                <ul class="ulPostBody">
                  <li>
                    Hưởng chính sách giá và ưu đãi đặc biệt (>30% doanh thu).
                  </li>
                  <li>Hỗ trợ tư vấn, triển khai phần mềm.</li>
                  <li>
                    Hỗ trợ truyền thông, quảng cáo sản phẩm, thu hút khách
                    hàng.
                  </li>
                </ul>
                <h2 class="entry-subtitle">
                  <strong>3. Nội dung hợp tác:</strong>
                </h2>
                <table
                  border="1"
                  cellpadding="0"
                  ...
                  <thead
                    ...
                    <tr>
                      ...
                      <th
                        ...
                        colspan="2">
                        <strong>Đơn vị thực hiện</strong>
                      </th>
                      <th
                        class="text-center"
                  ...
                  <tbody>
                    <tr
                      ...
                      <td
                        ...
                        Hoạt động xúc tiến Giới thiệu và Bán hàng
                      </td>
                    </tr>
                    <tr>
                      <td class="text-center" style="vertical-align: middle">
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Tìm kiếm khách hàng, tiếp cận tư vấn giới thiệu dịch
                        vụ, giải pháp của S-Invoice.
                      </td>
                      <td
                        class="text-left"
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Giới thiệu, tư vấn triển khai, demo dịch vụ khách hàng
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Khảo sát và xây dựng phương án triển khai sơ bộ; phối
                        hợp với S-Invoice để xây dựng phương án chi tiết
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Hoàn thiện đầy đủ hợp đồng, các giấy tờ liên quan đến
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Hướng dẫn khách hàng đăng ký thủ tục với Cơ quan Thuế
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                      </td>
                    ...
                    <tr
                      ...
                      <td
                        ...
                        colspan="4"
                        style="vertical-align: middle">
                        Hoạt động triển khai và Cài đặt hệ thống
                      </td>
                    </tr>
                    <tr>
                      <td class="text-center" style="vertical-align: middle">
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Cài đặt các công cụ để sử dụng Hóa đơn điện tử
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Khởi tạo tài khoản, cài đặt và thiết kế mẫu hóa đơn
                        cho khách hàng
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Tích hợp phần mềm bán hàng, kế toán vào hệ thống hóa
                        đơn điện tử Viettel
                      </td>
                      <td class="text-center" style="vertical-align: middle">
                        X
                    ...
                    <tr
                      ...
                      <td
                        ...
                        colspan="4"
                        style="vertical-align: middle">
                        Hoạt động Chăm sóc và Duy trì khách hàng
                      </td>
                    </tr>
                    <tr>
                      <td class="text-center" style="vertical-align: middle">
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Thực hiện các hoạt động CSKH vào các dịp Lễ tết
                      </td>
                      <td
                        class="text-center"
                        style="vertical-align: middle"></td>
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Làm thủ tục thu cước khách hàng định kỳ hoặc theo gói
                        cước sử dụng
                      </td>
                      <td
                        class="text-center"
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Giải quyết các khiếu nại và các công việc liên quan
                    ...
                    <tr>
                      ...
                      <td class="text-left" style="vertical-align: middle">
                        Hoàn thiện các thủ tục phát sinh trong quá trình khách
                ...
                <p>
                  <strong>Ghi chú: </strong>Chính sách và công việc của đại lý
                  được áp dụng từ 01/01/2023 cho đến khi có thông báo mới.
                </p>
                <h2 class="entry-subtitle">
                  <strong>4. Thông tin liên hệ</strong>
                </h2>
                <ul class="ulPostBody">
                  <li>
                ...
                <p>
                  <strong>RẤT MONG NHẬN ĐƯỢC SỰ HỢP TÁC TỪ QUÝ ĐẠI LÝ. TRÂN
                    TRỌNG!</strong>
                </p>
              </div>
            </div>
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "",
        pageId: "2239806871315314942",
        pageName: "Đăng ký làm đại lý",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/p/dang-ky-lam-dai-ly.php",
