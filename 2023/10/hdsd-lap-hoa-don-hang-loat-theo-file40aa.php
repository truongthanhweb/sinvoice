...
<head>
  ...
  <link href="hdsd-lap-hoa-don-hang-loat-theo-file.php" rel="canonical" />
  <link
    href="hdsd-lap-hoa-don-hang-loat-theo-file40aa.php?m=1"
  ...
  <meta
    content="Hướng dẫn người dùng lập hóa đơn hàng loạt theo file import hóa đơn trên hệ thống HDDT v2.0 của Viettel; Dịch vụ hóa đơn điện tử S-Invoice của Viettel"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2023/10/hdsd-lap-hoa-don-hang-loat-theo-file.php"
    property="og:url" />
  <meta
    content="Hướng dẫn lập hóa đơn chưa phát hành theo file (Import hóa đơn)"
    property="og:title" />
  <meta
    content="Hướng dẫn người dùng lập hóa đơn hàng loạt theo file import hóa đơn trên hệ thống HDDT v2.0 của Viettel; Dịch vụ hóa đơn điện tử S-Invoice của Viettel"
      ...
      <div class="sidebar col-md-3 col-xs-12 section" id="sidebar-2">
        ...
        <div class="list-group widget" id="list-group">
          <ul id="myUL" type="none">
            ...
            <li class="active">
              <a
                href="hdsd-lap-hoa-don-hang-loat-theo-file.php"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="1858911621247619860">
                ...
                <div class="entry-body">
                  <script type="application/ld+json">
                    {
                      ...
                      "image": [
                        "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgnfXxohujHFQO1lUTzFBZHzvaQCqDYDlYKoUgjvqI-CJNQ0YKKNbYf8015T_TRdLgLFiIAaaiHaKkCXpbOv-6MMVCqw_IW6vf-HpSjpNVZrPAxdZaz3r7rLZdqxJgGLk8bLEvqQYRaaLYKp4Yfy6vzKHmEnaE2jxeQQ_GeKAqzQH50oTakRPnmMK9sbZiq/s16000/logo_500_300.webp",
                        "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgcADG46N9YGeUf57QLizbSALZMKMzkzC1IoblFc-6BaqYTftOEgwRl_1S9vXXDgYcPJ3fxiPtx93_W-nfvckWTO6L2WFxImPy1n69kC7PRXhKRUKDP6gCqP1WP459Srr3oSIXlQzVPNU7yKcxlBZTutAtTApiy1aM0y-0QVz5ss0c4SiNIzQCFPZT6yf7O/s16000/banner_sinvoice_new_khuyen_mai_20.webp"
                      ],
                      "description": "Hướng dẫn người dùng lập hóa đơn hàng loạt theo file import hóa đơn trên hệ thống HDDT v2.0 của Viettel; Dịch vụ hóa đơn điện tử S-Invoice của Viettel cung cấp giải pháp quản lý hóa đơn trên nền điện tử cho doanh nghiệp. ",
                      "sku": "146036HDDT005",
                      "mpn": "HDDT005",
                      "brand": {
                        "@type": "Brand",
                  ...
                  <div class="divPostBody">
                    <p>
                      ...
                      <strong>Trong bài viết này
                        <a
                          href="../index.php"
                          target="_blank"
                          title="Hóa đơn điện tử S-Invoice">S-invoice</a>
                        sẽ hướng dẫn người dùng cách lập hóa đơn hàng loạt
                        theo file mẫu excel có sẵn.</strong>
                    </p>
                    <h2 class="entry-subtitle">
                      <strong>1. Tải về file template mẫu</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Tại trang chủ sinvoice.vn, người dùng nhấn đăng nhập
                        và nhập thông tin đăng nhập của doanh nghiệp/tổ chức.
                      </li>
                      <li>
                        Trên thanh menu bên trái, người dùng chọn "Quản lý hóa
                        đơn" => "Hóa đơn chưa phát hành" và nhấn vào nút
                        "Import hóa đơn"
                      </li>
                      <li>
                        Tại của sổ "Lập hóa đơn chưa phát hành theo file",
                        người dụng chọn Mẫu hóa đơn và Ký hiệu hóa đơn, sau đó
                        nhấp vào link "Tải file mẫu" để tải về file template.
                      </li>
                    </ul>
                    <h2 class="entry-subtitle">
                      <strong>2. Nhập thông tin hóa đơn vào template mẫu</strong>
                    </h2>
                    <p>
                      Người dùng thực hiện điền thông tin hóa đơn vào file
                      template, cụ thể như sau:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        <strong><em>STT;</em></strong>
                      </li>
                      <li>
                        <strong><em>Nhóm hóa đơn</em></strong><span class="color-warning">(*)</span>: Các mặt hàng
                        trên cùng 1 hóa đơn phải có nhóm hóa đơn giống nhau;
                      </li>
                      <li>
                        <strong><em>Thông tin người mua</em></strong>
                        <ol>
                          <li>
                            <strong><em>Người mua không lấy hóa đơn</em></strong>: Chỉ nhận giá trị 1 và 2 hoặc để trống. Nếu giá
                            trị 1 nghĩa là người mua không lấy hóa đơn; Nếu
                            giá trị 2 hoặc để trống nghĩa là người mua lấy hóa
                            đơn, khi đó các thông tin bắt buộc nhập gồm: Họ
                            tên hoặc tên đơn vị, Địa chỉ, MST;
                          </li>
                          <li>
                            <strong><em>Mã KH</em></strong>: Nhập tối đa 400 ký tự;
                          </li>
                          <li>
                            <strong><em>Họ tên</em></strong>: Nhập tối đa 800 ký tự, bắt buộc nhập nếu ô
                            Người mua không lấy hóa đơn là 2 hoặc để trống;
                          </li>
                          <li>
                            <strong><em>Địa chỉ</em></strong>: Nhập tối đa 1200 ký tự, bắt buộc nhập nếu ô
                            Người mua không lấy hóa đơn là 2 hoặc để trống;
                          </li>
                          <li>
                            <strong><em>Điện thoại</em></strong>: Tối đa 15 ký tự;
                          </li>
                          <li>
                            <strong><em>Email</em></strong>: Tối đa 2000 ký tự, các email phân cách bằng dấu
                            phẩy (,);
                          </li>
                          <li>
                            <strong><em>Mã số thuế</em></strong>
                          </li>
                          <li>
                            <strong><em>Loại giấy tờ</em></strong>: Chỉ cần nhập dòng đầu tiên cho mỗi hóa đơn. Nếu
                            loại giấy tờ là Chứng minh thư thì nhập 1; Hộ
                            chiếu thì nhập 2; Giấy phép kinh doanh thì nhập 3;
                          </li>
                          <li>
                            <strong><em>Số giấy tờ</em></strong>: Nhập số giấy tờ tương ứng với loại giấy tờ đã
                            chọn trước đó;
                          </li>
                          <li>
                            <strong><em>Tên đơn vị</em></strong>: Nhập tối đa 1200 ký tự, bắt buộc nhập nếu ô
                            Người mua không lấy hóa đơn là 2 hoặc để trống;
                          </li>
                          <li>
                            <strong><em>Tên ngân hàng</em></strong>;
                          </li>
                          <li>
                            <strong><em>Tài khoản ngân hàng</em></strong>;
                          </li>
                          <li>
                            <strong><em>Hợp đồng số</em></strong>;
                          </li>
                        </ol>
                      </li>
                      <li>
                        <strong><em>Nhóm Thông tin giao dịch</em></strong>
                        <ol>
                          <li>
                            <strong><em>Hình thức thanh toán</em></strong><span class="color-warning">(*)</span>: Nhập đúng
                            các thông tin hình thức thanh toán tương ứng như
                            sau: TM (Tiền mặt); CK (Chuyển khoản); TM/CK (Tiền
                            mặt/Chuyển khoản); DTCN (Đổi trừ công nợ);
                          </li>
                          <li>
                            <strong><em>Thanh toán</em></strong><span class="color-warning">(*)</span>: Nếu đã
                            thanh toán, nhập 1, nếu chưa thanh toán, nhập 2;
                          </li>
                          <li>
                            <strong><em>Loại tiền</em></strong><span class="color-warning">(*)</span>: Nếu để
                            trống mặc định là VND, có thể nhập VND hoặc USD;
                          </li>
                          <li>
                            <strong><em>Tỷ giá</em></strong>: Nhập tỷ giá VND-USD
                          </li>
                        </ol>
                      </li>
                      <li>
                        <strong><em>Nhóm Thông tin hàng hóa</em></strong>
                        <ol>
                          <li>
                            <strong><em>Loại hàng hóa</em></strong>: nhập một trong các giá trị tương ứng sau cho
                            từng dòng hàng hóa:
                            <ul class="ulPostBody">
                              <li>1 hoặc để trống: Hàng hóa</li>
                              <li>2: Ghi chú</li>
                              <li>3: Chiết khấu</li>
                              <li>4: Bảng kê</li>
                              <li>5: Phí khác</li>
                          ...
                          <li>
                            <strong><em>Mã hàng hóa/dịch vụ</em></strong>;
                          </li>
                          <li>
                            <strong><em>Tên hàng hóa/dịch vụ </em></strong><span class="color-warning">(*)</span>: Nhập tối
                            đa 500 ký tự;
                          </li>
                          <li>
                            <strong><em>Ghi chú</em></strong>: Nhập tối đa 500 ký tự;
                          </li>
                          <li>
                            <strong><em>Số lô</em></strong>;
                          </li>
                          <li>
                            <strong><em>Hạn dùng</em></strong>;
                          </li>
                          <li>
                            <strong><em>Đơn vị tính</em></strong>;
                          </li>
                          <li>
                            <strong><em>Số lượng</em></strong><span class="color-warning">(*)</span>;
                          </li>
                          <li>
                            <strong><em>Đơn giá</em></strong><span class="color-warning">(*)</span>;
                          </li>
                          <li>
                            <strong><em>Thành tiền</em></strong><span class="color-warning">(*)</span>;
                          </li>
                          <li>
                            <strong><em>Thuế GTGT(%)</em></strong><span class="color-warning">(*)</span>;
                          </li>
                          <li>
                            <strong><em>Tiền thuế</em></strong>;
                          </li>
                          <li>
                            <strong><em>% Chiết khấu</em></strong>;
                          </li>
                        </ol>
                      </li>
                    </ul>
                    <h2 class="entry-subtitle">
                      <strong>3. Tải lên (import) hóa đơn lên hệ thống</strong>
                    </h2>
                    <p>
                      Sau khi nhập đúng và đủ các thông tin vào file mẫu,
                      người dùng tiến hành import file lên hệ thống:
                    </p>
                    <ul class="ulPostBody">
                      <li>
                        Tại trang chủ
                        <a
                          href="../index.php"
                          target="_blank"
                          title="Hóa đơn điện tử S-Invocie"><strong><em>sinvoice.vn</em></strong></a>, người dùng nhấn đăng nhập và nhập thông tin đăng
                        nhập của doanh nghiệp/tổ chức.
                      </li>
                      <li>
                        Trên thanh menu bên trái, người dùng chọn
                        <strong><em>"Quản lý hóa đơn"</em></strong> =>
                        <strong><em>"Hóa đơn chưa phát hành"</em></strong> và
                        nhấn vào nút
                        <strong><em>"Import hóa đơn"</em></strong>
                      </li>
                      <li>
                        Tại của sổ
                        <strong><em>"Lập hóa đơn chưa phát hành theo file"</em></strong>, người dụng chọn
                        <strong><em>Mẫu hóa đơn</em></strong> và
                        <strong><em>Ký hiệu hóa đơn</em></strong>
                      </li>
                      <li>
                      ...
                      <li>
                        Tại bảng
                        <strong><em>"Lịch sử import dữ liệu"</em></strong>, người dùng có thể tải về file kết quả sau khi hệ
                        thống hoàn thành import hóa đơn.
                      </li>
                    </ul>
                    <h2 class="entry-subtitle">
                      <strong>4. Một số lưu ý khi nhập và import hóa đơn</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Hóa đơn có trường động sẽ phụ thuộc vào Loại hóa đơn:
                        nếu Loại hóa đơn khi chọn có khai báo trường động thì
                        khi tải file import mẫu sẽ lấy đúng thông tin các
                        trường động của Loại hóa đơn đó.
                      </li>
                      <li>
                        Sau khi import dữ liệu thành công, trong màn hình Quản
                        lý đơn chưa phát hành các hóa đơn đã được sắp xếp đúng
                        theo thứ tự thời gian.
                      </li>
                      <li>
                        Đối với mẫu thuế tổng, khi thực hiện import 1 hóa đơn
                        có nhiều dòng hàng hóa, mỗi dòng là 1 thuế suất khác
                        nhau, hệ thống sẽ lấy thuế suất của dòng đầu tiên để
                        tính toán cho cả hóa đơn.
                      </li>
                      <li>
                        Đối với mẫu thuế tổng điện nước và mẫu thuế tổng nói
                        chung, khi nhập thuế suất với định dạng 5; 10, hệ
                        thống sẽ lưu vào cơ sở dữ liệu có 2 loại thuế suất:
                        thuế 1: 5% và thuế 2: 10%
                      </li>
                      <li>
                        Hệ thống chưa hỗ trợ import với mẫu hóa đơn thuế tổng
                        có chiết khấu trước thuế và mẫu hóa đơn thuế tổng có
                        chiết khấu sau thuế (nếu dữ liệu import có nhập chiết
                        khấu với 2 mẫu này, hệ thống không đảm bảo tiền hàng
                        tính đúng).
                      </li>
                      <li>
                        Hệ thống đã hỗ trợ import lập hóa đơn với mẫu chiết
                        khấu dòng DCL, từng dòng đều có thuế suất và nhập
                        chiết khấu % tương ứng, đảm bảo tính đúng tiền hàng
                      </li>
                      <li>
                        Hiện tại khi thực hiện import, lập hóa đơn theo file,
                        hệ thống:
                        <ul class="ulPostBody">
                          <li>
                            Cho phép import hóa đơn trường hợp có
                            <strong><em>Tên người mua</em></strong> mà không
                            bắt buộc có <strong><em>Tên đơn vị</em></strong>
                          </li>
                          <li>
                            Khi nhập <strong><em>Tên đơn vị</em></strong> thì
                            bắt buộc phải nhập
                            <strong><em>Mã số thuế</em></strong>
                          </li>
                          <li>
                            Cho phép import hóa đơn trường hợp không có mã
                            hàng hóa
                          </li>
                          <li>
                            Cho phép import hóa đơn trường hợp email có 2000
                            ký tự, cách nhau bởi dấu
                            <strong><em>;</em></strong>
                          </li>
                          <li>
                            Hệ thống chỉ hỗ trợ cho phép tăng/giảm tổng tiền
                            thuế của toàn hóa đơn trong khoảng cho phép theo
                            cấu hình, trường hợp chênh lệch tiền hàng của toàn
                            bộ hóa đơn lớn hơn cấu hình cho phép, hệ thống sẽ
                            báo lỗi.
                          </li>
                          <li>
                            Khi cả nhóm hóa đơn có 1 dòng lỗi thì nhóm hóa đơn
                            đó sẽ không import được vào hệ thống, nhóm hóa đơn
                            không lỗi vẫn import thành công.
                          </li>
                        </ul>
                      </li>
                      <li>
                        Trường hợp người dùng nhập chiết khấu tách riêng 1
                        dòng trong hóa đơn, thì có thể nhập loại hàng hóa là
                        3, nhập tiền chiết khấu vào mục
                        <strong><em>Thành tiền</em></strong> theo hướng dẫn
                        trên.
                      </li>
                      <li>
                        Hiện tại hệ thống đang hỗ trợ cấu hình lập hóa đơn
                        theo file với mỗi lần import là 6000 hóa đơn, hoặc
                        file tối đa 5MB .
                      </li>
                    </ul>
                    <h2 class="entry-subtitle">
                      <strong>5. Hỗ trợ sau bán</strong>
                    </h2>
                    <p>
                      Nếu cần hỗ trợ sau bán, Quý khách hàng vui lòng liên hệ
                      tổng đài <strong>18008000</strong> nhánh 1 (miễn phí)
                    </p>
                    <p>
                    ...
                    <p style="text-align: right">
                      <strong>Nguồn tham khảo:
                        <a href="../index.php" target="_blank">Sinvocie</a></strong>
                    </p>
                  </div>
                </div>
              </main>
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2023/10/hdsd-lap-hoa-don-hang-loat-theo-file.php"
                  },
                  "headline": "Hướng dẫn lập hóa đơn chưa phát hành theo file (Import hóa đơn)",
                  "description": "Hướng dẫn người dùng lập hóa đơn hàng loạt theo file import hóa đơn trên hệ thống HDDT v2.0 của Viettel; Dịch vụ hóa đơn điện tử S-Invoice của Viettel",
                  "image": {
                    "@type": "ImageObject",
                    "url": "",
                    "width": 720,
                  ...
                  "datePublished": "2023-10-18T22:18:00+07:00",
                  "dateModified": "2023-10-19T21:18:18+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "1858911621247619860",
        pageId: "",
        pageName: "Hướng dẫn lập hóa đơn chưa phát hành theo file (Import hóa đơn)",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2023/10/hdsd-lap-hoa-don-hang-loat-theo-file.php",
