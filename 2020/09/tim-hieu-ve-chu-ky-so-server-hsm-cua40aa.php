...
<head>
  ...
  <link href="tim-hieu-ve-chu-ky-so-server-hsm-cua.php" rel="canonical" />
  <link
    href="tim-hieu-ve-chu-ky-so-server-hsm-cua40aa.php?m=1"
  ...
  <link
    ...
    media="handheld"
    rel="alternate" />
  <title>Tìm hiểu về chữ ký số server HSM của Viettel</title>
  <meta
    content="Mua hóa đơn điện tử S-Invoice miễn phí 6 tháng sử dụng chữ ký số Server HSM | Mua combo chữ ký số và hóa đơn đưọc tặng thêm 12 tháng HSM | sinvoice.vn"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2020/09/tim-hieu-ve-chu-ky-so-server-hsm-cua.php"
    property="og:url" />
  <meta
    content="Tìm hiểu về chữ ký số server HSM của Viettel"
    property="og:title" />
  <meta
    content="Mua hóa đơn điện tử S-Invoice miễn phí 6 tháng sử dụng chữ ký số Server HSM | Mua combo chữ ký số và hóa đơn đưọc tặng thêm 12 tháng HSM | sinvoice.vn"
      ...
      <div class="col-md-8 section" id="main-1">
        <div class="widget Blog" data-version="2" id="Blog1">
          <div class="main_top" style="margin-top: 20px">
            <article class="post" data-article-id="2371530100648964646">
              ...
              <main class="article-body">
                <div class="entry-body">
                  <div class="divPostBody">
                    <p>
                      <strong><em>[Chữ ký số Viettel-CA]</em></strong> - HSM
                      (Hardware Security Module) là thiết bị phần cứng dùng để
                      bảo vệ và quản lý các cặp khóa đồng thời tăng tốc độ xác
                      thực và mã hóa. So với USB token hay smartcard thì HSM
                      có nhiều tính năng cao cấp hơn nhằm phục vụ hoạt động
                      cho các hệ thống, ứng dụng có yêu cầu cao về bảo mật và
                      hiệu năng.
                    </p>
                    <table
                      align="center"
                      ...
                      <tbody>
                        <tr>
                          <td style="text-align: center">
                            <a
                              href="../../blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1L9oQSzrVdJ571j19ZPQF2BB0A5o87QtVqE0PoXe/s900/chu-ky-so-server-hsm-viettel.jpg"
                              imageanchor="1"
                              style="margin-left: auto; margin-right: auto"><img
                                alt="Ảnh minh họa: Chữ ký số server HSM của Viettel"
                                border="0"
                                data-original-height="734"
                                data-original-width="900"
                                src="../../blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1L9oQSzrVdJ571j19ZPQF2BB0A5o87QtVqE0PoXe/s16000/chu-ky-so-server-hsm-viettel.jpg"
                                title="Ảnh minh họa: Chữ ký số server HSM của Viettel" /></a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tr-caption" style="text-align: center">
                            Ảnh minh họa: Chữ ký số server HSM của Viettel
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <h2 style="font-size: 1.3em">
                      <strong>Chữ ký số server cho thiết bị HSM là gì?</strong>
                    </h2>
                    <p>
                      Đây là loại chữ ký số có cặp khóa và chứng thư số được
                      lưu trong thiết bị HSM, nhằm phục vụ cho các ứng dụng
                      chữ ký số có yêu cầu tốc độ cao (từ 10-10.000 tps chữ ký
                      số trên giây) điều mà thiết bị token/smartcard thông
                      thường không thể đáp ứng được. Thiết bị HSM này được gọi
                      sử dụng cho các chức năng ký số, mã hóa, giải mã,
                      &#8230; bởi các Server ứng dụng của tổ chức/doanh
                      nghiệp.
                    </p>
                    <h2 style="font-size: 1.3em">
                      <strong>Chức năng chữ ký số server là gì?</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Phù hợp với các tổ chức/doanh nghiệp có nhu cầu ký
                        điện tử nhiều và nhanh;
                      </li>
                      <li>
                        Có thể sử dụng như một Chữ ký số Doanh nghiệp (sử dụng
                        giao dịch điện tử);
                      </li>
                      <li>
                        Cài đặt trực tiếp vào máy chủ của Doanh nghiệp, thực
                        hiện lệnh ký tự động;
                      </li>
                      <li>
                        Ký số một cách linh động và có phân quyền cho cá nhân.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>Ứng dụng của chữ ký số server?</strong>
                    </h2>
                    <p>
                      Như đã được đề cập ở trên, chữ ký số server HSM sử dụng
                      cho các ứng dụng yêu cầu cao về bảo mật và hiệu năng
                      như:
                    </p>
                    <ul class="ulPostBody">
                      <li>Hóa đơn điện tử, chứng từ điện tử;</li>
                      <li>Sử dụng trong xác thực SSL, VPN, DNSSEC...;</li>
                      <li>Internet Banking;</li>
                      <li>Thanh toán trực tuyến, thương mại điện tử;</li>
                      <li>
                        Sử dụng trong các ứng dụng VAN như: T-VAN, I-VAN, Hải
                        quan...;
                      </li>
                      <li>Ký điện tử trên email, ký số trả lời tự động.</li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>Bảng giá chữ ký số server Viettel-CA:</strong>
                    </h2>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              <strong>Đăng ký mới hoặc gia hạn</strong>
                            </td>
                          ...
                          <tr>
                            ...
                            <td><strong>9,250,000</strong></td>
                            <td><strong>13,200,000</strong></td>
                          </tr>
                          <tr>
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>
                        <em>Viettel sẽ không tham gia vào quá trình cài đặt
                          chứng thư số tại server của Khách hàng.</em>
                      </li>
                      <li>
                        <em>Viettel sẽ cung cấp file *.cert, *.p12 và file
                          keys, Khách hàng chủ động install chứng thư vào
                          thiết bị.</em>
                      </li>
                    </ul>
                  </div>
              ...
              <div
                ...
                <div class="comment-form">
                  <a
                    href="https://www.blogger.com/comment/frame/8243747611808165490?po=2371530100648964646&amp;hl=vi&amp;saa=85391&amp;origin=https://www.sinvoice.vn&amp;m=1&amp;skin=emporio"
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2020/09/tim-hieu-ve-chu-ky-so-server-hsm-cua.php"
                  },
                  "headline": "Tìm hiểu về chữ ký số server HSM của Viettel",
                  "description": "Mua hóa đơn điện tử S-Invoice miễn phí 6 tháng sử dụng chữ ký số Server HSM | Mua combo chữ ký số và hóa đơn đưọc tặng thêm 12 tháng HSM | sinvoice.vn",
                  "image": {
                    "@type": "ImageObject",
                    "url": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi1L9oQSzrVdJ571j19ZPQF2BB0A5o87QtVqE0PoXeKuFKYCfxDkoKRoE8cs60wbXc9Q0agxIryrEKKWN3rp6iS0S0ngoCxB5voOf7CtR6g7Fms4Y9n7j1RkQL4b6IsUixy2WcV3PVVA0yq/w720-h480-p-k-no-nu/chu-ky-so-server-hsm-viettel.jpg",
                    "width": 720,
                    "height": 480
                  },
                  "datePublished": "2020-11-08T18:11:00+07:00",
                  "dateModified": "2020-12-03T11:14:24+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "2371530100648964646",
        pageId: "",
        pageName: "Tìm hiểu về chữ ký số server HSM của Viettel",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2020/09/tim-hieu-ve-chu-ky-so-server-hsm-cua.php",
