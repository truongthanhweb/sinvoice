<!DOCTYPE html>
<html data-page-type='404' dir='ltr' lang='vi'>
...
<head>
    ...
    <link href='https://www.sinvoice.vn//2020/09/viettel-dat-hai-chung-chi-uy-tin-the-gioi-ve-trung-tam-du-lieu.php' rel='canonical' />
    <link href='https://www.sinvoice.vn//2020/09/viettel-dat-hai-chung-chi-uy-tin-the-gioi-ve-trung-tam-du-lieu.php?m=1' media='only screen and (max-width: 640px)' rel='alternate' />
    <link href='https://www.sinvoice.vn//2020/09/viettel-dat-hai-chung-chi-uy-tin-the-gioi-ve-trung-tam-du-lieu.php?m=1' media='handheld' rel='alternate' />
    <title>Rất tiếc, không tìm được trang này.</title>
    <meta content='Không có trang này trênHóa đơn điện tử S-Invoice. Rất có thể trang đã bị xóa do tính năng không còn hoặc do đường dẫn URL bị sai.' name='description' />
    ...
    <style>
        ...
        * {
        ...
        #preloader {
            ...
            height: 100%;
            overflow: visible;
            background-image: url(https://cdn.jsdelivr.net/gh/thietkeblogspot/images/preloader.gif);
        ...
        .avatar-image-container img {
            background: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEifmQfLokTY-KuNcqzpVjGpLkOmKPOkNdYBnRKugws6WwOxVGarhCOnLO4bPpuVRKqgc4BqWfwJD9ro1bGkMwxzfoFmqTwf_i2gqtPbr2ROs1NRX_9uB922b86c3Fx_crhELmmSrsf52TQ/s1600/no-image.png) no-repeat center
        }
...
<body>
    <section class='error_page'>
        <article class='message'>
            <h1>Rất tiếc, không tìm được trang này.</h1>
            <p>Không có trang này trên Hóa đơn điện tử S-Invoice. Rất có thể trang đã bị xóa do tính năng không còn hoặc do đường dẫn URL bị sai.</p>
            <span>
                <a href='https://www.sinvoice.vn/' title='Trang chủ'>
                    Trang chủ
                </a>
            </span>
        </article>
...
_WidgetManager._RegisterWidget('_BlogView', new _WidgetInfo('Blog1', 'main-1', document.getElementById('Blog1'), {'cmtInteractionsEnabled': false, 'navMessage': 'R\u1ea5t ti\u1ebfc, trang b\u1ea1n \u0111ang t\xecm trong blog n\xe0y kh\xf4ng t\u1ed3n t\u1ea1i.', 'lightboxEnabled': true, 'lightboxModuleUrl': 'https://www.blogger.com/static/v1/jsbin/3789099744-lbx__vi.js', 'lightboxCssUrl': 'https://www.blogger.com/static/v1/v-css/123180807-lightbox_bundle.css'}, 'displayModeFull'));
...
_WidgetManager._RegisterWidget('_BlogView', new _WidgetInfo('Blog2', 'main-2', document.getElementById('Blog2'), {'cmtInteractionsEnabled': false, 'navMessage': 'R\u1ea5t ti\u1ebfc, trang b\u1ea1n \u0111ang t\xecm trong blog n\xe0y kh\xf4ng t\u1ed3n t\u1ea1i.', 'lightboxEnabled': true, 'lightboxModuleUrl': 'https://www.blogger.com/static/v1/jsbin/3789099744-lbx__vi.js', 'lightboxCssUrl': 'https://www.blogger.com/static/v1/v-css/123180807-lightbox_bundle.css'}, 'displayModeFull'));
