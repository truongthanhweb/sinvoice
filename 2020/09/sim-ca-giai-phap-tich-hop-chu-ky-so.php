...
<head>
  ...
  <link href="sim-ca-giai-phap-tich-hop-chu-ky-so.php" rel="canonical" />
  <link
    href="sim-ca-giai-phap-tich-hop-chu-ky-so40aa.php?m=1"
  ...
  <meta
    content="SIM CA hay còn gọi là Mobile CA, là dịch vụ chứng thực chữ ký số mà khóa riêng và khóa công khai được lưu trữ trên SIM Viettel"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2020/09/sim-ca-giai-phap-tich-hop-chu-ky-so.php"
    property="og:url" />
  <meta
    content="SIM CA: giải pháp tích hợp Chữ ký số Viettel-CA trên SIM di động"
    property="og:title" />
  <meta
    content="SIM CA hay còn gọi là Mobile CA, là dịch vụ chứng thực chữ ký số mà khóa riêng và khóa công khai được lưu trữ trên SIM Viettel"
      ...
      <div class="col-md-8 section" id="main-1">
        <div class="widget Blog" data-version="2" id="Blog1">
          <div class="main_top" style="margin-top: 20px">
            <article class="post" data-article-id="7723005880426031019">
              <header class="article-header">
                <h1 class="entry-title">
                  SIM CA: giải pháp tích hợp Chữ ký số Viettel-CA trên SIM di
                  động
                </h1>
              </header>
              <main class="article-body">
                <div class="entry-body">
                  <div class="divPostBody">
                    <p>
                      <strong> <em>[Chữ ký số Viettel-CA]</em></strong> - SIM
                      CA hay còn gọi là Mobile CA, là dịch vụ chứng thực chữ
                      ký số mà khóa riêng và khóa công khai được lưu trữ trên
                      SIM Viettel. Với SIM CA, người dùng có thể thực hiện ký
                      điển tử ngay trên chiếc điện thoại di động của mình ở
                      bất cứ nơi nào có sóng Viettel.
                    </p>
                    <table
                      align="center"
                      cellpadding="0"
                      ...
                      <tbody>
                        <tr>
                          <td style="text-align: center">
                            <a
                              href="../../blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhFg0QKzmTJU7HyAW7EbsRTJHw4k6MR3LjTqFSiWsE/s900/Giai-phap-chu-ky-so-tren-sim-ca.jpg"
                              imageanchor="1"
                              style="margin-left: auto; margin-right: auto"><img
                                alt="Ảnh minh họa: Tích hợp chữ ký số Viettel-CA vào SIM di động Viettel"
                                border="0"
                                data-original-height="514"
                                data-original-width="900"
                                src="../../blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhFg0QKzmTJU7HyAW7EbsRTJHw4k6MR3LjTqFSiWsE/s16000/Giai-phap-chu-ky-so-tren-sim-ca.jpg"
                                title="Ảnh minh họa: Tích hợp chữ ký số Viettel-CA vào SIM di động Viettel" /></a>
                          </td>
                        </tr>
                        <tr>
                          <td class="tr-caption" style="text-align: center">
                            Ảnh minh họa: Tích hợp chữ ký số Viettel-CA vào
                            SIM di động Viettel
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <h2 style="font-size: 1.3em">
                      <strong>Viettel là nhà cung cấp đầu tiên tại Việt Nam triển
                        khai giải pháp chữ ký số SIM CA</strong>
                    </h2>
                    <p>
                      <strong>Chữ ký số SIM CA</strong> thực hiện việc chứng
                      thực ký số dựa trên hạ tầng mạng viễn thông của
                      <strong>Viettel</strong>. Tức người dùng chỉ cần có SIM
                      CA là có thể xác thực chữ ký số (ký số).
                    </p>
                    <p>
                      Giải pháp SIM CA phát triển dựa trên các tiêu chuẩn quốc
                      tế, đáp ứng và đảm bảo mọi yêu cầu của một nhà cung cấp
                      dịch vụ chứng thực chữ ký số.
                    </p>
                    <p>
                      Phân phối khóa và lưu trữ an toàn trên chip bảo mật
                      chuyên dụng được tích hợp vào SIM di động của
                      <strong>Viettel</strong>, chuẩn chữ ký số PKCS#1,
                      PKCS#7; đảm bảo tính an toàn dữ liệu, tính xác thực
                      nguồn gốc, tính chống chối bỏ.
                    </p>
                    <h2 style="font-size: 1.3em">
                      <strong>Lợi ích khi sử dụng chữ ký số trên SIM CA của
                        Viettel</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Ký điện tử trên mọi thiết bị di động: chỉ cần có sóng
                        <strong>Viettel</strong> khách hàng có thể ký điện tử
                        trên các ứng dụng hỗ trợ SIM CA;
                      </li>
                      <li>
                        Không cần môi trường máy tính có cổng USB và kết nối
                        Internet;
                      </li>
                      <li>
                        Tương thích với tất cả các dòng điện thoại di động,
                        máy tính bảng;
                      </li>
                      <li>
                        Chi phí đầu tư thấp: giá chữ ký số SIM CA của
                        <strong>Viettel</strong> chỉ khoảng
                        <strong><span class="color-warning">400,000đ/năm</span></strong>.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>Ứng dụng chữ ký số SIM CA của Viettel</strong>
                    </h2>
                    <ol type="1">
                      <li>
                        <p>
                          Ứng dụng trong các tổ chức
                          <strong>Ngân hàng - Tài chính - Chứng khoán - Bảo
                            hiểm</strong>
                        </p>
                        <ul class="ulPostBody">
                          <li>
                            Sử dụng chữ ký số SIM CA cho các giao dịch nội bộ:
                            <strong><em>Ngân hàng MB bank, OCB, BIDV, Bảo hiểm
                                PVI...</em></strong>
                          </li>
                          <li>
                            Sử dụng chữ ký số SIM CA cho các khách hàng (Cá
                            nhân &amp; Doanh nghiệp) thực hiện các giao dịch
                            với các Tổ chức Ngân hàng &#8211; Tài chính
                          </li>
                        </ul>
                      </li>
                      <li>
                        <p>
                          Sử dụng SIM CA như một hình thức xác thực khi thực
                          hiện
                          <strong>các hoạt động mua bán, giao dịch, xác nhận thanh
                            toán</strong>&#8230; trong thương mại điện tử
                        </p>
                      </li>
                      <li>
                        <p>
                          Ứng dụng trong dịch vụ
                          <strong>Văn phòng điện tử vOffice</strong><br />
                          Văn phòng điện tử là một phần mềm tích hợp đầy đủ
                          các ứng dụng phục vụ nhu cầu quản lý, xử lý hồ sơ
                          công việc, trao đổi thông tin, điều hành tác nghiệp,
                          khởi tạo và quản lý văn bản tài liệu, công văn, báo
                          cáo&#8230; Các cá nhân có thể sử dụng chữ ký số SIM
                          CA để phê duyệt văn bản, hồ sơ, tài liệu trên ứng
                          dụng văn phòng điện tử vOffice.
                        </p>
                      </li>
                      <li>
                        <p>
                          Bên cạnh đó, chữ ký số SIM CA còn có thể tích hợp
                          trên các ứng dụng đặc thù khác như:
                          <strong><em>Dịch vụ công KBNN, Phần mềm y tế, Phần mềm quản
                              lý bán hàng online...</em></strong>
                        </p>
                      </li>
                    </ol>
                    <h2 style="font-size: 1.3em">
                      <strong>Bảng giá chữ ký số SIM CA của Viettel</strong>
                    </h2>
                        ...
                        <tbody>
                          <tr>
                            <td rowspan="2" style="vertical-align: middle">
                              <strong>Đăng ký mới hoặc gia hạn SIM
                                Viettel-CA</strong>
                            </td>
              ...
              <div
                ...
                <div class="comment-form">
                  <a
                    href="https://draft.blogger.com/comment/frame/8243747611808165490?po=7723005880426031019&amp;hl=vi&amp;saa=85391&amp;origin=https://www.sinvoice.vn&amp;skin=emporio"
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2020/09/sim-ca-giai-phap-tich-hop-chu-ky-so.php"
                  },
                  "headline": "SIM CA: giải pháp tích hợp Chữ ký số Viettel-CA trên SIM di động",
                  "description": "SIM CA hay còn gọi là Mobile CA, là dịch vụ chứng thực chữ ký số mà khóa riêng và khóa công khai được lưu trữ trên SIM Viettel",
                  "image": {
                    "@type": "ImageObject",
                    "url": "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhFg0QKzmTJU7HyAW7EbsRTJHw4k6MR3LjTqFSiWsEKU1bDxkwxu5xsQbW1_HxksE2aDxCDnBrQsmpZldYY7Eq5IYwzeDH2r3dWumvrbJOVP3eSXecLQWj9vcwoVw4fG0ZdUQ2zxE75WYdw/w720-h480-p-k-no-nu/Giai-phap-chu-ky-so-tren-sim-ca.jpg",
                    "width": 720,
                    "height": 480
                  },
                  "datePublished": "2020-09-13T22:55:00+07:00",
                  "dateModified": "2020-12-04T09:18:01+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "7723005880426031019",
        pageId: "",
        pageName: "SIM CA: giải pháp tích hợp Chữ ký số Viettel-CA trên SIM di động",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2020/09/sim-ca-giai-phap-tich-hop-chu-ky-so.php",
