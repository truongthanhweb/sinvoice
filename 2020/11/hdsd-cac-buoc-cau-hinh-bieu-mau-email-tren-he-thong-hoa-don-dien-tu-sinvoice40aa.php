...
<head>
  ...
  <link
    ...
    rel="canonical" />
  <link
    href="hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice40aa.php?m=1"
  ...
  <link
    ...
    rel="alternate" />
  <title>
    Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice
  </title>
  <meta
    content="Hướng dẫn doanh nghiệp cách cấu hình biểu mẫu email trên hệ thống hóa đơn điện tử S-Invoice của Viettel | Mua hóa đơn điện tử tặng chữ ký số"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice.php"
    property="og:url" />
  <meta
    content="Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice"
    property="og:title" />
  <meta
    content="Hướng dẫn doanh nghiệp cách cấu hình biểu mẫu email trên hệ thống hóa đơn điện tử S-Invoice của Viettel | Mua hóa đơn điện tử tặng chữ ký số"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="6071970229346933591">
              <header class="article-header">
                <h1 class="entry-title">
                  Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện
                  tử S-Invoice
                </h1>
              </header>
                ...
                <div class="entry-body">
                  <div class="divPostBody">
                    <p>
                      ...
                      Sau khi cấu hình thành công ở tab Email, người dùng cần
                      cấu hình biểu mẫu Email để có thể gửi mail hóa đơn điện
                      tử đến Khách mua hàng. Trong bài viết này S-Invoice xin
                      hướng dẫn doanh nghiệp cấu hình biểu mẫu email.
                    </p>
                    <p>
                      ******Xem thêm:
                      <strong><a
                          class="color-warning"
                          href="hdsd-cac-buoc-cau-hinh-gui-mail-hoa-don-dien-tu-cho-nguoi-mua-bang-gmail-hotmail-yahoo.php"
                          target="_blank">Các bước cấu hình gửi hóa đơn cho người mua bằng
                          Gmail, Hotmail, Yahoo, Outlook.</a></strong>
                    </p>
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>
                        Nhập tài khoản hóa đơn điện tử và nhấn
                        <strong>Đăng nhập</strong>.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>Bước 2. Chọn menu Cấu hình doanh nghiệp</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Chọn
                      ...
                      <li>Chọn tab <strong>Biểu mẫu email</strong>.</li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                    ...
                    <ul class="ulPostBody">
                      <li>
                        Nhấn chọn <strong>Thêm mới</strong> để thêm thông tin
                        mẫu email
                      </li>
                      <li>
                        Nhập các thông tin mẫu email như sau:<br />
                        <ul style="margin-left: 20px">
                          <li>
                            <strong><em>Email</em></strong>: nhập email dùng để gửi hóa đơn điện tử đến
                            người mua.
                          </li>
                          <li>
                            <strong><em>Tên mẫu email</em></strong>: nhập tên mẫu tùy ý.
                          </li>
                          <li>
                            <strong><em>Tiêu đề mail</em></strong>: nhập tiêu đề của email gửi đến người mua.
                          </li>
                          <li>
                            <strong><em>Sử dụng</em></strong>: chọn <strong>Cho cả doanh nghiệp</strong> hoặc
                            <strong>Theo mẫu hóa đơn</strong>.
                          </li>
                          <li>
                            <strong><em>Trạng thái</em></strong>: chọn <strong>Hoạt động</strong>.
                          </li>
                        </ul>
                      </li>
                    </ul>
                    ...
                    <ul class="ulPostBody">
                      <li>
                        Đây là bước quan trọng, người dùng có thể tùy chỉnh
                        nội dung email gửi đến người mua sao cho phù hợp với
                        doanh nghiệp.
                      </li>
                      <li>
                        Có bốn nội dung cần soạn thảo gồm:<br />
                        <ul style="margin-left: 20px">
                      ...
                      <li>
                        Người dùng tùy chỉnh nội dung bằng cách nhấn vào đường
                        link tương ứng, sao đó thay đổi ở cột bên trái. Nội
                        dung sẽ được xem trước hiển thị ở cột bên phải.
                      </li>
                    </ul>
                    <p><strong>*** Một số lưu ý:</strong></p>
                    <ul class="ulPostBody">
                      <li>
                        Người dùng <strong>BẮT BUỘC</strong> phải nhấn vào
                        link soạn thảo mới hoàn thành được việc thêm biểu mẫu.
                      </li>
                      <li>
                        Nếu muốn sử dụng biểu mẫu mặc định, người dùng nhấn
                        vào link soạn thảo. Ở cột Nội dung email, người dùng
                        <em>nhấn một ký tự bất kỳ, sau đó xóa ký tự đó đi</em>. (Mục đích là cho hệ thống hiểu đã có thay đổi nội
                        dung). Cột <strong>Xem trước</strong> hiển thị nội
                        dung, người dùng nhấn <strong>Đóng</strong>.
                      </li>
                      <li>
                        Các trường động nằm trong dấu {{...}} là cố định,
                        không được phép thay đổi.
                      </li>
                    </ul>
                    <h2 style="font-size: 1.3em">
                      <strong>Bước 5. Hoàn thành</strong>
                    </h2>
                    <p>
                      Người dùng nhấn <strong>Thêm mới</strong> để hoàn thành
                      việc cấu hình biểu mẫu email.
                    </p>
                    <p>
                      ***** Bài viết chi tiết
                      <strong><em><a
                            ...
                            target="_blank">"Hướng dẫn cấu hình biểu mẫu Email trên hệ thống
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice.php"
                  },
                  "headline": "Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice",
                  "description": "Hướng dẫn doanh nghiệp cách cấu hình biểu mẫu email trên hệ thống hóa đơn điện tử S-Invoice của Viettel | Mua hóa đơn điện tử tặng chữ ký số",
                  "image": {
                    "@type": "ImageObject",
                    "url": "",
                    "width": 720,
                  ...
                  "datePublished": "2020-11-21T16:16:00+07:00",
                  "dateModified": "2021-02-18T19:58:24+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "6071970229346933591",
        pageId: "",
        pageName: "Các bước cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice.php",
