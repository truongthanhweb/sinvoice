...
<head>
  ...
  <link
    ...
    rel="alternate" />
  <title>
    Các bước cấu hình gửi mail hóa đơn điện tử cho người mua hàng bằng Gmail,
    Yahoo, Hotmail
  </title>
  <meta
    content="Hướng dẫn doanh nghiệp tự cấu hình gửi mail hóa đơn điện tử S-Invoice cho người mua sử dụng Gmail, Hotmail hoặc Yahoo mail | Mua hóa đơn điện tử chính"
    name="description" />
  <!-- ROBOTS -->
  ...
  <meta
    content="https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-gui-mail-hoa-don-dien-tu-cho-nguoi-mua-bang-gmail-hotmail-yahoo.php"
    property="og:url" />
  <meta
    content="Các bước cấu hình gửi mail hóa đơn điện tử cho người mua hàng bằng Gmail, Yahoo, Hotmail"
    property="og:title" />
  <meta
    content="Hướng dẫn doanh nghiệp tự cấu hình gửi mail hóa đơn điện tử S-Invoice cho người mua sử dụng Gmail, Hotmail hoặc Yahoo mail | Mua hóa đơn điện tử chính"
      ...
      <div class="main col-md-9 col-xs-12 section" id="main-2">
        <div class="widget Blog post" data-version="2" id="Blog2">
          <div class="blog-posts" id="blog-posts">
            <article class="post" data-article-id="4660380960816121266">
              ...
              <main class="article-body">
                <div class="entry-body">
                  <div class="divPostBody">
                    <p style="color: red">
                      <strong>Kể từ ngày 31/05/2022, Google Mail thay đổi chính
                        sách bảo mật dẫn đến các bước cấu hình bên dưới không
                        còn hiệu lực nữa. Quý doanh nghiệp vui lòng cấu hình
                        theo video hướng dẫn sau:</strong>
                    </p>
                    <div class="col-md-12 d-flex align-items-center">
                      <a
                        class="flex"
                        data-fancybox="gallery"
                        href="https://youtu.be/Ho7eq560rIA">
                        <img
                          alt="Hướng dẫn gửi hóa đơn khởi tạo từ máy tính tiền đến Cơ quan Thuế"
                          class="img-fluid lazyload"
                          data-src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi_OGQuzULZ_KIsk7P9as8ytmkKbb70UesireAFtWAQqMs2XdIFUOUW3edKPrJN-b7lkDe99lWmpicOpCjSu7hZxMZVl4nj-EjtngPdJYaPXgCAdJ_39yDe6-ZN0mBJbF0-WmTUiBHmPt9Wo_XoFiwHjjY5wlPnczgAvQQdHL1KMmnwWRDcMjnGyobq-jFz/s16000/BANNER%20VIDEO%20-%20GUI%20HOA%20DON%20CHO%20NGUOI%20MUA%20BANG%20GMAI.webp"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" />
                        <span class="icon-play">
                          <i class="zmdi zmdi-play-circle"></i></span>
                      </a>
                    </div>
                    ...
                    <ul class="ulPostBody">
                      <li>
                        <a
                          href="../2023/03/su-dung-chung-tu-khau-tru-thue-tncn-dien-tu-theo-quy-dinh-nd123.php"
                          target="_blank"
                          title="Sử dụng chứng từ khấu trừ Thuế TNCN theo quy định tại Nghị định 123/2020/NĐ-CP"><strong>Sử dụng chứng từ khấu trừ Thuế TNCN theo quy định
                            tại Nghị định 123/2020/NĐ-CP</strong></a>
                      </li>
                      <li>
                        <a
                          href="../2024/04/goi-300-hoa-don-dien-tu-cho-ho-kinh-doanh.php"
                          target="_blank"
                          title="Gói 300 hóa đơn điện tử Viettel dành cho Hộ kinh doanh"><strong>Gói 300 hóa đơn điện tử Viettel dành cho Hộ kinh
                            doanh</strong></a>
                      </li>
                      <li>
                        <a
                          ...
                          target="_blank"
                          title="Khuyến mãi: Tặng 20% số lượng khi MUA THÊM hóa đơn điện tử"><strong>Khuyến mãi: Tặng 20% số lượng khi MUA THÊM hóa
                            đơn điện tử</strong></a>
                      </li>
                      <li>
                        <a
                          href="../p/bang-gia-sinvoice.php"
                          target="_blank"
                          title="Bảng giá dịch vụ Hóa đơn điện tử S-Invoice"><strong>Bảng giá dịch vụ Hóa đơn điện tử
                            S-Invoice</strong></a>
                      </li>
                    </ul>

                    <p>-------- <strong>Hết hiệu lực</strong> ---------</p>
                    <p>
                    ...
                    <h2 style="font-size: 1.1em">
                      <strong>1. DOANH NGHIỆP SỬ DỤNG GMAIL ĐỂ GỬI HÓA ĐƠN ĐIỆN
                        TỬ</strong>
                    </h2>

                    <h3 style="font-size: 1.1em">
                      <strong>Bước 1: Đăng xuất toàn bộ tài khoản Gmail trên trình
                        duyệt.</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>
                        ...
                        <a
                          ...
                          rel="nofollow"
                          target="_blank">mail.google.com</a>.
                      </li>
                      <li>
                        Nhập mật khẩu Gmail để đăng nhập (Nếu trình duyệt đã
                        lưu mật khẩu thì không cần).
                      </li>
                      <li>
                        Nhấn chuột vào biểu tượng hình tròn trên góc phải hộp
                        thư và chọn mục
                        <strong>Sign out off all Accounts (Đăng xuất khỏi tất cả
                          tài khoản)</strong>.
                      </li>
                    </ul>
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 2: Đăng nhập lại bằng tài khoản Gmail dùng để
                        gửi hóa đơn.</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>
                        ...
                        <a
                          ...
                          rel="nofollow"
                          target="_blank">https://accounts.google.com/b/0/DisplayUnlockCaptcha</a>.
                      </li>
                      <li>
                        Đăng nhập bằng tài khoản Gmail mà doanh nghiệp muốn sử
                        dụng để gửi hóa đơn điện tử đến người mua.
                      </li>
                    </ul>
                    <p>
                    ...
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 3: Cho phép ứng dụng truy cập vào tài khoản
                        Google của bạn.</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>
                        Nếu tài khoản Gmail không cấu hình Bảo mật 2 bước:
                        người dùng tiếp tục nhấn vào nút
                      ...
                      <li>
                        Nếu tài khoản Gmail có cấu hình Bảo mật 2 bước: người
                        dùng sẽ nhận được thông báo
                    ...
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 4: Cách tắt cấu hình Bảo mật 2 bước (2-Step
                        Verification)</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>Truy cập Gmail (mail.google.com).</li>
                      <li>
                        Nhấn vào biểu tượng hình tròn góc trên phải của Gmail
                        và chọn
                        <strong>Manage your Google Account (Quản lý tài khoản
                          Google của bạn).</strong>
                      </li>

                      <li>Chọn <strong>Security (Bảo mật)</strong>.</li>
                      <li>
                        Chọn mục
                        <strong>2-Step Verification (Xác minh 2 bước)</strong>.
                      </li>
                      <li>
                        Nhập mật khẩu Gmail và nhấn
                        <strong>Next (Tiếp theo)</strong> để tiếp tục.
                      </li>
                      <li>
                        Nhấn nút
                        <strong>Turn Off (Tắt)</strong> tại màn hình xác minh
                        2 bước.
                      </li>
                      <li>
                        Nhấn <strong>Turn Off (Tắt)</strong> một lần nữa để
                        xác nhận tắt.
                      </li>
                    </ul>
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 5: Thiết lập ứng dụng kém an toàn.</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>
                        ...
                        <a
                          ...
                          rel="nofollow"
                          target="_blank">https://myaccount.google.com/lesssecureapps</a>
                      </li>
                      <li>
                        Chọn
                      ...
                      <li>
                        Chuyển thanh trượt từ trạng thái
                    ...
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 6: Cấu hình thông số Gmail trên hệ thống hóa đơn
                        điện tử S-Invoice.</strong>
                    </h3>
                    <ul class="ulPostBody">
                      <li>
                        Truy cập website hóa đơn điện tử S-Invoice:
                        <a
                          href="https://business-sinvoice.viettel.vn/dang-nhap.php"
                          rel="nofollow"
                          target="_blank">business-sinvoice.viettel.vn.</a>
                      </li>
                      <li>
                        Nhập tài khoản và nhấn <strong>Đăng nhập</strong>
                      </li>
                      <li>
                        Chọn chức năng
                      ...
                      <li>
                        Chọn tab <strong>Email</strong> và điền các thông số
                        như sau:<br />
                        <ul style="margin-left: 20px">
                          <li>
                            Cấu hình mẫu: Chọn <strong><em>Gmail</em></strong>;
                          </li>
                          <li>Tên cấu hình: nhập "Gmail";</li>
                          <li>
                            Tên đăng nhập: nhập Gmail dùng để gửi Hóa đơn điện
                            tử đến Khách hàng. Ví dụ:
                          ...
                          <li>
                            Trạng thái: chọn <strong>Hoạt động</strong>.
                          </li>
                          <li>
                    ...
                    <h2 style="font-size: 1.1em">
                      <strong>2. DOANH NGHIỆP SỬ DỤNG YAHOO MAIL ĐỂ GỬI HÓA ĐƠN
                        ĐIỆN TỬ</strong>
                    </h2>
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 1: Cho phép ứng dụng kém an toàn</strong>
                    </h3>
                    ...
                    <ul class="ulPostBody">
                      <li>
                        ...
                        <a
                          ...
                          rel="nofollow"
                          target="_blank">https://login.yahoo.com/account/security</a>
                      </li>
                      <li>
                        Đăng nhập bằng tài khoản Yahoo dùng để gửi mail hóa
                        đơn điện tử
                      </li>
                      <li>
                        Nhấn chọn
                    ...
                    <h3 style="font-size: 1.1em">
                      <strong>Bước 2: Cấu hình thông số Yahoo mail trên hệ thống
                        hóa đơn điện tử S-Invoice.</strong>
                    </h3>
                    ...
                    <ul class="ulPostBody">
                      ...
                      <li>
                        ...
                        <ul style="margin-left: 20px">
                          ...
                          <li>
                            Tên đăng nhập: nhập Yahoo mail dùng để gửi Hóa đơn
                            điện tử đến Khách hàng. Ví dụ:
                    ...
                    <h2 style="font-size: 1.1em">
                      <strong>3. DOANH NGHIỆP SỬ DỤNG HOTMAIL ĐỂ GỬI HÓA ĐƠN ĐIỆN
                        TỬ S-INVOICE</strong>
                    </h2>
                    <ul class="ulPostBody">
                      <li>
                        Cấu hình các thông tin trên hệ thống hóa đơn điện tử
                        S-Invoice như sau:<br />
                        <ul style="margin-left: 20px">
                          <li>
                            Cấu hình mẫu: Chọn <strong>Hotmail</strong>;
                          </li>
                          <li>Tên cấu hình: nhập "Hotmail";</li>
                          <li>
                            Tên đăng nhập: tên Hotmail dùng để gửi hóa đơn
                            điện tử. Ví dụ:
                          ...
                          <li>
                            Địa chỉ server:
                            <strong><em>smtp.live.com</em></strong>;
                          </li>
                          <li>Cổng: <strong>587</strong></li>
                        </ul>
                      </li>
                    ...
                    <h2 style="font-size: 1.1em">
                      <strong>4. DOANH NGHIỆP SỬ DỤNG TÊN MIỀN RIÊNG ĐỂ GỬI HÓA ĐƠN
                        ĐIỆN TỬ S-INVOICE</strong>
                    </h2>

                    <ul class="ulPostBody">
                      <li>
                        Doanh nghiệp cần có các thông tin:<br />
                        <ul style="margin-left: 20px">
                          <li>Địa chỉ Email server;</li>
                          <li>Cổng gửi thư;</li>
                          <li>Loại bảo mật.</li>
                        </ul>
                      </li>
                      <li>
                        Cấu hình thông tin trên hệ thống Hóa đơn điện tử
                        S-Invoice như sau:<br />
                        <ul style="margin-left: 20px">
                          <li>
                          ...
                          <li>
                            Tên đăng nhập: tên email dùng để gửi hóa đơn điện
                            tử. Ví dụ: tailv1@viettel.com.vn
                          </li>
                    ...
                    <p>
                      <strong>*** Lưu ý:</strong> Khi cấu hình xong mail thì
                      người dùng cần phải
                      <a
                        class="color-warning"
                        href="hdsd-cac-buoc-cau-hinh-bieu-mau-email-tren-he-thong-hoa-don-dien-tu-sinvoice.php"
                        target="_blank">cấu hình biểu mẫu Email</a>
                      mới gửi được hóa đơn sau khi phát hành đến người mua
                    </p>
                    <p>
                      ****** Bài viết chi tiết:
                      <strong><em><a
                            ...
                            target="_blank"
                            title="Hướng dẫn cấu hình biểu mẫu Email trên hệ thống hóa đơn điện tử S-Invoice">Cấu hình gửi hóa đơn cho người mua bằng Gmail,
                            Hotmail, Yahoo, Outlook</a></em></strong>
                    </p>
              ...
              <script type="application/ld+json">
                {
                  ...
                  "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-gui-mail-hoa-don-dien-tu-cho-nguoi-mua-bang-gmail-hotmail-yahoo.php"
                  },
                  "headline": "Các bước cấu hình gửi mail hóa đơn điện tử cho người mua hàng bằng Gmail, Yahoo, Hotmail",
                  "description": "Hướng dẫn doanh nghiệp tự cấu hình gửi mail hóa đơn điện tử S-Invoice cho người mua sử dụng Gmail, Hotmail hoặc Yahoo mail | Mua hóa đơn điện tử chính",
                  "image": {
                    "@type": "ImageObject",
                  ...
                  "datePublished": "2020-11-22T17:26:00+07:00",
                  "dateModified": "2024-06-24T19:51:11+07:00",
                  "author": {
                    "@type": "Person",
                    "name": "Văn Tài"
                  },
  ...
  <script>
    var data = {
      ...
      blog: {
        ...
        postId: "4660380960816121266",
        pageId: "",
        pageName: "Các bước cấu hình gửi mail hóa đơn điện tử cho người mua hàng bằng Gmail, Yahoo, Hotmail",
        searchqueryescaped: "",
        homepageUrl: "https://www.sinvoice.vn/",
        url: "https://www.sinvoice.vn/2020/11/hdsd-cac-buoc-cau-hinh-gui-mail-hoa-don-dien-tu-cho-nguoi-mua-bang-gmail-hotmail-yahoo.php",
