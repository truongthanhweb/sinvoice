  ...
  <head>
    ...
    <style>
      ...
      *{box-sizing:border-box;-moz-box-sizing:border-box;-ms-box-sizing:border-box;text-rendering:geometricPrecision}
      ...
      #preloader{position:fixed;left:0;top:0;z-index:99999;width:100%;height:100%;overflow:visible;background-image:url(../../cdn.jsdelivr.net/gh/thietkeblogspot/images/preloader.gif);background-position:center center;background-repeat:no-repeat;background-color:#fff}
      ...
      .avatar-image-container img{background:url(../../blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEifmQfLokTY-KuNcqzpVjGpLkOmKPOkNdYBnRKugws/s1600/no-image.png) no-repeat center}
...
.thread-locked-alert{background-color:#f2f6fb;margin:20px 0 0;padding:15px;position:relative;border:1px solid #dadce0;border-radius:3px;overflow-x:hidden}*/
  ...
  <body>
              ...
              <ul class="quick_action nav flex flex-right">
                <li>
                  <a
                    ...
                    title="Liên hệ mua hàng - 0866531668"
                    >Liên hệ mua hàng: 0866531668</a
                  >
                </li>
            ...
            <nav class="navbar">
              ...
              <div class="collapse navbar-collapse navbar-right navbar_right">
                <ul class="nav navbar-nav">
                  ...
                  <li>
                    <a href="../p/tinh-nang.php" title="Tính năng"
                      >Tính năng</a
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="../search/label/tin-tuc.php" title="Tin tức"
                      >Tin tức</a
                    >
                  </li>
                  <li>
                    <a
                      ...
                      title="Bảng giá S-Invocie"
                      >Bảng giá</a
                    >
                  </li>
                  <li>
                    <a href="../p/tra-cuu-hoa-don.php" title="Tra cứu hóa đơn"
                      >Tra cứu hóa đơn</a
                    >
                  </li>
                  <li>
                    <a href="../p/mau-hoa-don-gtgt.php" title="Mẫu Hóa đơn"
                      >Mẫu hóa đơn</a
                    >
                  </li>
                </ul>
              ...
              <article class="post" data-article-id="8043222863168993441">
                  ...
                  <div class="entry-body">
                    ...
                    <div class="divPostBody">
                      <p>
                        ...
                        Theo <strong><em>Nghị định 123/2020/NĐ-CP</em></strong
                        >, kể từ ngày 01/07/2022, việc chuyển đổi hóa đơn bán
                            ...
                            <td style="text-align: center">
                              <a
                                ...
                                ><img
                                  ...
                                  src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiRsSdYbpnFCNZmCGFBdz2aH1YXRfkABa2UBcKAhit5uFRlj2vbggdtoyaaOS6L9lkn9II0pVUCulsly4b03jB9ktl4tiW5tTO8QIZHHsEngABisBskKdRTv44ac-Tt3x7uMYK8ObPL_RR2isOWw4UXIjHAafjFbghSocl2odR9jpPaSHpaJax024_b6A/s16000/mot-so-loai-tem-ve-the-dien-tu-hien-tai.webp"
                                  title="Một số ví dụ về tem vé thẻ điện tử trên thị trường"
                              /></a>
                            </td>
                          </tr>
                          <tr>
                      ...
                      <h2 class="entry-subtitle">
                        <strong
                          >Ưu thế của tem/vé/thẻ điện tử so với vé giấy là
                          gì?</strong
                        >
                      </h2>
                      ...
                      <ul class="ulPostBody">
                        ...
                        <li>
                          <strong
                            ><em
                              >Tiết kiệm chi phí in ấn, bảo vệ môi trường:</em
                            ></strong
                          >
                      ...
                      <h2 class="entry-subtitle">
                        <strong
                          >Tem/vé/thẻ có mệnh giá có phải chuyển đổi sang hóa
                          đơn điện tử?</strong
                        >
                      </h2>
                      <p>
                      ...
                      <p>
                        ...
                        <a
                          ...
                          target="blank"
                          title="Tem/vé/thẻ điện tử Viettel &#8211; Quy định về tem/vé/thẻ điện tử theo Thông tư 78/2021/TT-BTC"
                          >Tem/vé/thẻ điện tử Viettel &#8211; Quy định về
                          tem/vé/thẻ điện tử theo Thông tư 78/2021/TT-BTC</a
                        >
                      </p>
                      <h2 class="entry-subtitle">
                        <strong
                          >Giải pháp tem/vé/thẻ của Viettel dễ cài đặt, dễ sử
                            ...
                            <td style="text-align: center">
                              <a
                                ...
                                ><img
                                  ...
                                  title="Giải pháp Tem/Vé/Thẻ điện tử Viettel đang được nhiều đơn vị tin dùng"
                              /></a>
                            </td>
                          </tr>
                          <tr>
                      ...
                      <p>
                        <strong
                          >Nếu có nhu cầu đăng ký dịch vụ Tem/Vé/Thẻ của
                ...
                >
                  ...
                  <div class="comment-form">
                    <a
                      href="https://www.blogger.com/comment/frame/8243747611808165490?po=8043222863168993441&amp;hl=vi&amp;saa=85391&amp;origin=https://www.sinvoice.vn&amp;skin=emporio"
        ...
        <footer class="footer">
          <div class="container">
            <div class="foot-contact">
              ...
              <ul class="hot_line">
                <li>
                  <a href="https://www.sinvoice.com.vn/" target="_blank"
                    >Hóa đơn điện tử S-Invoice</a
                  >
                </li>
                <li>
                  <p class="email">
            ...
            <div class="foot-links">
              ...
              <ul class="hot_line">
                <li>
                  <a class="email" href="../p/thu-tuc-dang-ky-sinvoice.php"
                    >Thủ tục đăng ký</a
                  >
                </li>
                <li>
                  <a class="email" href="../p/van-ban-phap-ly-sinvoice.php"
                    >Văn bản pháp lý</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a class="email" href="../p/cau-hoi-thuong-gap-sinvoice.php"
                ...
                <li>
                  <a
                    class="email"
                    href="../2020/11/dieu-khoan-su-dung-dich-vu-hoa-don-dien-tu.php"
                    >Điều khoản sử dụng</a
                  >
                </li>
                <li>
                  <a class="email" href="../p/dang-ky-lam-dai-ly.php"
                    >Đăng ký làm đại lý</a
                  >
                </li>
              </ul>
            </div>
          ...
          <div class="modal-body">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <div
                  class="g-recaptcha"
                  data-sitekey="6LfqH5olAAAAAFejH_3Td1AeTsMuv3HjeA5ya1Co"
                ></div>
        ...
        if (data_embed == "true" && data_allow_comments == "true") {
          ...
          if (url.indexOf("?showComment") != -1) {
            if (url.indexOf("#c") != -1) {
              ...
              $("html,body")
                .stop()
                .animate({ scrollTop: $(li).offset().top - 100 }, "slow");
            } else {
              for (var i = 0; i < m; i++) {
                $(str[i]).removeClass("hidden");
              }
    ...
    <script
      asysn="asysn"
      defer="defer"
      src="../../cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.2/owl.carousel.min.js"
    ></script>
    <script
      asysn="asysn"
      defer="defer"
      src="../../cdnjs.cloudflare.com/ajax/libs/mixitup/2.1.11/jquery.mixitup.min.js"
    ></script>
    <script
      asysn="asysn"
      defer="defer"
    ...
    <script
      asysn="asysn"
      defer="defer"
      src="../../cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.0/jquery.waypoints.min.js"
    ></script>
    ...
    <script
      asyns=""
      defer="defer"
      src="../../cdn.jsdelivr.net/gh/thietkeblogspot/js/contact-buttons-widget.min.js"
    ></script>
    <script
      async="async"
      defer="defer"
      ...
      var _widget_settings = {
        ...
        support: {
          staff: {
            ...
            image:
              "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh7tKkNpgTVEELAiBo7IICiGKDNlq-MJM0gznciTpYgiHPjGcoEx4jeF3Wj-VCaED4SFVijzBrKqfyT5yO2bCkApmDgq69bxZ4jrXx9q7vFMEUfgTmiopeyA_9PJBXWWy6Kt-tk-OCttD0B/s16000/cc.png",
            messages:
              "Không biết chúng tôi có thể hỗ trợ gì cho anh/chị không ạ?",
          },
        },
        buttons: {
          contact: {
    ...
    <script
      async="async"
      src="https://www.googletagmanager.com/gtag/js?id=UA-182978106-1"
    ></script>
    <style type="text/css">
      body {
        overflow: hidden;
